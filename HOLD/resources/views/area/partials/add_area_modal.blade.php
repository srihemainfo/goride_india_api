  ...
  <div class="modal-dialog modal-dialog-aside" role="document" style="width: 30%;">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h5 class="modal-title">Area Edit Form</h5>
      ...
      <div class="modal-body">
        ...
        <form id="customerFormtest" name="customerFormtest">
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <input type="char" class="form-control" name="area_name" id="area_name" placeholder="Enter the Area" readonly>
            ...
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <select name="area_status" id="area_status" class="form-select">
            ...
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="post_code" maxlength="20" id="post_code" placeholder="Enter the Code">
            ...
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="pickup_extra" id="pickup_extra" required oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 5)" placeholder="Enter the Amount">
            ...
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="drop_extra" id="drop_extra" required oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 5)" placeholder="Enter the Amount">
