        ...
        <form id="customerForm" name="customerForm">
          ...
          <div class="row">
            ...
            <div>
              ...
              <label for="area_name">From Area Name <span class="required">*</span></label>

              <select class="form-control select2" style="width: 100%;" name="add_area_name" id="add_area_name" data-placeholder="Enter the Area">
             ...
             <div class="col-sm-12">
               ...
               <div class="form-group">
                   ...
                   <label for="address" class="col-form-label">To Area Name<span class="required">&nbsp;</span></label>
            ...
            <!-- <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <label for="post_code" class="col-form-label">Postcode / Pincode<span class="required">&nbsp;</span></label>

                <input type="text" class="form-control" name="add_post_code" id="add_post_code" maxlength="20" placeholder="Enter the Code">
            ...
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <label for="pickup_extra" class="col-form-label">Price<span class="required">&nbsp;*</span></label>

                <input type="text" class="form-control" name="add_pickup_extra" id="add_pickup_extra" required oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 5)" placeholder="Enter the Amount">
...
<!-- 
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="add_drop_extra" id="add_drop_extra" required oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 5)" placeholder="Enter the Amount">
