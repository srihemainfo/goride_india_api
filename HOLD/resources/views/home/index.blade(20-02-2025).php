    ...
    <div class="col-sm-12 main-card mb-2 card">
       <div class="card-header">
        ...
        <div class="btn-actions-pane-right">
            ...
            <button type="submit" class="btn btn-warning" onclick="showlist('Pending')"> Pending </button>   
            <button type="submit" class="btn btn-white standard" style="background-color: #07912b!important;" onclick="showlist('Confirmed')"> Confirmed </button>
            <button type="submit" class="btn btn-warning" style="background-color: #0E73C9 !important;" onclick="showlist('Assigned')"> Assigned </button>
            <button type="submit" class="btn btn-success"  style="background-color: #67138B !important;" onclick="showlist('Dispatched')"> Dispatched </button>
            <!--<button type="submit" class="btn btn-info" onclick="showlist('Moving')"> Moving </button>-->
            <button type="submit" class="btn btn-success" style="background-color: #0ecb02!important;" onclick="showlist('Dispatched')"> Completed </button>
            <!--<button type="submit" class="btn btn-warning1" onclick="showlist('settled')"> Settled </button>-->
            <button type="submit"class="btn btn-info1" style="background-color: #F33434  !important;" onclick="showlist('Canceled')"> Canceled </button>
        </div>
    </div>
        <div class="card-body">
