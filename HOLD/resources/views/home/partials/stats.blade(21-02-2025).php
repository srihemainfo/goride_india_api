...
<div class="col-lg-6 col-md-6" id='chart_container' style='displa:none;'>
    <div class="name">
    <h3 class="hd-name">Airport</h3>
    </div>
    <div class="row airpottdrw">
        <div class="col-md-12 airpottd bg-white">
              <canvas id="bookingChart" width="400" height="200" class='display:none;'></canvas>
    {{--
         <div class="airport">
         <div class="tent">
                <!--<ul class="ed-ul">-->
