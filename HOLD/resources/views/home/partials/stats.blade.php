...
<div class="row">   
    <div class="col-lg-7 col-md-6">
        <div class="row">
    <div class="col-xl-4 col-sm-6 mb-2"><a style="text-decoration:none;" href="/booking/list/All">
        <div class="card text-white bg-primary">
            <div class="card-body">
                <div class="card-body-icon">
                    <i class="fa fa-car"></i>
                    <span class="ml-1"><b>Total bookings</b></span>
                </div>
    ...
    <div class="col-xl-4 col-sm-6 mb-2"><a style="text-decoration:none;" href="/booking/list/All">
        <div class="card text-white bg-warning">
            <div class="card-body">
                <div class="card-body-icon">
                    <i class="fa fa-car"></i>
                    <span class="ml-1"><b>Pending bookings</b></span>
                </div>
    ...
    <div class="col-xl-4 col-sm-6 mb-2"><a style="text-decoration:none;" href="/booking/list/All">
        <div class="card text-white bg-info">
            <div class="card-body" style="height: 106px;">
                <div class="card-body-icon">
                    <i class="fa fa-car"></i>
                    <span class="ml-1"><b>Confirmed bookings</b></span>
                </div>
    ...
    <div class="card text-white bg-success">
            <div class="card-body">
                <div class="card-body-icon">
                    <i class="fa fa-car"></i>
                    <span class="ml-1"><b>Assigned bookings</b></span>
                </div>
    ...
    <div class="card text-white bg-dark">
            <div class="card-body">
                <div class="card-body-icon">
                    <i class="fa fa-car"></i>
                    <span class="ml-1"><b>Dispatched bookings</b></span>
                </div>
    ...
    <div class="card text-white bg-danger">
            <div class="card-body">
                <div class="card-body-icon">
                    <i class="fa fa-car"></i>
                    <span class="ml-1"><b>Cancelled bookings</b></span>
                </div>
