    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-12 row mb-2">
                ...
                <div class="col-sm-3">
                    <label for="job_no_filter" class="mt-2">Job No</label>
                    <input type="text" class="form-control" id="job_no_filter" placeholder="Search by Job No." name="job_no_filter" value="">
                </div>

                <div class="col-sm-3">
                    <label for="pickup_between_filter" class="mt-2">Pickup Dates Between</label>
                    <input type="text" class="form-control" id="pickup_between_filter" placeholder="Select date range" name="pickup_between_filter" value="" autocomplete="off">
                </div>

                <div class="col-sm-3">
                    <label for="booking_between_filter" class="mt-2">Booking Dates Between</label>
                    <input type="text" class="form-control" id="booking_between_filter" placeholder="Select date range" name="booking_between_filter" value=""autocomplete="off">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12 row mb-3">
                <div class="col-sm-3">
                    <button type="button" class="btn btn-primary" id="dash_book_search"><i class="fa fa-filter"></i>&nbsp; Filter</button>
                    <button type="button" class="btn btn-danger" id="dash_book_reset"><i class="fa fa-undo"></i>&nbsp; Reset</button>
                </div>
            </div>
