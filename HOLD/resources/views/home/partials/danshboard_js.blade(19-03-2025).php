        ...
        $('#dash_book_search').on('click', function(){
            ...
            new DataTable('#dash-table', {
             ...
             columns: [
                 ...
                 },
                 {
                        ...
                        render: function(data, type, row) {
                            return row.pickup_flight_num 
                                ? `<i class="fa-solid fa-plane" style="font-weight: 600;margin: 0 9px 2px 4px;color: #114462;"></i>${row.pickup_flight_num}` 
                                : '';
                        },
                 ...
                 render: function(data,type,row){
                     return `<div style="padding-bottom: 15px; padding-top: 15px;"><i class="fa-solid fa-location-dot" style="font-weight: 00;margin: 0 9px 0px 1px;color: #114462;color: green;font-size: 20px;"></i>${row.from}`;
                 }
                 },
                //  { data: null,
                ...
                //  },
                 ...
                 render: function(data,type,row){
                     return `<div style="padding-bottom: 10px;"><i class="fa-solid fa-location-dot" style="font-weight: 00;margin: 0 9px 2px 4px;color: #114462;color: red;"></i>${row.to}`;
                 }
                 },
                 {
                  data: null,
                  ...
                  render: function(data,type,row){
                     let amountType = row.type.replace(/_/g, ' ').toUpperCase();
                    return `
                      <div>
                        <i class="fa-solid fa-user" style="font-weight: 00;margin: 0 9px 2px 4px;color: #114462;"></i>${row.driver_name != null ? row.driver_name : 'Driver not assign'}
                      </div>
                      ...
                      <div style="margin-top: 10px;">
                        <i class="fa-solid fa-building-columns" style="font-weight: 00;margin-left: 5px;color: #114462;"></i> ${amountType ? amountType : 'N/A'}
                      </div>
                    `;
                  }
                },

                 {
                     ...
                     render: function(data, type, row) {
                        ...
                        if (orderStatus == 'Pending') {
                            ...
                            style="width: 110px !important; color: white; margin-right: 0; background-color: #F5781F !important;">Pending</button>
                            
                            <button class="form-control booking-status me-5 bg-warning" onclick="changeBookStatus(${row.id}, this)" id="book_status${row.id}" data-btn_name = "Canceled" name="status"
                            style="width: 110px !important; color: white; margin-right: 0; background-color: #F33434 !important;">Canceled</button>`;
                            
                         }  
                        if (orderStatus == 'Confirmed') {
                            return `
                    
                             <button class="form-control booking-status me-5 bg-warning" id="book_status${row.id}" onclick="changeBookStatus(${row.id}, this)" data-btn_name = "Assigned" name="status" 
                            style="width: 110px !important; color: white; margin-right: 0; background-color: #FFC500 !important;">Confirmed</button>
                        ...
                        if (orderStatus == 'Assigned') {
                            ...
                            style="width: 110px !important; color: white; margin-right: 0; background-color: #0E73C9 !important;">Assigned</button>`;
                        ...
                        if (orderStatus == 'Completed') {
                            ...
                            style="width: 110px !important; color: white; margin-right: 0; background-color: #0ecb02 !important;">Completed</button>`;
                         ...
                         if (orderStatus == 'settled') {
                            return `
                             ...
                             <button class="form-control booking-status me-5 bg-warning" id="book_status${row.id}"  name="status" 
                            style="width: 110px !important; color: white; margin-right: 0; background-color: #0ecb02 !important;">Settled</button>`;
                            
                         } 
                         if (orderStatus == 'Moving') {
                            return `
                    
                             <button class="form-control booking-status me-5 bg-primary" id="book_status${row.id}" onclick="changeBookStatus(${row.id}, this)" data-btn_name = "Completed" name="status" 
                            style="width: 110px !important; color: white; margin-right: 0; background-color: #02c0cb !important;">Moving</button>`;
                            
                         } 
                        if (orderStatus == 'Dispatched') {
                            return `
                    
                             <button class="form-control booking-status me-5 bg-warning" onclick="changeBookStatus(${row.id}, this)" id="book_status${row.id}" data-btn_name = "Moving" name="status" 
                            style="width: 110px !important; color: white; margin-right: 0; background-color: #67138B !important;">Dispatched</button>`;
            ...
            new DataTable('#dash-table', {
             ...
             columns: [
                 ...
                 },
                {
                 ...
                 className:'dt-table-7',
                 render: function(data,type,row){
                    return `<div style="padding-bottom: 15px; padding-top: 15px;"><i class="fa-solid fa-location-dot" style="font-weight: 00;margin: 0 9px 0px 1px;color: #114462;color: green;font-size: 20px;"></i>${row.from ? row.from : 'N/A'}`;
                }
                 },
                //  { data: null,
                //  className: 'dt-table-14',
                ...
                //  },
                 ...
                 className: 'dt-table-8',
                 render: function(data,type,row){
                    return `<div style="padding-bottom: 10px;"><i class="fa-solid fa-location-dot" style="font-weight: 00;margin: 0 9px 2px 4px;color: #114462;color: red;"></i>${row.to ? row.to : 'N/A'}`;
                }
                 },
                 {
                  data: null,
                     ...
                     render: function(data, type, row) {
                        ...
                        if (orderStatus == 'Pending') {
                            return `
                             ...
                             <button class="form-control booking-status me-5 bg-warning" onclick="changeBookStatus(${row.id}, this)" id="book_status${row.id}" data-btn_name = "Confirmed" name="status" 
                            style="width: 100px !important; color: white; margin-right: 0; background-color: #F5781F !important;">Pending</button>
                            
                            <button class="form-control booking-status me-5 bg-warning" onclick="changeBookStatus(${row.id}, this)" id="book_status${row.id}" data-btn_name = "Canceled" name="status"
                            style="width: 100px !important; color: white; margin-right: 0; background-color: #F33434 !important;">Canceled</button>`;
                        ...
                        if (orderStatus == 'Assigned') {
                            return `
                             ...
                             <button class="form-control booking-status me-5 bg-warning" onclick="changeBookStatus(${row.id}, this)" id="book_status${row.id}" data-btn_name = "Dispatched" name="status" 
                            style="width: 100px !important; color: white; margin-right: 0; background-color: #0E73C9 !important;">Assigned</button>`;
...
function changeBookStatus(id, element){
            ...
            if ($(element).text() == "Confirmed") {
                warningClick('Alert','Kindy Assign the Driver',"danger");
                return;
            }
