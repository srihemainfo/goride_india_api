@extends($theme . '.layouts.app') @section('css') @endsection
@section('content')
<style>
  .widget {
...
<main>
  <div
    class="hero__two"
    style="background-image:linear-gradient(rgba(227, 237, 246, 0.5),rgba(115, 93, 255, 0)), url({{
      asset('ttwo/images/banner6.webp')
    }});background-position: center top;background-size: cover;"
  >
    <div
      class="header__main-wrap desk-vw"
        ...
        <div class="header__main ul_li_between">
          <div class="header__main-left ul_li flex-1">
            <div class="header__bar hamburger_menu">
              <a href="home"
                ><img src="{{ asset('ttwo/images/bar-2.svg') }}" alt
              /></a>
            </div>
            {{--
            <div class="header__logo ml-50">
              <a href="home">
                ...
                @if(isset($seoData['partnerWeb']->logo) &&
                $seoData['partnerWeb']->logo != '')
                <h1>
                  <img
                    src="{{ asset($seoData['partnerWeb']->logo) }}"
                    alt="logo"
                  />
                </h1>
                @endif
          ...
          <div class="main-menu navbar navbar-expand-lg">
            <nav class="main-menu__nav collapse navbar-collapse">
              ...
              collect($seoData['getAllPages'])->count() > 0) @php $topItems =
              collect($seoData['getAllPages'])->filter(function ($page) { return
              $page->position == 'top'; }); $getFirstFive =
              collect($topItems)->take(5); @endphp
              <ul class="navbar-nav">
          ...
          <div class="header__main-right ul_li"></div>
        </div>
      </div>
    </div>
    <div class="container-fluid">
      <div class="row align-items-center banner-contents">
        ...
        <div class="col-lg-8 right-content mb-5">
          <!-- widget1 -->
          <div
            class="widget rounded page-content bordered rounded padding-30 mb-5"
            id="about"
          >
            <p style="color: rgb(65, 65, 65); font-size: 14px">
              Welcome to our
              <strong>Car Fleet Booking Website</strong>!<br /><br />
              We’re excited to offer you a seamless and user-friendly
              experience. With just a few clicks, you can easily book a ride
              that suits your needs—whether you're looking for convenience,
              comfort, or speed.<br /><br />
              Our platform is designed to make booking your next trip simple,
              quick, and hassle-free. No more waiting around – enjoy a faster,
              smoother journey every time you book with us.<br /><br />
              Don’t wait – <strong>book your ride now</strong> and experience
              the difference!
            </p>
          </div>
        </div>
        ...
        <div class="service__slide">
          <div class="service__item">
            <div class="service__img">
              <img
                src="{{ asset('ttwo/images/seedan.png') }}"
                alt="fleet cars"
              />
            </div>
            <h3 class="service__title">
              <a href="javacript:void(0);">Sedan</a>
            </h3>
          ...
          <div class="service__item">
            <div class="service__img">
              <img
                src="{{ asset('ttwo/images/premium-suv.png') }}"
                alt="fleet cars"
              />
            </div>
            <h3 class="service__title">
              <a href="javacript:void(0);">Premium SUV</a>
            </h3>
            <ul class="service__list list-unstyled">
              <li>5 Peoples</li>
              <li>5 Luggages</li>
          ...
          <div class="service__item">
            <div class="service__img">
              <img
                src="{{ asset('ttwo/images/sprinter.png') }}"
                alt="fleet cars"
              />
            </div>
            <h3 class="service__title">
              <a href="javacript:void(0);">Sprinter</a>
            </h3>
            <ul class="service__list list-unstyled">
              <li>12 Peoples</li>
              <li>12 Luggages</li>
          ...
          <div class="service__item">
            ...
            <h3 class="service__title">
              <a href="javacript:void(0);">First Class</a>
            </h3>
            <ul class="service__list list-unstyled">
              <li>2 Peoples</li>
              <li>2 Luggages</li>
  ...
  <section
    id="clinox-service-feature"
    class="clinox-service-feature-section d-none"
  >
    <div class="container">
          ...
          <div class="col-lg-6">
            ...
            >
              ...
              <div class="clinox-service-feature-text position-relative">
                ...
                <p>
                  Experience top-tier airport transfer services with luxurious
                  vehicles, expert chauffeurs, and round-the-clock availability.
                  Whether for business or leisure, enjoy smooth, punctual, and
                  comfortable rides designed to meet your specific needs. Our
                  services extend to all major airports, including Toronto
                  Pearson International Airport (YYZ), ensuring you arrive at
                  your destination effortlessly and in style.
                </p>
                <ul>
          ...
          <div class="col-lg-6">
            ...
            >
              ...
              <div class="clinox-service-feature-text position-relative">
                ...
                <p>
                  Travel in elegance with our Demo Theme transfer services.
                  professional drivers, and luxurious vehicles, we ensure
                  timely, travel in style for airport transfers, special events,
                  or corporate needs effortlessly, comfortable, and stress-free
                  transportation for every journey you take.
                </p>
                <ul>
                  <li>
                    Spacious, comfortable and stylish vehicle options including
                    Premium SUV, Sprinter etc..
                  </li>
                  <li>Professionally dressed chauffeurs in suit and tie</li>
                  <li>
                    Accommodate 4 - 5 passengers plus luggage (depending on
                    vehicle choice)
                  </li>
                </ul>
              </div>
  ...
  <section
    id="clinox-service-offer"
    class="clinox-service-offer-section d-none"
  >
    <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="clinox-service-offer-item d-flex">
              <div
                class="inner-serial d-flex align-items-center justify-content-center"
              >
                01
              </div>
              <div class="inner-text headline pera-content">
                ...
                <p>
                  Navigate to our user-friendly website at www.Demo Themepro.ca
                  Our intuitive design ensures a hassle-free booking experience.
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="clinox-service-offer-item d-flex">
              ...
              <div class="inner-text headline pera-content">
                ...
                <p>
                  Reliable city transport services in Ajax, Burlington, and
                  Kitchener. Experience safe, punctual, and comfortable rides
                  tailored to your travel needs, ensuring seamless connectivity
          ...
          <div class="col-lg-4">
            <div class="clinox-service-offer-item d-flex">
              ...
              <div class="inner-text headline pera-content">
                ...
                <p>
                  Our experienced drivers are not just skilled behind the wheel;
                  they are also committed to providing a courteous and
                  professional service moment you arrive.
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="clinox-service-offer-item d-flex">
              ...
              <div class="inner-text headline pera-content">
                ...
                <p>
                  Experience seamless Corporate Airport Demo Themeusine services
                  for luxury business travel. Our professional chauffeurs ensure
                  timely, comfortable, and stylish transportation, elevating
                  your corporate journey to new heights.
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="clinox-service-offer-item d-flex">
              ...
              <div class="inner-text headline pera-content">
                ...
                <p>
                  Set up your regular commuting routes by entering your daily
                  pick-up and drop-off locations, preferred timings, and any
          ...
          <div class="col-lg-4">
            <div class="clinox-service-offer-item d-flex">
              ...
              <div class="inner-text headline pera-content">
                ...
                <p>
                  Provide details about your tour, including the destination,
                  date, and any specific stops or attractions you plan to visit
                  perfect vehicle selection.
                </p>
              </div>
            </div>
          </div>
  ...
  <div
    class="elfsight-app-b916b172-9c2c-4afe-a032-a85746e5d1bb"
