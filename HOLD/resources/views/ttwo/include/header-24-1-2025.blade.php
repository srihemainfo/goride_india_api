			...
			<div class="container mob-nav">
				<div class="header__top ul_li_between mt-none-15">
					<div class="header__social mt-15">
						<a href="index.html">{{ isset($seoData['partnerWeb']->company_name) && $seoData['partnerWeb']->company_name != ''  ? $seoData['partnerWeb']->company_name : 'Go Ride Run' }}</a>
					</div>
					<ul class="header__info ul_li mt-15">
						<li><i class="far fa-phone"></i><a class="text-dark" href="javacript:void(0);">{{ isset($seoData['partnerWeb']->whatsapp_number) && $seoData['partnerWeb']->whatsapp_number != ''  ? '+' . $seoData['partnerWeb']->whatsapp_number : '0000000000' }}</a></li>
						<li>
						    <i class="far fa-envelope"></i><a class="text-dark" href="javacript:void(0);"><span
									class="" >{{  isset($seoData['partnerWeb']->email) && $seoData['partnerWeb']->email != ''  ?  $seoData['partnerWeb']->email : 'support@goride.run'  }}</span></a></li>
					</ul>
				</div>
			</div>
		</div>
