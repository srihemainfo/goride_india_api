...
<section class="bp-section">
    <div class="container">
        <div class="text-center my-3 bottom-line mv-div">
            ...
            <h6 style="color:#ffffff; margin-bottom:0;">
        ...
        <table class="table table-bordered mt-3" style="color:#ffffff;">
            <tr>
        ...
        <div class="col-lg-12 mt-4 col-sm-12 mv-div">
            <p style="color:#ffffff;text-align:center;font-size:large">
            ...
            <p style="color:#ffffff;text-align:center;font-size:large">Best Regards</p>
            <p style="color:#ffffff;text-align:center;font-size:large">{{ ($seoData['partnerWeb']->company_name ?? '') }}</p>
        </div>
    </div>
</section>
<script>
