    ...
    <div class="container-fluid mt-5">
        ...
        <div class="row gy-4">
            <div class="col-lg-4">
                ...
                <iframe src="{{ env('iframeURL') . request()->getHost() }}" width="100%" height="500"
            ...
            <div class="col-lg-8 right-content mb-4">
                ...
                @if(isset($seoData['getAllPages']) && count($seoData['getAllPages']) > 0 && (isset($slug) || isset($seoData['activePagesContent'])))
                    <!-- widget1 -->
                    <div class="widget rounded page-content bordered rounded padding-30 {{ isset($seoData['activePagesContent']) ? '' : 'd-none' }}"
                        id="about">
