...
<head>
    ...
    <title>
        {{ $seoData['partnerWeb']->company_name ?? "Experience Premium Travel with GoRide |The World's Leading Limo & Cab Dispatch Software Solution" }}
    </title>
    ...
    <!-- Print CSS to remove unwanted elements during printing -->
    <style>
        @media print {
            /* Hide the header and footer in print */
            @page {
                margin: 0;
            }
            ...
            /* Hide elements like page numbers, timestamps, and URL */
            .footer, .header {
                display: none;
            }
        }
