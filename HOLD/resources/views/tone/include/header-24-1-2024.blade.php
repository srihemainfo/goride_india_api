...
<header class="header-classic">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-7 col-xs-12 text-end">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}">
                        <img src="{{ asset(isset($seoData['partnerWeb']->logo) && $seoData['partnerWeb']->logo != ''  ? $seoData['partnerWeb']->logo : 'tone/images/demoimage.png') }}" alt="logo" />
                    </a>
                </div>
                                    ...
                                    <div class="details">
                                        ...
                                        <div class="num-flex">
                                            <p class="mb-0">
                                                ...
                                                <a href="https://api.whatsapp.com/send?phone={{ $metaData['whatsapp_number'] ?? '000000000' }}&amp;text=Hello I need car service Please contact me" target="_blank">
    ...
    @php
        ...
        $getFirstFive = collect($seoData['getAllPages'])->take(5);
