                    ...
                    <div id="smtpSetup" class="email-hide" style="display:none;">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7 col-sm-7">
                                ...
                                <input type="text" id="smtp_host" name="smtp_host" class="form-control" maxlength="100" data-parsley-maxlength="100" value="stmp.gmail.com">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-7 col-sm-7">
                                ...
                                <input type="text" id="smtp_port" name="smtp_port" class="form-control" maxlength="100" data-parsley-maxlength="100" value="587">
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="form-label col-md-5 col-sm-5">Email</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="form-label col-md-5 col-sm-5">Password</label>
