            ...
            <div class="x_content-container">
                ...
                <form id="formSettingsEmail" class="form-horizontal form-label-left" method="post" data-parsley-validate novalidate enctype="multipart/form-data">
                    ...
                    <div class="row mb-3 mt-5 align-items-center">
                        ...
                        <label for="mailer_type1" class="form-label col-md-4 col-sm-4">
                        ...
                        <div class="col-md-8 col-sm-8 d-flex align-items-center">
                            ...
                            <!--    <label class="form-check-label" for="mailer_type2">Your Email</label>-->
                    ...
                    <div class="row mb-3 email-hide" style="display:none;">
                        ...
                        <label class="form-label col-md-5 col-sm-5">From Email <span class="required">&nbsp;*</span></label>

                        <div class="col-md-7 col-sm-7">

                            <input type="text" id="from_email" name="from_email" class="form-control" maxlength="100" data-parsley-maxlength="100" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <label class="form-label col-md-5 col-sm-5">Email Name <span class="required">&nbsp;*</span></label>

                        <div class="col-md-7 col-sm-7">

                            <input type="text" id="from_name" name="from_name" class="form-control" maxlength="100" data-parsley-maxlength="100" required>
                    ...
                    <div id="smtpSetup" class="email-hide" style="display:none;">
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="form-label col-md-5 col-sm-5">SMTP Host <span class="required">&nbsp;*</span></label>

                            <div class="col-md-7 col-sm-7">

                                <input type="text" id="smtp_host" name="smtp_host" class="form-control" maxlength="100" data-parsley-maxlength="100" value="smtp.gmail.com" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="form-label col-md-5 col-sm-5">SMTP Port <span class="required">&nbsp;*</span></label>

                            <div class="col-md-7 col-sm-7">

                                <input type="text" id="smtp_port" name="smtp_port" class="form-control" maxlength="100" data-parsley-maxlength="100" value="587" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="form-label col-md-5 col-sm-5">Encryption <span class="required">&nbsp;*</span></label>
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="form-label col-md-5 col-sm-5">Email <span class="required">&nbsp;*</span></label>

                            <div class="col-md-7 col-sm-7">

                                <input type="text" id="smtp_user_name" name="smtp_user_name" class="form-control" maxlength="100" data-parsley-maxlength="100" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <label class="form-label col-md-5 col-sm-5">Password <span class="required">&nbsp;*</span></label>

                            <div class="col-md-7 col-sm-7">

                                <input type="password" id="smtp_password" name="smtp_password" class="form-control" maxlength="100" data-parsley-maxlength="100" required>
