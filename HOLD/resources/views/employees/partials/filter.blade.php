<div class="col-sm-9  main-card mb-3 card">
    ...
    <div class="card-header">
        ...
        <h4 class="card-title">Employee Filter</h4>
        ...
        <form method="post" id="emp_filter">
            ...
            <div class="col-sm-12 row mb-2">
                ...
                <div class="col-sm-3">
                    ...
                    <label for="phone_filter">Phone No</label>

                    <input type="text" class="form-control" id="phone_filter" placeholder="Search by phone" name="phone_filter" value="">
