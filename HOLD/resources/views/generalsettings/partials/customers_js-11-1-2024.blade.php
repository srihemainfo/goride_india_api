    ...
    new DataTable('#emp-table', {
        ...
        columns: [
            ...
            },
            {
                data: null,
                render: function(data, type, row) {
                    return '<span style="padding: 8px;"><i class="fa-regular fa-pen-to-square" style="background: green;color: #fff;padding: 6px 7px;border-radius: 6px;margin: 0 0 6px 0;" onclick="edit_employee(' + row.id + ')"></i></span>' +
