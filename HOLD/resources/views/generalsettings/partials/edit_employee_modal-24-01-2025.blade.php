  ...
  <div class="modal-dialog modal-dialog-aside" role="document" style="width: 30%;">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                ...
                <form id="edit_employeeForm" class="form-horizontal" method="post" action="" data-parsley-validate="" enctype="multipart/form-data" novalidate="">
                ...
                <div class="mb-3 row">
                        ...
                        <div class="col-md-7 col-sm-7">
                            <div class="input-group">
                                ...
                                <input type="text" id="edit_country_code" name="edit_country_code"  value="+91" disabled="disabled" style="width: 50px; text-align: center;padding:3px;" />

                                <!-- Contact Number Input -->
                                <input type="tel" id="edit_contact_number" name="edit_contact_number" oninput="validateContactNumber(this)" maxlength="15" class="form-control" required="required" 
                ...
                <div class="col-md-7 col-sm-7">
                    ...
                    <div class="input-group">
                                <!-- Country Code Input (Disabled) -->
                        <input type="text" id="edit_country_code_whatsapp" name="edit_code_whatsapp"  value="+91" disabled="disabled" style="width: 50px; text-align: center;padding:3px;" />

                        <input type="hidden" id="hidden_phoneCode" name="hidden_phoneCode" value="+91"/>

                    <input type="tel" id="edit_whatsapp_number" name="edit_whatsapp_number"  class="form-control"  maxlength="15" data-parsley-maxlength="15" oninput="validateContactNumber(this)" data-parsley-pattern="/^([+]|(00))[ ()0-9]{9,18}$/" data-parsley-error-message="Enter valid contact number with country code, e.g., +91 7358543391">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-7 col-sm-7">
                    ...
                    <input type="email" id="edit_email" name="edit_email" class="form-control" required="required" maxlength="100" data-parsley-maxlength="100">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-7 col-sm-7">
                    ...
                    <input type="text" id="edit_website_prefix" name="edit_website_prefix" class="form-control" required="required" maxlength="100" data-parsley-maxlength="100">
            ...
            <div class="mb-3 row">
                ...
                <label class="form-label col-md-5 col-sm-5">Contact address<span style="color: red;">*</span></label>

                <div class="col-md-7 col-sm-7">

                    <textarea id="edit_company_address" name="edit_company_address" class="form-control" rows="5" required="required" maxlength="1000" data-parsley-maxlength="1000"></textarea>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-7 col-sm-7">
                    ...
                    <input type="text" id="edit_company_name" name="edit_company_name"  class="form-control" required="required" maxlength="100" data-parsley-maxlength="100">
            ...
            <div class="mb-3 row">
                ...
                <label class="form-label col-md-5 col-sm-5">Logo<span style="color: red;">*</span></label>

                <div class="col-md-7 col-sm-7">

                    <input type="file" id="edit_txtLogo" class="form-control" name="edit_txtLogo" accept="image/*" alt="Logo" onchange="if (!window.__cfRLUnblockHandlers) return false; preview_image(event)">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-7 col-sm-7">
                    ...
                    <img id="edit_imagePreview" name="edit_imagePreview" src="" class="img-thumbnail" style="max-width: 200px">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-7 col-sm-7">
                    ...
                    <input type="file" id="edit_favicon" class="form-control" name="favicon" accept="image/*" alt="favicon" onchange="if (!window.__cfRLUnblockHandlers) return false; preview_image_favicon(event)">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-7 col-sm-7">
                    ...
                    <img id="edit_imagePreviewFavicon" src="" class="img-thumbnail" style="max-width: 200px">
