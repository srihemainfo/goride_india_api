<script>
    ...
    function showlist() {
        ...
        new DataTable('#emp-table', {
            ...
            columns: [
                ...
                },
                {
                    data: 'favicon',
                    render: function (data, type, row) {
                        var faviconUrl = data ? data : row.logo;
       ...
       &nbsp;
                                <a class="btn text-danger btn-sm" style="cursor: pointer; font-size: 16px;" onclick="viewCode('${row.cweburl}')">
    ...
    $('#saveBtn').click(function (e) {
        ...
        const contactAddressError = $('#contact_address_error');
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status == 400) {
                    ...
                    warningClick('Error', response['error'], "danger");  // Show warning
