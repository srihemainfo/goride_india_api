...
@section('content')
    <div class="col-sm-4 main-card card mx-auto">
        <div class="card-header">
            <h4 class="card-title">Generate Driver Settled Job's Report</h4>
        </div>
        <div class="card-body">
            <div class="col-sm-12">
                <div class="form-group">
                    <label for="driver_name_filter" class="col-form-label">Driver Name <span class="required"> *</span></label>
                    <select class="form-control" class="form-control select2 select2-hidden-accessible" style="width: 100%;"
                        tabindex="-1" aria-hidden="true" id="driver_name_filter" name="driver_name_filter"
                        data-control="select2" data-placeholder="Select driver for booking" data-hide-search="true">
                        <option value="">-- select driver --</option>
                        
                        @if( isset($list_drivers) && count($list_drivers) > 0)
                        @foreach ($list_drivers as $driver)
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    <label for="report_type" class="col-form-label">Report Type <span class="required"> *</span></label>
            ...
            <div class="col-sm-12" id="month_select" style="display: none;">
                <div class="form-group">
                    <label for="month_filter" class="col-form-label">Month <span class="required"> *</span></label>
                    <select class="form-control" class="form-control select2 select2-hidden-accessible" style="width: 100%;"
            ...
            <div class="col-sm-12" id="week_select" style="display: none;">
                <div class="form-group">
                    <label for="week_filter" class="col-form-label">Week <span class="required"> *</span></label>
                    <select class="form-control" class="form-control select2 select2-hidden-accessible" style="width: 100%;"
            ...
            <div class="col-sm-12" id="custom_select" style="display: none;">
                <div class="form-group">
                    <label for="custom_filter">Custom Date Range <span class="required"> *</span></label>
     ...
     <div class="col-sm-2 main-card mb-3 card  d-none d-lg-block position" style="background-color: #343a40;">
  <div class="nav flex-column nav-tabs nav-tabs-right " id="vert-tabs-right-tab" role="tablist" aria-orientation="vertical">
    
    <a class="nav-link   text-light" id="vert-tabs-right-home-tab" href="/admin-report" role="tab" aria-controls="vert-tabs-right-home" aria-selected="true" style="cursor: pointer; background-color: #343a40;">
      <i class="fas fa-file-alt" style="margin-right: 8px;"></i> Admin Report
    </a>
    
    <a class="nav-link active text-light" id="vert-tabs-right-offer-times-tab" href="/driver-report" role="tab" aria-controls="vert-tabs-right-profile" aria-selected="false" style="cursor: pointer;">
...
@section('custom_scripts')
    @include('reports.partials.driver_report_js')
@endsection
