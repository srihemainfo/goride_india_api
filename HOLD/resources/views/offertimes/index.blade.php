...
<div class="col-sm-9 main-card mb-3 card">
    ...
    <div class="card-header row container">
        ...
        <div class="col-9">
            ...
            <h4 class="card-title text-start mt-0  p-0">List Of Pricing By Time</h4>
        ...
        <div class="modal-dialog modal-dialog-aside" role="document" style="width: 30%;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title">Pricing By Time Creation</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="cost" class="col-form-label">
                                        Cost in (Amount) <span class="required">&nbsp;*</span>
                                    ...
                                    <input type="number" class="form-control" name="cost" id="cost" placeholder="0.00" min="0" max="99999999" oninput="if(this.value.length > 8) this.value = this.value.slice(0, 8);">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" name="from" id="from" placeholder="Enter from time">
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="to" class="col-form-label">Time To (24 hour format & Integer value Only)<span class="required">&nbsp;*</span></label>

                                    <input type="number" class="form-control" name="to" id="to" min="0" max="24" placeholder="Enter to time" oninput="validateInput(this)">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" name="to" id="to" placeholder="Enter to time">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="4" cols="50" name="content" class="form-control"  oninput="this.value = this.value.slice(0, 100)" id="content"></textarea>
        ...
        <div class="modal-dialog modal-dialog-aside" role="document" style="width: 30%;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="editorModalLabel">Pricing By Time Edit</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" name="editfrom" id="editfrom" placeholder="Enter from time">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" name="editto" id="editto" placeholder="Enter to time">
