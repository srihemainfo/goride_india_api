...
<div class="col-sm-9 main-card mb-3 card">
  ...
  <div class="card-header row container">
    ...
    <div class="col-9">
      ...
      <h4 class="card-title text-start mb-0  mt-1 p-0">Pricing By Date</h4>
  ...
  <div class="modal-dialog modal-dialog-aside" role="document" style="width: 30%;">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h5 class="modal-title">Pricing By Date Creation</h5>
  ...
  <div class="modal-dialog modal-dialog-aside" role="document" style="width: 30%;">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h5 class="modal-title" id="editorModalLabel">Pricing By Date Edit</h5>
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="editcost" id="editcost" placeholder="Enter the Cost" min="0" max="99999999" oninput="if(this.value.length > 8) this.value = this.value.slice(0, 8);">
                <p class="text-danger invalid-cost"></p>
            ...
            <div class="col-sm-12">
              ...
              <div class="form-group">
                ...
                <textarea rows="4" cols="50" name="editcontent" oninput="this.value = this.value.slice(0, 100)" class="form-control" id="editcontent"></textarea>
