<div id="form-modal" class="modal fixed-left fade" tabindex="-1" role="dialog">
    ...
    <div class="modal-dialog modal-dialog-aside" role="document" style="width: 50%;">
      ...
      <div class="modal-content">
        ...
        <h5 id="modalTitle" class="modal-title">Location Range Form</h5>
        ...
        <div class="modal-body">
            ...
            <form id="locationrangeForm" name="locationrangeForm">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '')" name="name" maxlength="30" id="name" placeholder="Enter Zone Name">
                    ...
                    <div class="form-group">
                        ...
                        <label for="from_charge" class="col-form-label">PickUp Charge<span class="required">&nbsp;*</span></label>

                        <input type="number" class="form-control" name="from_charge" id="from_charge" placeholder="0.00" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 5)">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="to_charge" id="to_charge" placeholder="0.00" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 5)">
