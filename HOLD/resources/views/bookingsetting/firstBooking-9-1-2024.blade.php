            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="row">
                            <label class="col-form-label col-md-5 col-sm-5">Advance booking minimum <button type="button" class="TOOL btn btn-secondary" data-toggle="tooltip" data-placement="top" title="Please set sufficient manimum time before booking for your customer">i</button></label></label>
