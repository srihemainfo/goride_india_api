                        ...
                        <div class="x_content">
                            <div class="x_content-container">
                                <form id="formSettingsSocialMedia" class="form-horizontal" method="post" data-parsley-validate>
                                    <div class="row mb-3">
                                        <label for="countrySearch" class="col-form-label col-md-5 col-sm-5">Operating country:</label>
                                    ...
                                    <div class="row mb-3">
    <label for="timezone" class="col-form-label col-md-5 col-sm-5">Timezone</label>
    <div class="col-md-7 col-sm-7">
        ...
        <div id="dropdowntimezone" class="dropdown-list form-select arrow-none"></div>
                                    ...
                                    <!--</div>-->
                                        <div class="row mb-3">
                                        <label for="timezone" class="col-form-label col-md-5 col-sm-5">Currency</label>
                                        <div class="col-md-7 col-sm-7">
                ...
                <div class="col-sm-2 main-card mb-3 card d-none d-lg-block" style="background-color: #343a40;position:fixed;right:0;top:7rem;bottom:1.8rem;">
