...
<div class="row row-sm ">
    ...
    <div class="form-group">
                    <label for="btn-text">Title (link tag)</label><span style="color:red;">&nbsp;*</span>
                       ...
                       <input type="url" class="form-control" id="btn-text" name="btn-text" placeholder="Enter article button text"
                        oninput="this.value = this.value.replace(/[^A-Za-z0-9-_ ]/g, '');" maxlength="70" required>
                  ...
                  <table class="table table-bordered text-nowrap border-bottom"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                             ...
                                                             <th class="column_sort sorting sorting_asc">Link Title</th>
