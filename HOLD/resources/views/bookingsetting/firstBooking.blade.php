                                ...
                                <form id="formSettingsSocialMedia" class="form-horizontal" method="post" data-parsley-validate>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-7 col-sm-7">
                                            ...
                                            <input class="form-control " type="text" name="company_name" id="company_name" placeholder="Enter Company Name" autocomplete="off" value="Your Company" oninput="this.value = this.value.replace(/[^0-9a-zA-z ]/g, '').slice(0, 30);">
                                    ...
                                    <div class="row mb-3">
                                            ...
                                            <label for="" class="col-form-label col-md-5 col-sm-5">Timezone: <span class="required">*</span></label>
                                        ...
                                        <label for="" class="col-form-label col-md-5 col-sm-5">Currency: <span class="required">*</span></label>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <label class="col-form-label col-md-5 col-sm-5">Distance Calculated By: <span class="required">*</span></label>
