...
<div class="row row-sm ">
    <div class="col-lg-12 mb-3" style="display: none;" role="main" id="formArit">
        <div class="card ">
            ...
            <div class="card-body">
                <div class="new-form-container m-3 ">
                    ...
                    <div class="form-group">
                        <label for="btn-text">Position</label><span style="color:red;">&nbsp;*</span>
                        <div>
                            <label><input type="radio" name="Position" value="top">&nbsp;Top</label><br>
                            <label><input type="radio" name="Position" value="bottom" checked>&nbsp;Bottom</label><br>
                        </div>
                        <!-- <label><input type="radio" name="Position" value="3"> Option 3</label><br> -->
                    </div>
            ...
            <div class="card-header">
                ...
                <div class="col-lg-8">
                    <div class="col-sm-12 col-md-6 col-lg-4 mt-4">
                        <button type="button" class="btn btn-primary d-none" id="searchBTN"
                            onclick="unsubscribeList();">GO</button>
                    </div>

                    <div class="col-sm-12 col-md-6 col-lg-4 mt-4">
                        <label for="urlType" class="d-block">&nbsp;</label></span>
                        <button class="btn btn-outline-primary w-100" onclick="$(`#formArit`).show();$(`html, body`).animate({ scrollTop: 0 }, 500);">
                            <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Add
                        </button>
                    </div>
                </div>
...
<script>
            ...
            const table = $('#Participation_List').DataTable({
                ...
                ajax: { 
                    ...
                    dataSrc: function (response) {
                        // console.log("Jana1",response);
                        // console.log("Jana2",response.data);
                        if (response.status === 200) {
    ...
    const saveContent = (id = '') => {
        try {
            ...
            var selectPosition = $('input[name="Position"]:checked').val();
            ...
            if (selectPosition == null || selectPosition == undefined || selectPosition == 'null' || selectPosition.trim() == '') {
                showToast('error', 'Position is required!', 5000);
                return false;
            }
            ...
            h.append('id', id);
            h.append('position', selectPosition);
