                    ...
                    <div class="wizard">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation" class="active" >
                                    ...
                                    <a href="bookingSetting" ><span class="round-tab"><i class="fa-solid fa-check"></i> </span> <i class="book-id">Booking Settings</i></a>
                                ...
                                <li role="presentation" class="active second-round"class="{{ request()->routeIs('first-fleet') ? 'active' : 'disabled'}}">
                                    ...
                                    <a href="create-fleet"><span class="round-tab"><i class="fa-solid fa-check"></i></span> <i class="book-id">Fleet Creation</i></a>
