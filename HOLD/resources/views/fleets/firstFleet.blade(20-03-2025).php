                ...
                <div class="col-md-12">
                    ...
                    <div class="wizard">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation" class="active second-round"class="{{ request()->routeIs('first-fleet') ? 'active' : 'disabled'}}">

                                    <a href="create-fleet"><span class="round-tab" ><i class="fa-solid fa-check"></i></span> <i class="book-id second">Fleet Creation</i></a>
          ...
          <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <label for="name" class="col-form-label">Fleet / Car Name<span class="required">&nbsp;*</span></label>
...
<div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <label for="luggage" class="col-form-label">luggage</label>
                     ...
                     <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <label for="hand_luggage" class="col-form-label">Hand Luggage</label>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <label for="child" class="col-form-label">Child Seats/ Booster</label>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <label for="child" class="col-form-label">Fare Per Km/ Miles</label>

                            <input type="number" class="form-control" name="fare_pice" id="fare_pice" placeholder="Enter Fare" value="0" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 3);">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <label for="name" class="col-form-label">Fleet Image</label>

                                <input type="file" class="" name="file" id="fileInput" placeholder="Enter Fleet Image" value="">
