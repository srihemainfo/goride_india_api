@php
    ...
    $tools_urls = ['fleet', 'currency', 'offertimes', 'offerdays', 'promocode', 'notifications', 'livetracking'];
    $pricing_urls = [
        'generalpricing',
        'vehiclepricing',
        'distanceslab',
    ...
    $employee_urls = ['employee', 'module-permissions', 'roles'];
    $settings = [
        'bookingsetting',
        'emailsetting',
        'EmailTemplate',
    ...
    <div class="scrollbar-sidebar">
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu metismenu">
                ...
                @endphp
                @if ($sessionPermission['BOOKING_MODULE_read'] ?? false)
                    <li>
                ...
                @if (
                    ($sessionPermission['CAR_FARE_MODULE_read'] ?? false) ||
                        ($sessionPermission['LIST_AREAS_MODULE_read'] ?? false) ||
                        ($sessionPermission['LOCATION_RANGE_MODULE_read'] ?? false))
                    ...
                    <li>
                        ...
                        <ul class="mm-collapse">
                            @if ($sessionPermission['CAR_FARE_MODULE_read'] ?? false)
                                <li>
                                    <a href="{{ url('/carfares') }}"
                            ...
                            @endif
                            @if ($sessionPermission['LOCATION_RANGE_MODULE_read'] ?? false)
                            <li>
                ...
                @if (
                    ($sessionPermission['EMPLOYEE_MODULE_read'] ?? false) ||
                        ($sessionPermission['MODULE_PERMISSIONS_read'] ?? false) ||
                        ($sessionPermission['ROLE_MODULE_read'] ?? false))
                ...
                <li class="{{ in_array(Request::segment(1), $employee_urls) ? 'mm-active' : '' }}">
                    ...
                    <ul class="mm-collapse">
                        @if ($sessionPermission['EMPLOYEE_MODULE_read'] ?? false)
                        <li>
                        ...
                        @endif
                        @if ($sessionPermission['MODULE_PERMISSIONS_read'] ?? false)
                        <li>
                        ...
                        @endif
                        @if ($sessionPermission['ROLE_MODULE_read'] ?? false)
                        <li>
                            <a href="{{ route('roles') }}"
                                class="{{ Request::segment(1) === 'roles' ? 'mm-active' : '' }}">
                                <i class="metismenu-icon pe-7s-users"></i> Role
                            </a>
                        </li>
                        @endif
                    </ul>
                ...
                @if ($sessionPermission['CUSTOMER_MODULE_read'] ?? false)
                ...
                @if (
                    ($sessionPermission['LIST_FLEETS_MODULE_read'] ?? false) ||
                        ($sessionPermission['CURRENCY_MODULE_read'] ?? false) ||
                        ($sessionPermission['OFFER_TIMES_MODULE_read'] ?? false) ||  ($sessionPermission['OFFER_DAYS_MODULE_read'] ?? false))
                <li class="{{ in_array(Request::segment(1), $tools_urls) ? 'mm-active' : '' }}">
                    ...
                    <ul class="mm-collapse">
                        @if ($sessionPermission['LIST_FLEETS_MODULE_read'] ?? false)
                        <li>
                        ...
                        <!--    </a>-->
                        <!--</li>-->
                        @if ($sessionPermission['OFFER_TIMES_MODULE_read'] ?? false)
                        <li>
                        ...
                        @endif
                        @if ($sessionPermission['OFFER_DAYS_MODULE_read'] ?? false)
                        <li>
            ...
            --}}
                ...
                @if ($sessionPermission['DRIVER_MODULE_read'] ?? false)
                ...
                @endif
                @if (($sessionPermission['GENERATE_INVOICE_read'] ?? false) || ($sessionPermission['SETTLEMENT_MODULE_read'] ?? false))
                ...
                <li class="{{ in_array(Request::segment(1), $payment_urls) ? 'mm-active' : '' }}">
                    ...
                    <ul class="mm-collapse">
                        @if (($sessionPermission['GENERATE_INVOICE_read'] ?? false) )
                        <li>
                        ...
                        @endif
                        @if (($sessionPermission['SETTLEMENT_MODULE_read'] ?? false) )
                        <li>
                ...
                <li class="{{ in_array(Request::segment(1), $report_urls) ? 'mm-active' : '' }}">
                    ...
                    <ul class="mm-collapse">
                        @if (($sessionPermission['ADMIN_REPORT_read'] ?? false) )
                        <li>
                ...
                @if (($sessionPermission['BOOKING_SETTING_read'] ?? false) || ($sessionPermission['DRIVER_REQUES_SETTING_read'] ?? false) || ($sessionPermission['EMAIL_SETTING_read'] ?? false) || ($sessionPermission['EMAIL_TEMPLATE_SETTING_read'] ?? false) || ($sessionPermission['PAYMENT_OPTIONS_SETTING_read'] ?? false) || ($sessionPermission['BOOKING_RESTRUCTION_DATE_SETTING_read'] ?? false) || ($sessionPermission['GOOGLE_CALENDAR_SETTING_read'] ?? false) || ($sessionPermission['REVIEW_SETTING_read'] ?? false))
                ...
                <li class="{{ in_array(Request::segment(1), $settings) ? 'mm-active' : '' }}">
                    ...
                    <ul class="mm-collapse">
                        ...
                        @if (($sessionPermission['BOOKING_SETTING_read'] ?? false))
                        <li>
                            <a href="{{ route('bookingsetting') }}"
                                class="{{ Request::segment(1) === 'bookingsetting' ? 'mm-active' : '' }}">
                                <i class="metismenu-icon pe-7s-users"></i>Settings
                            </a>
                        </li>
                        @endif
                        @if (($sessionPermission['DRIVER_REQUES_SETTING_read'] ?? false))
                        <li>
                            <a href="{{ route('driver-request') }}"
                                class="{{ Request::segment(1) === 'driver-request' ? 'mm-active' : '' }}">
                                <i class="metismenu-icon pe-7s-users"></i>Driver Request
                            </a>
                        </li>
                        @endif
                        @if (($sessionPermission['EMAIL_SETTING_read'] ?? false))
                        <li>
                        ...
                        @endif
                        @if (($sessionPermission['EMAIL_TEMPLATE_SETTING_read'] ?? false))
                        <li>
                        ...
                        <!--    </a>-->
                        <!--</li>-->
                        @if (($sessionPermission['PAYMENT_OPTIONS_SETTING_read'] ?? false))
                        <li>
                        ...
                        @endif
                        @if (($sessionPermission['BOOKING_RESTRUCTION_DATE_SETTING_read'] ?? false))
                        ...
                        @if (isset($aa))
                        @if (($sessionPermission['GOOGLE_CALENDAR_SETTING_read'] ?? false))
                            <li>
                            ...
                            @if (($sessionPermission['REVIEW_SETTING_read'] ?? false))
            ...
            @endif
                @if (isset($aa))
                    <li class="{{ in_array(Request::segment(1), $driver_request_urls) ? 'mm-active' : '' }}">
                        <a href="javascript:void(0)"
                            class="{{ in_array(Request::segment(1), $driver_request_urls) ? 'mm-active' : '' }}">
