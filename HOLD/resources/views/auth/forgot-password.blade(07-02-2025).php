...
<x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', '')" required autofocus oninput="validateEmailInput(this)" maxlength="254" />
    ...
    <span></span>
        ...
        <a href="/login" class="text-light btn btn-warning fw-semibold fs-lg inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150" id="forgot_btn" style="font: zize 11px; font: weight 700px;">
        Login
    </a>
