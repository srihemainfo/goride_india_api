<div id="form-modal" class="modal fixed-left fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-aside" role="document" style="width: 30%;">
        <div class="modal-content">
                    ...
                    <div class="col-sm-12 mb-4">
                        ...
                        <form method="post" id="upload_form" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="file" class="form-control-file border" name="select_file" id="select_file" accept=".pdf,.jfif, .jpg, .png, .doc" />
            ...
            <input type="button" name="upload" id="file_upload_btn" class=" btn btn-primary" value="upload">
            </div>
        </div>
    </div> <!-- modal-bialog .// -->
</div> <!-- modal.// -->