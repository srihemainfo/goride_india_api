...
<div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 mb-4">
            ...
            <input type="text" class="form-control" id="vehicle_reg_no" placeholder="Vehicle Reg No." name="vehicle_reg_no" value="" oninput="this.value = this.value.replace(/[^a-zA-Z0-9]/g, '').slice(0, 20);"> 
        ...
        <div class="col-sm-6 mb-4">
            ...
            <label for="vehicle_insurance">Vehicle Insurance <span class="required">*</span></label>

            <input type="text" class="form-control" id="vehicle_insurance" placeholder="Vehicle Insurance" name="vehicle_insurance" required value="" oninput="this.value = this.value.replace(/[^a-zA-Z0-9]/g, '').slice(0, 25);">
        ...
        <div class="col-sm-6 mb-4">
            ...
            <label for="vehicle_insurance_expiry">Insurance Expiry on <span class="required">*</span></label>

            <input type="date" class="form-control future-date" id="vehicle_insurance_expiry"  name="vehicle_insurance_expiry" value="" required>
        ...
        <div class="col-sm-6 mb-4">
            ...
            <label for="vehicle_license">Vehicle Licence / RC No. <span class="required">*</span></label>

            <input type="text" class="form-control" id="vehicle_license" placeholder="Vehicle Licence" name="vehicle_license" value="" required oninput="this.value = this.value.replace(/[^a-zA-Z0-9]/g, '').slice(0, 25);">
         ...
         <div class="col-sm-6 mb-4">
            ...
            <label for="vehicle_license_expiry">Licence Expiry on <span class="required">*</span></label>

            <input type="date" class="form-control future-date" id="vehicle_license_expiry"  name="vehicle_license_expiry" value="" required>
        ...
        <!--    <label for="vehicle_license">Add RC Certificate No. </label>-->

        <!--    <input type="text" class="form-control" id="add_cerficate" placeholder="Add Certificate No" name="add_cerficate" value="">-->
        ...
        <!--</div>-->
         ...
         <div class="col-sm-6 mb-4">
            ...
            <label for="driver_license_no">Driver Licence No. <span class="required">*</span></label>

            <input type="text" class="form-control" id="driver_license_no" placeholder="Driver Licence No." required name="driver_license_no" value="" oninput="this.value = this.value.replace(/[^a-zA-Z0-9]/g, '').slice(0, 25);">
        ...
        <div class="col-sm-6 mb-4">
            ...
            <label for="driver_license_no_expiry">Driver Licence Expiry on <span class="required">*</span></label>

            <input type="date" class="form-control future-date" id="driver_license_no_expiry"  name="driver_license_no_expiry" value="" required>
        ...
        <div class="col-sm-6 mb-4">
            ...
            <label for="mot_no">MOT / Pollution Certificate No.</label>
        ...
        <div class="col-sm-6 mb-4">
            ...
            <label for="mot_no_expiry">MOT / Pollution Certificate Expiry on</label>
