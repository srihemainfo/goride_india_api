...
//     $.ajaxSetup({
    ...
    let select_file = $('#select_file').val('');
    ...
    var fileInput = $('#select_file')[0].files[0];  
    if (fileInput) {
...
///////////////////////////////////////////////////////////////
    ...
    $.each(document_details, function (key, item) {
        $('#uploaded_documents_view').append('<tr>\
            ...
            <td>\
                <a href="/driver-documents/' + item.driver_id + '/' + item.file_path + '" target="_blank" id="document_view" class="mb-2 mr-2 btn-sm btn-transition btn" style="color: #266444; border-color:#266444;" title="View Document">\
                    <i class="fa fa-eye"></i>\
                </a>\
