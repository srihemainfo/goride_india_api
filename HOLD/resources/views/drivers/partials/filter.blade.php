<div class="col-sm-11 main-card mb-3 card d-none">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-12 row mb-3">
                <div class="col-sm-6">
                    <button type="button" class="btn btn-primary mt-2 me-2" id="search"><i class="fa fa-filter"></i>&nbsp; Filter</button>
                    <button type="button" class="btn btn-danger mt-2" id="reset_filter"><i class="fa fa-undo"></i>&nbsp; Reset</button>
                </div>
            </div>
            </form>   
        </div>
