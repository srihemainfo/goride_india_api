...
.modal.driver-modelactive {

    .modal-dialog {

        margin: 1.75rem 8rem 1.75rem 25rem;
...
.dropdown-currency{
 ...
 <div class="modal fade" id="add-drivermodel" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        ...
                                        <div>
                                           ...
                                           <div class="row justify-content-center align-items-center">
                                            ...
                                            <div class="d-flex justify-content-center text-center">
                                                ...
                                                <!--<button type="submit" class="btn" style="background: #146dbb; color: #fff;font-size: 16px;font-weight: 600;"onclick="window.location.href = '/create-carfares'; ">Save and Previous</button>-->

                                                <button type="submit" id="driver_sub" class="btn btn-primary ms-2">Submit</button>
