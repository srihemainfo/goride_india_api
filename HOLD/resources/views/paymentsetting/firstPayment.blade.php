          ...
          <div class="card border border-secondary mb-3">
            ...
            <div class="card-header">
              ...
              <div class="form-check">
                ...
                <label class="form-check-label" for="cashPaymentFor" id="payby" style="font-size:18px;">Pay By Cash</label>
                <input type="hidden" name="cash_title" id="cash_title"  class="form-control" maxlength="100" data-parsley-maxlength="100" value="pay_by_cash">
              </div>
            ...
            <!-- <div class="card-body">
              ...
              <label class="form-label">Website Billing Screen Title</label>
              <input type="text" name="cash_title" id="cash_title" class="form-control" maxlength="100" data-parsley-maxlength="100" placeholder="Pay By Cash">
              <div class="text-end mt-2" style="position: relative;">
  <div class="hover-box" style="display: inline-block; position: relative;">
    <button
    ...
    <div class="hover-box-container">
      <img
        src="dashboard-assets/assets/images/logo-inverse1.png"
        class="hover-img"
        alt="Tooltip Image"
      />
    </div>
...
.hover-box:hover .hover-box-container {
  display: block;
}

.hover-img {
  max-width: 100px; /* Adjust image size as needed */
  display: block; /* Ensure image stays contained */
}
