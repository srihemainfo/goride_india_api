...
$(".templateInsert").on('click', function(e){
	var templateID = $(this).attr('id');
	var templateChange = 'N';
	templateID = templateID.replace("t", "");

	var pageContentCurr = $('.summernote').html(escape($('.summernote').summernote('code')));
	if (pageContentCurr != "") {
		var confResult = confirm("This will replace existing page content");
		if (confResult == true) {
			templateChange = 'Y';
		}
	}
	...
	if (templateChange == 'Y') {
		$.ajax({url: "page-template.php?t="+templateID, success: function(result){
