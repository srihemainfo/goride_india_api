...
<div class="col-sm-9 main-card mb-3 card">
    ...
    <div class="card-header row container">
       ...
       <h4 class="card-title text-start mt-0 p-0">Email Templates List</h4>
                ...
                <form id="fleetForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" oninput="this.value = this.value.slice(0, 20)" name="template_name" id="template_name" placeholder="Enter Template Name">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control summernote" name="description" oninput="this.value = this.value.slice(0, 200)" id="description" placeholder="Enter description"></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" oninput="this.value = this.value.slice(0, 20)" name="edittemplate_name" id="edittemplate_name" placeholder="0.00">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="editdiscription" oninput="this.value = this.value.slice(0, 200)" id="editdiscription" min="0" max="24" placeholder="Enter to time">
...
@section('custom_scripts')
    ...
    @include('emailTemplate.partials.offertimes_js')
