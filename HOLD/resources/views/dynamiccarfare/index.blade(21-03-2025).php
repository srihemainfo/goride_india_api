...
<div class="col-sm-9 mx-4 main-card mb-3 card">
    <div class="card-header">
        <h4 class="card-title mr-4">Check Car Fares Calculation <button type="button" style="border-radius: 70%;" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="Please Update the Car's Fares List Before Calculating!."><i class="fa-solid fa-info"></i></button></h4>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <form id='priceCal'>
