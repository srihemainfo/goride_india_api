...
<div class="col-sm-12 mx-4 main-card mb-3 card">
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                         ...
                                         <li role="presentation" class="active">
                                            ...
                                            <a href="create-carfares" ><span class="round-tab"><i class="fa-solid fa-check"></i> </span> <i class="book-id"> Car Fare</i></a>
                                        ...
                                        <!-- <li role="presentation">
                                         ...
                                         <div class="card-body">
                                            ...
                                            <div class="col-sm-12 main-card mb-3 card">
                                                <div class="card-header">
                                                    <h4 class="card-title mr-4">Description of Fares</h4>
                                                </div>
                                                <div class="card-body">
                                                    <div class="table-responsive">
