<div class="col-sm-12 main-card mb-3 card" id="outward_container">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-4"> 
                <label for="country_websites">Website <span class="required">*</span></label>
                    <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1"
                        aria-hidden="true" id="country_websites" name="country_websites" data-control="select2"
                        data-placeholder="Choose the website" data-hide-search="true">
                        <option value=""></option>
                    </select> 
            </div>
            ...
            <div class="col-sm-3" id="km_base_show">
                <label>Journey Type <span class="required">*</span></label>
                    <div class="form-check">
                        <div>
                            ...
                            <label class="form-check-label mt-1" for="one_way" style="font-size: 16px !important;"> One Way </label><br>
                            <input value="Return" class="form-check-input" type="radio" name="journey_type" id="return_journey">
                            <label class="form-check-label mt-1" for="return_journey" style="font-size: 16px !important;"> Return </label>
                        </div>
                    </div>
                <p class="text-danger invalid-journey-type"></p>
            </div>
            
            <div class="col-sm-3 d-none" id="tariff_base_show">
                <label>Journey Type <span class="required">*</span></label>
                    <div class="form-check">
                        <div>
                            <input value="tariff_oneway" class="form-check-input" type="radio" name="tariff_journey_type" id="tariff_one_way_checkbox" checked="">
                            <label class="form-check-label mt-1" for="one_way" style="font-size: 16px !important;"> One Way </label><br>
                            <input type="hidden" name="tariff_type_hidden_input" id="tariff_type_hidden_input">
                            <input value="roundtrip" class="form-check-input" type="radio" name="tariff_journey_type" id="tariff_roundtrip_checkbox">
                            <label class="form-check-label mt-1" for="return_journey" style="font-size: 16px !important;"> Roundtrip </label>
                        </div>
                    </div>
                <p class="text-danger invalid-journey-type"></p>
            </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-sm-2 d-none" id="tariff_return_date_show">
                <label for="tariff_return_pickup_date">Return Pickup Date <span class="required">*</span></label>
                <div class="input-group">
                    <input class="form-control"
                                  type="date"
                                  
                                  id="tariff_return_pickup_date"
                                  name="tariff_return_pickup_date"
                                  min="{{ date('Y-m-d', strtotime('+0 day')) }}"
                                  required/>
                </div>
            ...
            <div class="col-sm-4">
                <label for="one_way_pickup_address">Full Pickup Address (Street, House/Flat/Floor No) <span class="required">*</span> </label>
            ...
            <div class="col-sm-4">
                <label for="one_way_dropoff_address">Full Dropoff Address (Street, House/Flat/Floor No)<span class="required">*</span> </label>
        ...
        <div class="row mb-4 one_way_arrival_flight_ship_details">
             <div class="col-sm-3">
                ...
                @if ($isEditable && $booking_details->pick_shipname)
                    <input class="form-control" type="text" name="one_way_flight_number"
                        id="one_way_flight_number" placeholder="Flight Number"
                        value="{{ $booking_details->pickup_flight_num }}" maxlength="10" oninput="this.value = this.value.replace(/[^A-Za-z0-9]/g, '')">
                @elseif($isEditable && $booking_details->pickup_flight_num)
                    <input class="form-control" type="text" name="one_way_flight_number"
                        id="one_way_flight_number" placeholder="Flight Number"
                        value="{{ $booking_details->pick_shipname }}" maxlength="10" oninput="this.value = this.value.replace(/[^A-Za-z0-9]/g, '')">
                @else
                    <input class="form-control" type="text" name="one_way_flight_number"
                        id="one_way_flight_number" placeholder="Flight Number" value="" maxlength="10" oninput="this.value = this.value.replace(/[^A-Za-z0-9]/g, '')">
                @endif
        ...
        <div class="row mb-4">
            ...
            <div class="col-sm-3">
                <label for="one_way_total_cost">One Way Cost <span class="getcurrencycode"></span><span class="required">*</span> <a class="" href="/carfares" target="_blank">Check Car Fare</a></label>
                <input class="form-control text-success font-weight-bold" type="text" readonly 
                    id="one_way_total_cost" value="" onkeyup="extraOneway()" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 5);">
                <p class="text-danger invalid_one_way_total_cost"></p>
            </div>
            
            
            <!-- <div class="col-sm-3">
                <label for="one_way_extra_cost">Extra Cost(Parking & Passing Charges)
                        </label>
                <input class="form-control text-success font-weight-bold" type="number" name="one_way_extra_cost"
                    id="one_way_extra_cost" onkeyup="extraOneway()"
                    value="0" >
            ...
            <div class="col-sm-2">
                <label for="one_way_distance">Distance
                       <span class="distance_unit"></span>
            ...
            <div class="col-sm-3">
                ...
                <input class="form-control text-success font-weight-bold" type="text" name="one_way_total_cost"
                    id="net_total" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 5);" style="font-weight: bold;" 
                    value="0">
            </div>

            <div class="col-sm-3 oneway_offershowhide">
                <label for="one_way_travel_time" style="margin-top: 38px;color: blue;">Special Offers Includes <span class="oneway_special_off_total"></span>
                <input type="hidden" name="oneway_offerprice" id="oneway_special_off_total123">
                <input type="hidden" name="oneway_date_offerprice" id="oneway_date_offerprice">
                <input type="hidden" name="one_way_all_total" id="one_way_all_total">
                </label>
            </div>
