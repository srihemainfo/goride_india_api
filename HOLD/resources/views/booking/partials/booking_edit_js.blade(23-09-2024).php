    ...
    function ShowClientInfo(data) {
        ...
        $('#client_info').html(
            `<div class="col-sm-4">
                ...
                <input type="text" id="client_name" name="client_name" class="form-control" value="${data.fname}" placeholder="Enter client name">
            ...
            <div class="col-sm-4">
                ...
                <input type="text" id="client_mobile" name="client_mobile" class="form-control" value="${data.mobile}" placeholder="Enter client mobile">
