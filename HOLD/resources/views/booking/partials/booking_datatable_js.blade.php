                     ...
                     render: function(data, type, row) {
                        ...
                        if (orderStatus == 'Pending') {
                            return `
                             ...
                             <button class="form-control booking-status me-5 bg-primary" onclick="changeBookStatus(${row.id}, this)" id="book_status${row.id}" data-btn_name = "Confirmed" name="status" 
                        ...
                        if (orderStatus == 'Confirmed') {
                            ...
                            <button class="form-control booking-status me-5 bg-primary" onclick="assigndriver(${row.id},'${row.job_no}','${row.total}')" id="book_status${row.id}" data-btn_name = "Confirmed" name="status" 
                            style="width: 150px !important; color: white; margin-right: 0; background-color: #0d72c8 !important;">Assign Driver</button>
                        ...
                        if (orderStatus == 'Dispatched') {
                            return `
                             ...
                             <button class="form-control booking-status me-5 bg-success" onclick="changeBookStatus(${row.id}, this)" id="book_status${row.id}" data-btn_name = "Completed" name="status" 
                            style="width: 110px !important; color: white; margin-right: 0;">Completed</button>`;
                 ...
                 },
                 {
                 ...
                 },
                  {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `<p style="font-weight: 600; color: #114462;">Created On:&nbsp;&nbsp;${formattedDate}</p>`;
                    }
                },
                 {
                    data: null,
                    ...
                    render: function(data, type, row) {
                        ...
                        return `<div style="display: flex; align-items: center; justify-content: center;">
                                    <img src="${imageUrl}" alt="Status" style="max-width: 30%; height: auto; object-fit: contain;">
                                </div>`;
                    }
                }
             ],
            ...
            new DataTable('#book-table', {
             ...
             columns: [
                 ...
                 },
                 {
                     ...
                     render: function(data, type, row) {
                         // Custom rendering logic goes here
                         return `<ul style="margin-right: -7px; margin-top: 125px;">
                         <li  style="list-style-type: none;"><a href="/booking/edit/${row.id}" title="Edit Item" class="mb-2 mr-2 btn-sm btn-transition btn btn-outline-primary editPrice"><i class="fa fa-edit"></i></a></li>
                         ...
                         ${(row.order_status == 'Dispatched' || row.order_status == 'Assigned') ? `<li  style="list-style-type: none;"><a href="javascript:void(0)" onclick="sendMail(${row.id})" title="Send Email" class="mb-2 mr-2 btn-sm btn-transition btn btn-outline-dark"><i class="fa fa-envelope"></i></a></li>` : ``}${(row.order_status == 'Dispatched' || row.order_status == 'Assigned') ? 
                            `<li style="list-style-type: none;">
                                <a href="javascript:void(0)" onclick="whatsapp(${row.id})" title="WhatsApp" class="mb-2 mr-2 btn-sm btn-transition btn btn-outline-success">
