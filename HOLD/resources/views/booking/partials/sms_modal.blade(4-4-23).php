            ...
            <form id="smsForm" name="smsForm">
                    ...
                    <div class="form-group">
                      <div class="form-check">
                          <label class="form-check-label">
                            <input type="checkbox" name="sms" class="form-check-input" value="SC">SMS Customer
                          </label>
                      </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6">      
                  <div class="form-group">
                    <div class="form-check">
                        <label class="form-check-label">
                          <input type="checkbox" name="sms" class="form-check-input" value="SD" checked>SMS Driver
                        </label>
                    </div>
                  </div>
              </div>
