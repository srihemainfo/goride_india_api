        ...
        <header style='border-bottom: 2px solid #000;'>
            ...
            <div style="width: 100%;">
                <p style="text-align: center;">
                    <strong>{{ $mergedData['booking_details']['cweburl'] }} Booking Information</strong>
                </p>
                <p style="text-align: center;">Email: {{$mergedData['booking_details']['website_email']}} Cell: {{$mergedData['booking_details']['contact_number']}} Phone: {{$mergedData['booking_details']['whatsapp_number']}} Thank You for using {{$mergedData['booking_details']['cweburl']}} to complete your journey. Please check your journey details.</p>
            </div>
        </header>
                    ...
                    <div style="width: 100%">
                        <div style="display:inline-block;width: 31%;vertical-align: top;">
                            ...
                            <div style="width: 100%;">
                                ...
                                <div style="display:inline-block;width: 49%;vertical-align: top; margin-left: 18px;">
                            ...
                            <div style="width: 100%;">
                                <div style="display:inline-block;width: 100%;vertical-align: top;">
                                    ...
                                    <p>
                                        ...
                                        &nbsp;&nbsp;
                                        {{ !empty($mergedData['booking_details']['type']) ? strtoupper(str_replace('_', ' ', $mergedData['booking_details']['type']))  : '' }}
                                    </p>
