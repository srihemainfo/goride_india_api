...
@include('pricing-list.fixedprice.partials.filter')
...
<div class="col-sm-10 main-card  card">
 <div class="card-header  row container">
         ...
         <div class="col-10">
       <h4 class="card-title  mb-0  mt-1 p-0">Fixed Price List</h4>
       </div>
       <div class="col-2">
...
<div class="col-sm-2 main-card mb-3 card" style="background-color: #343a40;">
  <div class="nav flex-column nav-tabs nav-tabs-right h-100" id="vert-tabs-right-tab" role="tablist" aria-orientation="vertical">
    ...
    <a class="nav-link text-light" id="vert-tabs-right-notification-tab" href="/locationcategory " role="tab" aria-controls="vert-tabs-right-settings" aria-selected="false" style="cursor: pointer;">
     ...
     <a class="nav-link active text-light" id="vert-tabs-right-notification-tab" href="/FixedPrice" role="tab" aria-controls="vert-tabs-right-settings" aria-selected="false" style="cursor: pointer;">
    ...
    <div class="modal-dialog modal-dialog-aside" role="document" style="width: 30%;">
      <div class="modal-content">
       ...
       <div class="modal-body">
            <form id="VehicleForm">
            <div class="row mb-3">
               <label for="pickup" class="col-md-6 col-sm-12 col-form-label">Pick Up</label>
               <div class="col-md-6 col-sm-12">
                  <input type="text" id="pickup" name="pickup" class="form-control" autocomplete="off" required="" data-parsley-type="digits">
               </div>
            </div>
            <div class="row mb-3">
               <label for="dropoff" class="col-md-6 col-sm-12 col-form-label">Drop Off</label>
               <div class="col-md-6 col-sm-12">
                  <input type="text" id="dropoff" name="dropoff" class="form-control" autocomplete="off" required="" min="1" data-parsley-type="digits">
               </div>
            </div>
            <div class="row mb-3">
               <label for="Currency" class="col-md-6 col-sm-12 col-form-label">Currency</label>
               <div class="col-md-6 col-sm-12">
            ...
            <div class="row mb-3">
               <label for="Price" class="col-md-6 col-sm-12 col-form-label">Price</label>
               <div class="col-md-6 col-sm-12">
                  <input type="number" id="price" name="price" class="form-control" autocomplete="off" required="" min="0" data-parsley-type="digits">
    ...
    <div class="modal-content">
     ...
     <div class="modal-body">
            ...
            <div class="row mb-3">
               <label for="pickup" class="col-md-6 col-sm-12 col-form-label">Pick Up</label>
               <div class="col-md-6 col-sm-12">
                  <input type="text" id="editpickup" name="editpickup" class="form-control" autocomplete="off" required="" data-parsley-type="digits">
               </div>
            </div>
            <div class="row mb-3">
               <label for="dropoff" class="col-md-6 col-sm-12 col-form-label">Drop Off</label>
               <div class="col-md-6 col-sm-12">
                  <input type="text" id="editdropoff" name="editdropoff" class="form-control" autocomplete="off" required="" min="1" data-parsley-type="digits">
               </div>
            </div>
            <div class="row mb-3">
               <label for="Currency" class="col-md-6 col-sm-12 col-form-label">Currency</label>
               <div class="col-md-6 col-sm-12">
                     <select id="editcurrency" name="editcurrency" class="form-control" required>
                         <option value="">Select Currency</option>
                     <option value="CAD">CAD</option>
                      <option value="INR">INR</option>
                       <option value="GBP">GBP</option>
            ...
            <div class="row mb-3">
               <label for="Price" class="col-md-6 col-sm-12 col-form-label">Price</label>
               <div class="col-md-6 col-sm-12">
                  <input type="number" id="editprice" name="editprice" class="form-control" autocomplete="off" required="" min="0" data-parsley-type="digits">
                   <input type="hidden" id="editVehicleId" name="id">
               </div>
            </div>
<div class="modal-footer">
    ...
    @include('pricing-list.fixedprice.partials.add_fixed_price_modal')
@endsection

@section('custom_scripts')
    @include('pricing-list.fixedprice.partials.fixed_price_js')
@endsection