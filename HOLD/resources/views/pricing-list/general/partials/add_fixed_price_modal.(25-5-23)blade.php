        ...
        <div class="modal-body">
            <form id="fixedPriceForm" name="fixedPriceForm">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="saloon" class="col-form-label">Saloon</label>
                            <input type="number" class="form-control" name="saloon" id="saloon" placeholder="0">
                            <p class="text-danger invalid-saloon"></p>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="estate" class="col-form-label">Estate</label>
                            <input type="number" class="form-control" name="estate" id="estate" placeholder="0">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="mpv" class="col-form-label">MPV</label>
                            <input type="number" class="form-control" name="mpv" id="mpv" placeholder="0">
                            <p class="text-danger invalid-hand-luggage"></p>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="mpv5" class="col-form-label">MPV5</label>
                            <input type="number" class="form-control" name="mpv5" id="mpv5" placeholder="0">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="mpv6" class="col-form-label">MPV6</label>
                            <input type="number" class="form-control" name="mpv6" id="mpv6" placeholder="0">
                            <p class="text-danger invalid-mpv6"></p>
                        </div>
                    </div>                    
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="mpv8" class="col-form-label">MPV8</label>
                            <input type="number" class="form-control" name="mpv8" id="mpv8" placeholder="0">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="mpv_executive" class="col-form-label">MPV Executive</label>
