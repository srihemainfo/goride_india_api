...
use Illuminate\Support\Facades\{DB, Validator, Hash,Session,Gate};
...
// if (isset($_SESSION['permissions']['DRIVER_MODULE_read']) && $_SESSION['permissions']['DRIVER_MODULE_read'] === true) {
...
// }
         ...
         return view('employees.index');
        abort_if(Gate::denies('BOOKING_MODULE_read'), Response::HTTP_FORBIDDEN, 'Permission Denied');
