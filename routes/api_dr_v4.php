...
use App\Http\Controllers\Api\v4\AddcreditController;
use App\Http\Controllers\Api\v4\authController;
// use App\Http\Controllers\Api\v4\NewauthController2;
use App\Http\Controllers\Api\v4\billingController;
use App\Http\Controllers\Api\v4\cashTicket;
use App\Http\Controllers\Api\v4\CCAvenueGateway;
// use App\Http\Controllers\Api\v4\couponCode;
use App\Http\Controllers\Api\v4\DeleteuserController;
use App\Http\Controllers\Api\v4\DrawController;
use App\Http\Controllers\Api\v4\drawsController;
use App\Http\Controllers\Api\v4\FaqControllers;
use App\Http\Controllers\Api\v4\getThanks;
use App\Http\Controllers\Api\v4\HomeCoutroller;
use App\Http\Controllers\Api\v4\InvoiceController;
use App\Http\Controllers\Api\v4\WhatsappController;
use App\Http\Controllers\Api\v4\LoginController;
use App\Http\Controllers\Api\v4\MyprofileController;
use App\Http\Controllers\Api\v4\networkGateway;
use App\Http\Controllers\Api\v4\onlineTicket;
use App\Http\Controllers\Api\v4\PlayController;
use App\Http\Controllers\Api\v4\TermsController;
use App\Http\Controllers\Api\v4\TicktviewController;
use App\Http\Controllers\Api\v4\TransactionController;
use App\Http\Controllers\Api\v4\WithdrawController;
use App\Http\Controllers\Api\v4\ContactController;
// use App\Http\Controllers\Api\v4\myTicketsController;
// use App\Http\Controllers\Api\v4\cartonBilling;
use App\Http\Controller\Api\NewauthController;
use App\Http\Controllers\Api\v4\pastDraw;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Route;
use App\Http\Controllers\Api\v4\twilioController;
use App\Http\Controllers\Api\v4\dtSendTemplate;
use App\Http\Controllers\Api\v4\OpenJobsController;
use App\Http\Controllers\Api\v4\DigioKyc;
use App\Http\Controllers\Api\v4\JobStreamController;
use App\Http\Controllers\Api\v4\WalletController;
use App\Http\Controllers\Api\v4\OpenJobCustomer;
// use App\Http\Controllers\Api\v4\ConsentController;
use App\Http\Controllers\Api\v4\ManualKycUpload;
use App\Http\Controllers\Controller;
use App\Http\Controllers\Api\v4\CustomerAppController;
use App\Http\Controllers\Api\v4\AdminApiController;
use App\Http\Controllers\Api\v4\MultipleVehicleController;
use App\Http\Controllers\Api\v4\DriverScoreController;
use App\Http\Controllers\Api\v4\DriverCarPoolJobController;
use App\Http\Controllers\Api\v4\SpinWheelController;
use App\Http\Controllers\Api\v4\FeedBackController;
// use App\Http\Controllers\Api\v4\SocietyGroupController;
// use App\Http\Controllers\Api\v4\GroupMemberController;
// use App\Http\Controllers\Api\v4\GroupInvitationController;
...
//         namespace('API')->middleware('log.api.requests')->group(function () {
            ...
            Route::middleware(['driver.auth'])->group(function () {
                ...
                //spinwheel routes
                Route::get('/spin-option', [SpinWheelController::class, 'getOptions']);
                Route::post('/spin-now', [SpinWheelController::class, 'spin']);
                ...
                Route::post('/ride-otp-verify', [OpenJobsController::class, 'otpVerify']);
                ...
                // Carpool APIS
                Route::post('carpool/autocomplete', [DriverCarPoolJobController::class, 'GoogleLocations'])->name('GoogleLocations');
                Route::post('carpool/fetch-route', [DriverCarPoolJobController::class, 'fetchRoute'])->name('fetchRoute');
                Route::post('/carpool/create-job', [DriverCarPoolJobController::class, 'createJob']);
                Route::post('/carpool/invite-action', [DriverCarPoolJobController::class, 'acceptReject']);
                Route::get('carpool/routes/{route_id}/stops', [DriverCarPoolJobController::class, 'getRouteStops']);
                Route::get('carpool/post-job', [DriverCarPoolJobController::class, 'postCarpoolJob']);
                
                Route::get('carpool/my-job', [DriverCarPoolJobController::class, 'myJobs']);
                Route::post('carpool/lock-job', [DriverCarPoolJobController::class, 'jobLock']);
                Route::post('carpool/otp-verify', [DriverCarPoolJobController::class, 'otpVerify']);
                Route::post('carpool/cancel-job', [DriverCarPoolJobController::class, 'cancelJob']);
                Route::get('carpool/user-profile', [DriverCarPoolJobController::class, 'userProfile']);
                Route::post('carpool/complete-ride', [DriverCarPoolJobController::class, 'completeRide']);
                Route::post('carpool/remove-passenger', [DriverCarPoolJobController::class, 'removeInvite']);
                
                Route::post('carpool/job-info', [DriverCarPoolJobController::class, 'jobInfo']);
                
                Route::post('carpool/start-ride', [DriverCarPoolJobController::class, 'startRide']);
                Route::post('carpool/setting', [DriverCarPoolJobController::class, 'settingUpdate']);
                Route::get('carpool/past-job', [DriverCarPoolJobController::class, 'pastJob']);
                Route::post('carpool/drop-passenger', [DriverCarPoolJobController::class, 'dropPassenger']);
                
                Route::post('/popup-status-update', [DriverCarPoolJobController::class, 'schPopUpStatus']);
                Route::post('/sch-create-job', [DriverCarPoolJobController::class, 'popUpcreateJob']);
                
                Route::get('/carpool/schedule-list', [DriverCarPoolJobController::class, 'scheduleList']);
                Route::post('/carpool/schedule-delete', [DriverCarPoolJobController::class, 'deleteSchedule']);
                
                Route::post('/carpool/update-live-track', [DriverCarPoolJobController::class, 'updateTracking']);
                
                Route::get('/socket-auth', function (Request $request) {
                    
                    Log::info('===== SOCKET AUTH START =====');
            ...
            Route::middleware('driver.auth')->prefix('society')->group(function () {
            
                Route::post('/create', [SocietyGroupController::class, 'createGroup']);
            
                Route::post('/update', [SocietyGroupController::class, 'updateGroup']);
            
                Route::post('/delete', [SocietyGroupController::class, 'deleteGroup']);
            
                Route::get('/details/{group_id}', [SocietyGroupController::class, 'groupDetails']);
            
                Route::get('/my-groups', [SocietyGroupController::class, 'myGroups']);
            
                Route::post('/change-image', [SocietyGroupController::class, 'changeImage']);
            
                Route::post('/change-description', [SocietyGroupController::class, 'changeDescription']);
            
                Route::get('/members/{group_id}', [GroupMemberController::class, 'memberList']);
            
                Route::post('/invite-member', [GroupMemberController::class, 'inviteMember']);
            
                Route::post('/remove-member', [GroupMemberController::class, 'removeMember']);
            
                Route::post('/generate-invite-link', [GroupInvitationController::class, 'generateInviteLink']);
            
                Route::get('/invite-details/{token}', [GroupInvitationController::class, 'inviteDetails']);
            
                Route::post('/join-by-link', [GroupInvitationController::class, 'joinByInviteLink']);
            
                Route::get('/join-requests/{group_id}', [GroupInvitationController::class, 'joinRequests']);
            
                Route::post('/approve-member', [GroupInvitationController::class, 'approveMember']);
            
                Route::post('/reject-member', [GroupInvitationController::class, 'rejectMember']);
            
                Route::post('/accept-invitation', [GroupInvitationController::class, 'acceptInvitation']);
            
                Route::post('/reject-invitation', [GroupInvitationController::class, 'rejectInvitation']);
