...
use App\Http\Controllers\Api\v5\CustomerAppController;
use App\Http\Controllers\Api\v5\CustomerAuthController;
use App\Http\Controllers\Api\v5\CustomerFeedback;
use App\Http\Controllers\Api\v5\WalletController;
use App\Http\Controllers\Api\v5\SchedularController;
use App\Http\Controllers\Api\v5\CarPoolKycController;
use App\Http\Controllers\Api\v5\CarPoolJobController;
use App\Http\Controllers\Api\v5\InvitationController;
use App\Http\Controllers\Api\v5\AgoraController;
use App\Http\Controllers\Api\v5\CustomerCallController;
use App\Http\Controllers\Api\v5\FamousPlaceController;
use App\Http\Controllers\Api\v5\ReferralClaimController;
use App\Http\Controllers\Api\v5\BannerController;
use App\Http\Controllers\Api\v5\SocietyGroupController;
use App\Http\Controllers\Api\v5\GroupMemberController;
use App\Http\Controllers\Api\v5\GroupInvitationController;
use App\Http\Controllers\Api\v5\SocietyJobController;
use Carbon\Carbon;
...
Route::middleware(['customer.newauth'])->group(function () {
    ...
    Route::post('/carpool/fetch-route', [CarPoolJobController::class, 'fetchRoute'])->name('fetchRoute');
    Route::get('/carpool/share-location', [CarPoolJobController::class, 'shareLocation']);
    ...
    Route::prefix('society')->middleware('auth:sanctum')->group(function () {
        ...
        */
        ...
        Route::get('/category-list', [SocietyGroupController::class, 'categoryList']);
        ...
        Route::get('/details', [SocietyGroupController::class, 'groupDetails']);
        Route::get('/my-groups', [SocietyGroupController::class, 'myGroups']);
        
    
        Route::get('/members', [GroupMemberController::class, 'memberList']);
        ...
        Route::post('/leave-group', [GroupMemberController::class, 'leaveGroup']);
        Route::post('/transfer-ownership',[GroupMemberController::class,'transferOwnership']);
        Route::post('/make-admin',[GroupMemberController::class,'makeAdmin']);
        Route::post('/remove-admin',[GroupMemberController::class,'removeAdmin']);
        
        Route::post('/generate-invite-link',[GroupInvitationController::class,'generateInviteLink']);
        Route::get('/invite-details/{invite_code}', [GroupInvitationController::class, 'inviteDetails']);
        
        
        Route::post('/join',[GroupInvitationController::class,'joinByInviteLink']);
        Route::get('/join-requests', [GroupInvitationController::class, 'joinRequests']);
        ...
        Route::get('/jobs', [SocietyJobController::class, 'jobs']);
        // Route::post('/job/remove', [SocietyJobController::class, 'removeSharedJob']);
        
        Route::get('/groups', [SocietyGroupController::class, 'groups']);
        Route::get('/group/details', [SocietyGroupController::class, 'groupDetails']);
        Route::post('/group/join', [SocietyGroupController::class, 'joinGroup']);
