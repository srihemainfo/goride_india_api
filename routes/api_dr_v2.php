...
use App\Http\Controllers\Api\v2\AddcreditController;
use App\Http\Controllers\Api\v2\authController;
// use App\Http\Controllers\Api\v2\NewauthController2;
use App\Http\Controllers\Api\v2\billingController;
use App\Http\Controllers\Api\v2\cashTicket;
use App\Http\Controllers\Api\v2\CCAvenueGateway;
// use App\Http\Controllers\Api\v2\couponCode;
use App\Http\Controllers\Api\v2\DeleteuserController;
use App\Http\Controllers\Api\v2\DrawController;
use App\Http\Controllers\Api\v2\drawsController;
use App\Http\Controllers\Api\v2\FaqControllers;
use App\Http\Controllers\Api\v2\getThanks;
use App\Http\Controllers\Api\v2\HomeCoutroller;
...
use App\Http\Controllers\Api\v2\MyprofileController;
use App\Http\Controllers\Api\v2\networkGateway;
use App\Http\Controllers\Api\v2\onlineTicket;
use App\Http\Controllers\Api\v2\PlayController;
use App\Http\Controllers\Api\v2\TermsController;
use App\Http\Controllers\Api\v2\TicktviewController;
use App\Http\Controllers\Api\v2\TransactionController;
use App\Http\Controllers\Api\v2\WithdrawController;
use App\Http\Controllers\Api\v2\ContactController;
// use App\Http\Controllers\Api\v2\myTicketsController;
// use App\Http\Controllers\Api\v2\cartonBilling;
use App\Http\Controller\Api\NewauthController;
use App\Http\Controllers\Api\v2\pastDraw;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Route;
use App\Http\Controllers\Api\v2\twilioController;
use App\Http\Controllers\Api\v2\dtSendTemplate;
use App\Http\Controllers\Api\v2\OpenJobsController;
use App\Http\Controllers\Api\v2\DigioKyc;
use App\Http\Controllers\Api\v2\JobStreamController;
use App\Http\Controllers\Api\v2\WalletController;
use App\Http\Controllers\Api\v2\OpenJobCustomer;
// use App\Http\Controllers\Api\v2\ConsentController;
use App\Http\Controllers\Api\v2\ManualKycUpload;
use App\Http\Controllers\Controller;
use App\Http\Controllers\Api\v2\CustomerAppController;
use App\Http\Controllers\Api\v2\AdminApiController;
use App\Http\Controllers\Api\v2\MultipleVehicleController;
use App\Http\Controllers\Api\v2\DriverScoreController;
