...
use App\Http\Controllers\Api\v3\AddcreditController;
use App\Http\Controllers\Api\v3\authController;
// use App\Http\Controllers\Api\v3\NewauthController2;
use App\Http\Controllers\Api\v3\billingController;
use App\Http\Controllers\Api\v3\cashTicket;
use App\Http\Controllers\Api\v3\CCAvenueGateway;
// use App\Http\Controllers\Api\v3\couponCode;
use App\Http\Controllers\Api\v3\DeleteuserController;
use App\Http\Controllers\Api\v3\DrawController;
use App\Http\Controllers\Api\v3\drawsController;
use App\Http\Controllers\Api\v3\FaqControllers;
use App\Http\Controllers\Api\v3\getThanks;
use App\Http\Controllers\Api\v3\HomeCoutroller;
use App\Http\Controllers\Api\v3\InvoiceController;
use App\Http\Controllers\Api\v3\WhatsappController;
use App\Http\Controllers\Api\v3\LoginController;
use App\Http\Controllers\Api\v3\MyprofileController;
use App\Http\Controllers\Api\v3\networkGateway;
use App\Http\Controllers\Api\v3\onlineTicket;
use App\Http\Controllers\Api\v3\PlayController;
use App\Http\Controllers\Api\v3\TermsController;
use App\Http\Controllers\Api\v3\TicktviewController;
use App\Http\Controllers\Api\v3\TransactionController;
use App\Http\Controllers\Api\v3\WithdrawController;
use App\Http\Controllers\Api\v3\ContactController;
// use App\Http\Controllers\Api\v3\myTicketsController;
// use App\Http\Controllers\Api\v3\cartonBilling;
use App\Http\Controller\Api\NewauthController;
use App\Http\Controllers\Api\v3\pastDraw;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Route;
use App\Http\Controllers\Api\v3\twilioController;
use App\Http\Controllers\Api\v3\dtSendTemplate;
use App\Http\Controllers\Api\v3\OpenJobsController;
use App\Http\Controllers\Api\v3\DigioKyc;
use App\Http\Controllers\Api\v3\JobStreamController;
use App\Http\Controllers\Api\v3\WalletController;
use App\Http\Controllers\Api\v3\OpenJobCustomer;
// use App\Http\Controllers\Api\v3\ConsentController;
use App\Http\Controllers\Api\v3\ManualKycUpload;
use App\Http\Controllers\Controller;
use App\Http\Controllers\Api\v3\CustomerAppController;
use App\Http\Controllers\Api\v3\AdminApiController;
use App\Http\Controllers\Api\v3\MultipleVehicleController;
use App\Http\Controllers\Api\v3\DriverScoreController;
use App\Http\Controllers\Api\v3\DriverCarPoolJobController;
