...
class CarPoolJobController extends Controller
{
    ...
    public function createJob(Request $request)
    {
        try {
            ...
            if ($c_seat == 'BIKE' && $request->seat > 1) {
                return ApiResponse::error("Seat count exceeds your vehicle's maximum capacity." . $c_seat);
            }
        ...
        try {
            ...
            $joinedJobs = $joinedJobsQuery
                ->select(
                    ...
                    'job.isLock',
                    'job.pickup_date',
                    DB::raw("IFNULL(JSON_UNQUOTE(JSON_EXTRACT(host.vehicle_details, '$.choosed_vehicle')), '') as choosed_vehicle"),
