...
class CustomerAuthController extends Controller
{
    public function profile(Request $request)
    {
        ...
        if (!$kycDetails) {
            $kycDetails = new \stdClass();
        }
        
        $kycDetails->proof_type = "AADHAAR";
        $kycDetails->front_image = "https://airportrides-storage.s3.amazonaws.com/carpool/693865a0-55f5-4681-9b94-b73f9a75b4f3.jpg";
        $kycDetails->back_image = "https://airportrides-storage.s3.amazonaws.com/carpool/e252a52d-28c3-4394-a37d-dc54c605ee82.jpg";
        $kycDetails->proof_status = "approved";
