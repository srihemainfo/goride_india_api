...
$anchorTag = '<a href="' . $linkData->slug . '" style="color: #467bbe; text-decoration: none;">' . $linkData->name .
    '</a>';
...
<!-- Breadcrumb -->
<section class="page-header" style="background-image: url('{{ asset('goride/img/car.webp') }}');">
...
<section class="choose-section  pb-5 ">
    <div class="container">
        ...
        <div class="row d-flex justify-content-center align-items-center ">
            <div class="choose-content-area mb-3">
                <div class="row align-items-center gap-3 gap-md-0">

                    <!-- Left Column: Heading -->
                    <div class="col-md-6 col-12">
                        <h3 class="mb-0">Taxi Fare Options</h3>
                    </div>

                    <!-- Right Column: App Button + Note -->
                    <div class="col-md-6 col-12 text-center">
                        <a href="https://play.google.com/store/apps/details?id=com.shi.goride.customer" target="_blank"
                            id="app_link"
                            style="background: black; border-radius: 10px; padding: 4px 10px; display: inline-block;">
                            <img src="https://www.goride.run/goride/img/paly-store-logo.png" alt="google-play"
                                style="width: 120px;">
                        </a>

                        <div class="mt-1">
                            <small class="text-muted" style="font-size: 11px; font-style: italic; font-weight: 600;">
                ...
                <div class="col-md-6 mb-3">
                    <div class="cab-card aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                        <div class="cab-left ">
                            ...
                            <div class="cab-info mt-2">
                                <h5 class="mb-2">4 Seater Mini</h5>
                                <div class="icon-text">
                        ...
                        <div class="cab-middle ">
                            ...
                            <ul class="list-unstyled km-text">
                                  <div class="amount-badge">
                                <span>
                                    ₹{{ $seoTags['mini_four_seater'] ?? 'N/A' }}
                                </span>
                            </div>
                                <li><i class="fa-solid fa-check text-success me-1"></i>
                                    Upto {{ round($seoTags['mini_four_km']) }} kms and 4 hrs</li>
                                <li><i class="fa-solid fa-check text-success me-1"></i>Included (Taxes, Toll, Parking,
                                    Bata &amp; other charges)</li>
                            </ul>
                        ...
                        <!--          <small class="text-muted" style="font-size: 12px;font-style: italic;font-weight: 600;margin-bottom: 6px;">-->
                        <!--             Included (Taxes, Toll, Parking, Bata &amp; other charges)-->
                        <!--          </small>-->
                        <!--        </div>-->
                        <!--    <div class="d-flex justify-content-end align-items-end"> <small class="text-muted"-->
    ...
    <div class="cab-card aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="cab-middle">
            <ul class="list-unstyled km-text">
                <div class="amount-badge">
                    <span>
                        ₹{{ $seoTags['four_seater'] ?? 'N/A' }}
                    </span>
                </div>
                <li>
                    <i class="fa-solid fa-check text-success me-1"></i>
                    Upto {{ round($seoTags['four_km']) }} kms and 4 hrs
                </li>
                <li>
                    <i class="fa-solid fa-check text-success me-1"></i>
                    Included (Taxes, Toll, Parking, Bata &amp; other charges)
    ...
    <div class="cab-card aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="cab-middle">
            <ul class="list-unstyled km-text">
                <div class="amount-badge">
                    <span>
                        ₹{{ $seoTags['six_seater'] ?? 'N/A' }}
                    </span>
                </div>
                <li>
                    <i class="fa-solid fa-check text-success me-1"></i>
                    Upto {{ round($seoTags['six_km']) }} kms and 4 hrs
                </li>
                <li>
                    <i class="fa-solid fa-check text-success me-1"></i>
                    Included (Taxes, Toll, Parking, Bata &amp; other charges)
    ...
    <div class="cab-card aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="cab-middle">
            <ul class="list-unstyled km-text">
                <div class="amount-badge">
                    <span>
                        ₹{{ $seoTags['seven_seater'] ?? 'N/A' }}
                    </span>
                </div>
                <li>
                    <i class="fa-solid fa-check text-success me-1"></i>
                    Upto {{ round($seoTags['seven_km']) }} kms and 4 hrs
                </li>
                <li>
                    <i class="fa-solid fa-check text-success me-1"></i>
                    Included (Taxes, Toll, Parking, Bata &amp; other charges)
    ...
    <div class="cab-card aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="cab-middle">
            <ul class="list-unstyled km-text">
                <div class="amount-badge">
                    <span>
                        ₹{{ $seoTags['onethree_seater'] ?? 'N/A' }}
                    </span>
                </div>
                <li>
                    <i class="fa-solid fa-check text-success me-1"></i>
                    Upto {{ round($seoTags['onethree_km']) }} kms and 4 hrs
                </li>
                <li>
                    <i class="fa-solid fa-check text-success me-1"></i>
                    Included (Taxes, Toll, Parking, Bata &amp; other charges)
    ...
    <div class="cab-card aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="cab-middle">
            <ul class="list-unstyled km-text">
                <div class="amount-badge">
                    <span>
                        ₹{{ $seoTags['twoone_seater'] ?? 'N/A' }}
                    </span>
                </div>
                <li>
                    <i class="fa-solid fa-check text-success me-1"></i>
                    Upto {{ round($seoTags['twoone_km']) }} kms and 4 hrs
                </li>
                <li>
                    <i class="fa-solid fa-check text-success me-1"></i>
                    Included (Taxes, Toll, Parking, Bata &amp; other charges)
    ...
    <div class="cab-card aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="cab-middle">
            <ul class="list-unstyled km-text">
                <div class="amount-badge">
                    <span>
                        ₹{{ $seoTags['fivezero_seater'] ?? 'N/A' }}
                    </span>
                </div>
                <li>
                    <i class="fa-solid fa-check text-success me-1"></i>
                    Upto {{ round($seoTags['fivezero_km']) }} kms and 4 hrs
                </li>
                <li>
                    <i class="fa-solid fa-check text-success me-1"></i>
                    Included (Taxes, Toll, Parking, Bata &amp; other charges)
    ...
    <div class="overlay">
        ...
        <div class="features">
            <div class="feature-box">
                <h3><i class="fa-solid fa-check text-success me-1"></i> 24×7 Customer Support</h3>
                <p>Always available to assist you anytime, anywhere.</p>
            </div>
            <div class="feature-box">
                <h3><i class="fa-solid fa-check text-success me-1"></i>Verified Drivers</h3>
                <p>Experienced professionals with background checks.</p>
            </div>
            <div class="feature-box">
                <h3><i class="fa-solid fa-check text-success me-1"></i> Clean Vehicles</h3>
                <p>Well-maintained and sanitized for your comfort.</p>
            </div>
            <div class="feature-box">
                <h3><i class="fa-solid fa-check text-success me-1"></i> Safe & Reliable</h3>
                        ...
                        <div class="col-md-5 col-12">
                            <div class="filter-section" data-aos="fade-up">
                                ...
                                <select class="district-dropdown" id="districtSelect">
                                    ...
                                    <option value="{{strtolower($value->to_place)}}">
                                        {{$value->name . ' - '.$value->to_place}}</option>
                                    @endforeach
                                    @else
