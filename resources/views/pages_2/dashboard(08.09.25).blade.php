                            ...
                            <div class="media-body">
                                <div class="greeting-user">
                                    ...
                                    <a class="btn btn-outline-white_color" href="/pricing">Get Started<i
                                          ...
                                          <a class="btn btn-outline-white_color position-relative" href="/jobs">
  Open Jobs <i class="fa-solid fa-suitcase ms-1"></i>
                ...
                <div class="card">
                    ...
                    @else
                        <div class="card-body text-center">
                            <p>No Purchases have done <a href="/pricing" style="color:#0d6efd;">click here</a> to buy now.
                            </p>
                        </div>
                    @endif
                </div>
