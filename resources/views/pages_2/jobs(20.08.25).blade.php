            ...
            <div class="modal-body">
                ...
                <div class="mt-3 border-top pt-3">
                    <p class="text-danger mb-1 bg-light fw-normal border w-100 rounded p-2">
                        <strong class="text-dark">Note:</strong> This amount includes toll, parking, bata, and passenger
                        fare.
                    </p>
                </div>
            </div>
                    ...
                    <div class="row align-items-center">
                                ...
                                <div class="flex-grow-1 pt-md-1 w-100">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 text-dark small mb-0 mb-md-2 mb-sm-0">
                                        <span class="fw-semibold d-block d-md-inline-block mb-1 mb-md-0">
                                            <i class="fas fa-building text-warning me-1"></i><span id="j_company">Sri
                                                Hematech Info Solutions</span>
                                        </span>
                                    ...
                                    <div class="d-flex flex-wrap gap-0 gap-md-3 text-dark small d-none d-md-block">
                                        <span class="fw-semibold d-block d-md-inline-block mb-1 mb-md-0">
                                            <i class="fa fa-briefcase text-warning me-1"></i><span id="j_complete">15
                                                jobs completed</span>
                                        </span>
                                        <span class="fw-semibold d-block d-md-inline-block">
                                            <i class="fas fa-calendar text-warning me-1"></i><span id="j_time">Posted 3
                                                hours ago</span>
                                        </span>
                                    </div>
                        ...
                        <div class="col-lg-4 col-12 d-flex flex-column align-items-center justify-content-center  mt-lg-0 d-block d-md-none">
                           <div class="d-flex flex-wrap gap-3  text-dark small ">
                                        <span class="fw-semibold d-block d-md-inline-block mb-1 mb-md-0">
                                            <i class="fa fa-briefcase text-warning me-1"></i><span id="j_complete">0 Completed</span>
                                        </span>
                                        <span class="fw-semibold d-block d-md-inline-block">
                                            <i class="fas fa-calendar text-warning me-1"></i><span id="j_time">Posted 1 day ago</span>
                                        </span>
                                    </div>
                        </div>
