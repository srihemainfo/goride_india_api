                                                      ...
                                                      <div class="d-flex align-items-center small text-muted gap-4 mb-2">
                                                        ...
                                                        <div class="d-flex align-items-center gap-3 mb-2">
                                                          <span class="text-form">
                                                                <i class="fas fa-hourglass-end text-dark hourglass-rotate"></i>
                ...
                <form id="journeyForm" data-gtm-form-interact-id="0" enctype="multipart/form-data" onsubmit="journeyForm(event)">
                    ...
                    <div class="d-flex align-items-center flex-nowrap overflow-auto gap-2">
                        <div class="form-check mb-0">
                            <input class="form-check-input" type="radio" name="job_type" id="oneWay" value="oneway" checked>
                            <label class="form-check-label" for="oneWay">One Way</label>
                        </div>
                        <div class="form-check mb-0">
                            <input class="form-check-input" type="radio" name="job_type" id="roundTrip"
                                value="roundtrip">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-12">
                            ...
                            <input type="text" id="marketedPrice" name="fare" class="form-control p-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <div class="mt-2 d-flex flex-column">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="bataIncluded" name="bataRadio" value="Included" checked>
                                        <label class="form-check-label" for="bataIncluded">Included</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="bataClient" name="bataRadio" value="Passenger to pay">
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <div class="mt-2 d-flex flex-column">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="tollIncluded" name="tollRadio" value="Included" checked>
                                        <label class="form-check-label" for="tollIncluded">Included</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="tollClient" name="tollRadio" value="Passenger to pay">
                           ...
                           <div class="col-md-4 col-12">
                                ...
                                <div class="mt-2 d-flex flex-column">
                                    <div class="form-check me-2">
                                        <input class="form-check-input" type="radio" id="parkingIncluded" name="parkingRadio" value="Included" checked>
                                        <label class="form-check-label" for="parkingIncluded">Included</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="parkingClient" name="parkingRadio" value="Passenger to pay">
                    ...
                    <div class="text-center d-flex justify-content-center">
                        ...
                        <button type="submit" class="btn view-btn p-1" id="job_submit-btn">Create Job</button>
        ...
        <div class="modal-content p-3">
            ...
            <div class="modal-body" id="previewContent">
                                    ...
                                    <div class="company-info">
                                        <div class="car-specs">
                                            <div class="row">
                                                <div class="col-md-6 col-12 d-flex align-items-center gap-3">
                                                    <span class="passenger-count">
                                                        <i class="fas fa-users"></i> <span id="pre_pass">5</span>
                                                    </span>
                                                    <span class="distance">
                                                        <i class="fas fa-route"></i> <span id="pre_dis">280</span>km
                                                    </span>

                                                </div>
                                                <div
                                                    class="col-md-6 col-12 d-flex justify-content-center align-items-end flex-column">
                                                    <div class="amount">₹ <span id="pre_fare">3,800</span></div>
                                                    <div class="amount-des">
                                                        <i class="fas fa-bullhorn"></i> <small> <span id="pre_addtional">Toll, parking, and bata included</span> </small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="trip-info">
                                        <div class="route-section">
                                            <div class="location-time">
                                                ...
                                                <div class="date-time" id="pre_pick2">26 Jul 09:00 AM </div>
                                                <!--<div class="location">Perambur railway station, <br> Chennai</div>-->
                                                <div class="location" id="pre_from">Perambur railway station, Chennai</div>
                                            </div>

                                            <div class="route-arrow">

                                                <div class="arrow-line">
                                                    <div class="duration d-none d-sm-block" id="pre_duration">2 days and 15 hours</div>
                                                    <div class="arrow-container">
                                                        <div class="long-arrow"></div>
                                                        <i class="fas fa-car car-icon"></i>
                                                    </div>
                                            ...
                                            <div class="location-time">
                                                ...
                                                <div class="date-time" id="pre_drop2">29 Jul 05:42 AM </div>
                                                <!--<div class="location" id="pre_to">Kilambakkam bus terminus <br> chennai</div>-->
                                                <div class="location" id="pre_to">Kilambakkam bus terminus chennai</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="summary-section p-3 bg-light rounded" style="width: auto !important;">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <p><i class="fas fa-calendar-day me-2"></i><strong>Pickup:</strong> <span id="pre_pick">15 May 2023, 10:00 AM</span> 
                            </p>
                            <p><i class="fas fa-map-marker-alt me-2"></i><strong>From:</strong> <span id="pre_from2">Mumbai, Maharashtra</span> </p>
                        </div>
                        <div class="col-md-6 col-12">
                            <p><i class="fas fa-calendar-day me-2"></i><strong>Drop:</strong> <span id="pre_drop">15 May 2023, 01:30 PM</span> </p>
                            <p><i class="fas fa-map-marker-alt me-2"></i><strong>To:</strong> <span id="pre_to2">Pune, Maharashtra</span> </p>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="userModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-md" style="animation: 0.3s ease-out 0s 1 normal none running modalSlideIn;">
    <div class="modal-content p-3">
      ...
      <!-- Footer -->
   <!-- Modal Footer -->
<div class="modal-footer justify-content-between bg-white border-0 px-3">

  <!-- Report Dropdown -->
  <div class="dropdown">
    <button class="btn btn-outline-danger btn-sm dropdown-toggle d-flex align-items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
      <i class="fas fa-flag me-2"></i> Report User
    </button>
    <ul class="dropdown-menu shadow-sm custom-report-dropdown">
      <li>
...
<script>
    ...
    function journeyForm(event) {
        ...
        $('#pre_drop').text(formObject.dropoff_date != '' ? formatDate(formObject.dropoff_date) : '');
        $('#pre_drop2').text(formObject.dropoff_date != '' ? formatDate(formObject.dropoff_date) : '');
