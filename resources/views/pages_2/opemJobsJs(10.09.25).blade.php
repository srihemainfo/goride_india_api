<script>
    ...
    function openJobs(loc = null, dis = null, pass = null, fare = null, pg = null) {
        ...
        if (pg == 'yes') {
            ...
            console.log('hi bro')
            $("#openJobs_cards").empty(); // clear old jobs when resetting
        }
        
        loading = true;
        
        // // console.log('hhhhhhiiiiiiiiiiii')
        $.ajax({
  ...
  <button class="btn btn-link text-danger p-0" data-bs-toggle="modal" data-bs-target="#cancelModal">
    Cancel Job
  </button>
...
<div class="col-12 d-md-flex justify-content-md-between align-items-center flex-md-wrap align-items-end">
    ...
    function myFilterFunction(loc = null, dis = null, fare = null,  pass = null) {
        ...
        openJobs(location, distance, passengers, amount, pg);
