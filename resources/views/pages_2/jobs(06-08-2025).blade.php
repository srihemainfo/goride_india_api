...
<section class="login_dashboard_section" id="main-dashboard-wrapper">
    ...
    <div class="page-wrapper">
        <div class="mobile_menu_toggler">
            <h1 class="admin_name m-0">Hello {{ $userDetails['userDetails']['name'] ?? '' }}</h1>
            <i class="fa-solid fa-bars" id="mobile_menu_opener"></i>
        </div>
        <div class="row mb-3">
            <div class="col-12">
    ...
    <ul class="nav nav-tabs card-header-tabs w-100" id="jobTabs" role="tablist">
                                ...
                                <div class="col-md-3 col-12 mb-4 mb-md-0 d-none d-md-block">
                                    <div class="card filter shadow-sm border-0 rounded-3">
                                        <div
                                            ...
                                            <button class="btn btn-sm btn-link text-muted p-0" id="resetFiltersBtn">
                                            ...
                                            <div class="mb-4 position-relative">
                                                ...
                                                <div id="locationFields">
                                                    <div class="position-relative">
                                                        <input type="text"
                                                            class="form-control form-control-sm border-warning location-input mb-2"
                                                            placeholder="e.g., Chennai" autocomplete="off"
                                                            id="mainLocationInput">
                                    ...
                                    <div class="offcanvas-body">
                                        <div class="card filter shadow-sm border-0 rounded-3">
                                            ...
                                            <div class="card-body p-3">
                                                <!-- Location Filter -->
                                                <div class="mb-4 position-relative">
                                                    <label for="filterLocationMobile"
                                                        class="form-label fw-bold small mb-2 text-dark">
                                                        <i class="fas fa-map-marker-alt text-warning me-2"></i>Location
                                                    </label>
                                                    <div class="position-relative">
                                                        <input type="text"
                                                            class="form-control form-control-sm border-warning location-input mb-2"
                                                            placeholder="e.g., Chennai" autocomplete="off"
                                                            id="mainLocationInputMobile">
                                                        <div class="search-dropdown position-absolute w-100 bg-white shadow-lg"
                                                            id="locationDropdownMobile"
                                                            style="display: none; top: 100%; z-index: 1000;">
                                                            <div class="p-3">
                                                                <h6 class="popular-searches-title mb-3">Popular
                                                                    Locations</h6>
                                                                <div class="trending-tags">
                                                                    <span class="badge go-ride-tag me-2 mb-2"><i
                                                                            class="fas fa-city me-1"></i>Chennai</span>
                                                                    <span class="badge go-ride-tag me-2 mb-2"><i
                                                                            class="fas fa-city me-1"></i>Bangalore</span>
                                                                    <span class="badge go-ride-tag me-2 mb-2"><i
                                                                            class="fas fa-city me-1"></i>Hyderabad</span>
                                                                    <span class="badge go-ride-tag me-2 mb-2"><i
                                                                            class="fas fa-city me-1"></i>Mumbai</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                            ...
                                                            <div class="route-section">
                                                                <div class="location-time">
                                                                    <div class="date-time">26 Jul <br><span>09:00
                                                                            AM</span></div>
                                                                    <div class="location">Perambur railway station, <br>
                                                                        Chennai</div>
                                                                </div>
                                                                ...
                                                                <div class="location-time">
                                                                    <div class="date-time">29 Jul <br><span>05:42
                                                                            AM</span></div>
                                                                    <div class="location">Kilambakkam bus terminus <br>
                                                                        Chennai</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div
                                                        class="col-md-3 py-3 col-12 d-flex align-items-center justify-content-center">
                                                    ...
                                                    <div
                                                        ...
                                                        <!-- Left: Posted Info -->
                                                      <div class="d-flex align-items-center small text-muted gap-4 mb-2">
                                                            <span class="d-flex align-items-center gap-1">
                                                                    ...
                                                                    <!-- Flag icon - opens report modal -->
                                                                    <span class="fw-bold" style="cursor:pointer;" >
                                                                        <i class="fa fa-flag text-danger ms-1" onclick="toggleFlagOptions()"></i>
                                                                    </span>
                                                                </span>
                                                                   <!-- Flag options -->
    ...
    <i class="fas fa-hourglass-end text-dark hourglass-rotate"></i> Expiry in
    2 days and 15 hours
</span>
...
<!--</span>-->
    ...
    <!-- Flag icon - opens report modal -->
    <span class="fw-bold" style="cursor:pointer;" data-bs-toggle="modal" data-bs-target="#reportModal">
        <i class="fa fa-flag text-danger ms-1"></i>
    </span>
</span>
                                                        ...
                                                        <div class="d-flex align-items-center gap-3 mb-2">
                                                            <span class="text-form">
                                                                <i class="fas fa-hourglass-end text-dark"></i> Expiry in
                                                                2 days and 15 hours
                                                            </span>
                                                            <div>
                                                                <span class="icon-report" onclick="toggleLike(this)">
...
"></div>
    ...
    align-items: end;
">
                                                            <div class="dropdown sort-dropdown mb-4 text-end">
...
<div class="col-8">
    <div class="row">
        ...
        <div class="row">
          <small class="d-flex justify-content-end align-items-end">
    

    <span role="button" data-bs-toggle="modal" data-bs-target="#remarksModal-1" class=" text-primary">
      <i class="fas fa-comment-dots me-1"></i> I'm familiar with the route ...
    </span>
  </small>
        </div>
      </div>
    ...
    <i class="fas fa-check-circle"></i> </button>
                                                                        ...
                                                                        <i class="fas fa-flag flag-icon" onclick="toggleFlagOptions(this)" title="Flag User"></i>
                                                                    </div>
                                                                      <!-- Right: After Accepted -->
                                                                <div class="bid-post-accept d-none" id="post-accept-1">
    <!-- Call icon -->
    <a href="tel:+919999999999" class="icon-circle bg-primary text-white me-2" title="Call">
        <i class="fas fa-phone fa-lg"></i>
    </a>

    <!-- WhatsApp icon -->
    <a href="https://wa.me/919999999999" target="_blank" class="icon-circle bg-success text-white me-2" title="WhatsApp">
...
<div class="col-8">
    ...
    <span role="button" data-bs-toggle="modal" data-bs-target="#remarksModal-1" class="text-decoration-underline text-primary">
      <i class="fas fa-comment-dots me-1"></i> I'm familiar with the route ...
    </span>
  </small>
        </div>
                                                                ...
                                                                <div class="col-4">
                                                                    <div class="bid-actions" id="actions-1">
                                                                        <button class="btn btn-success p-2 btn-sm accept-btn" onclick="acceptBid(1)" title="Accept">
                                                                      ...
                                                                      <!-- Right: After Accepted -->
                                                                    <div class="bid-post-accept d-none d-none" id="post-accept-1">
                                                                        <a href="tel:+919999999999" class="text-primary me-3" title="Call"><i class="fas fa-phone fa-lg"></i></a>
                                                                        <a href="https://wa.me/919999999999" target="_blank" class="text-success me-3" title="WhatsApp"><i class="fab fa-whatsapp fa-lg"></i></a>
                                                                       <button class="btn btn-danger p-2 btn-sm accept-btn" onclick="rejectBid(1)">
                                                                            <i class="fas fa-times-circle"></i> 
                                                                        </button>
                                                                    </div>
                                                                    </div>
...
<div class="col-8">
    ...
    <span role="button" data-bs-toggle="modal" data-bs-target="#remarksModal-1" class="text-decoration-underline text-primary">
      <i class="fas fa-comment-dots me-1"></i> I'm familiar with the route ...
                                                                ...
                                                                <div class="col-4">
                                                                    <div class="bid-actions" id="actions-2">
                                                                        <button class="btn btn-success p-2 btn-sm accept-btn" onclick="acceptBid(2)" title="Accept">
                                                                            <i class="fas fa-check-circle"></i>
                                                                        </button>
                                                                      ...
                                                                      <!-- Right: After Accepted -->
                                                                    <div class="bid-post-accept d-none d-none" id="post-accept-2">
                                                                        <a href="tel:+919999999999" class="text-primary me-3" title="Call"><i class="fas fa-phone fa-lg"></i></a>
                                                                        <a href="https://wa.me/919999999999" target="_blank" class="text-success me-3" title="WhatsApp"><i class="fab fa-whatsapp fa-lg"></i></a>
                                                                       <button class="btn btn-danger p-2 btn-sm accept-btn" onclick="rejectBid(2)">
                                                                            <i class="fas fa-times-circle"></i> 
                                                                        </button>
                                                                    </div>
                                                                    </div>
...
<div class="col-4">
                                                                    <div class="bid-actions" id="actions-3">
                                                                        <button class="btn btn-success p-2 btn-sm accept-btn" onclick="acceptBid(3)" title="Accept">
                                                                            <i class="fas fa-check-circle"></i>
                                                                        </button>
                                                                    ...
                                                                    <!-- Right: After Accepted -->
                                                                    <div class="bid-post-accept d-none d-none" id="post-accept-3">
                                                                        <a href="tel:+919999999999" class="text-primary me-3" title="Call"><i class="fas fa-phone fa-lg"></i></a>
                                                                        <a href="https://wa.me/919999999999" target="_blank" class="text-success me-3" title="WhatsApp"><i class="fab fa-whatsapp fa-lg"></i></a>
                                                                       <button class="btn btn-danger p-2 btn-sm accept-btn" onclick="rejectBid(3)">
                                                                            <i class="fas fa-times-circle"></i> 
                                                                        </button>
                                                                    </div>
                                                                    </div>
...
<div class="col-8">
    ...
    <span role="button" data-bs-toggle="modal" data-bs-target="#remarksModal-1" class="text-decoration-underline text-primary">
      <i class="fas fa-comment-dots me-1"></i> I'm familiar with the route ...
                                                                    ...
                                                                    <!-- Right: Initial Actions -->
                                                                    <div class="bid-actions" id="actions-4">
                                                                        <button class="btn btn-success p-2 btn-sm accept-btn" onclick="acceptBid(4)" title="Accept">
                                                                            <i class="fas fa-check-circle"></i>
                                                                        </button>
                                                                     ...
                                                                     <!-- Right: After Accepted -->
                                                                    <div class="bid-post-accept d-none d-none" id="post-accept-4">
                                                                        <a href="tel:+919999999999" class="text-primary me-3" title="Call"><i class="fas fa-phone fa-lg"></i></a>
                                                                        <a href="https://wa.me/919999999999" target="_blank" class="text-success me-3" title="WhatsApp"><i class="fab fa-whatsapp fa-lg"></i></a>
                                                                      <button class="btn btn-danger p-2 btn-sm accept-btn" onclick="rejectBid(4)">
                                                                            <i class="fas fa-times-circle"></i> 
                                                                        </button>
                                                                    </div>
                                                                    </div>
...
<div class="col-8">
    ...
    <span role="button" data-bs-toggle="modal" data-bs-target="#remarksModal-1" class="text-decoration-underline text-primary">
      <i class="fas fa-comment-dots me-1"></i> I'm familiar with the route ...
                                                                    ...
                                                                    <!-- Right: Initial Actions -->
                                                                    <div class="bid-actions" id="actions-5">
                                                                        <button class="btn btn-success p-2 btn-sm accept-btn" onclick="acceptBid(5)" title="Accept">
                                                                            <i class="fas fa-check-circle"></i>
                                                                        </button>
                                                                     ...
                                                                     <!-- Right: After Accepted -->
                                                                    <div class="bid-post-accept d-none d-none" id="post-accept-5">
                                                                        <a href="tel:+919999999999" class="text-primary me-3" title="Call"><i class="fas fa-phone fa-lg"></i></a>
                                                                        <a href="https://wa.me/919999999999" target="_blank" class="text-success me-3" title="WhatsApp"><i class="fab fa-whatsapp fa-lg"></i></a>
                                                                      <button class="btn btn-danger p-2 btn-sm accept-btn" onclick="rejectBid(5)">
                                                                            <i class="fas fa-times-circle"></i> 
                                                                        </button>
                                                                    </div>
                                                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                        ...
                                                        <div class="company-info">
                                                            <div class="car-specs">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6 col-12 d-flex justify-content-center align-items-end flex-column">
                                                                        <div class="amount">
                                                                            <span class="bids-c me-3">
                                                                                <i class="fas fa-gavel"></i> 15 Bids
                                                                            </span>₹3,800
                                                    ...
                                                    <div class="col-md-3 py-3 col-12 d-flex align-items-center justify-content-center">
                                                        <div class="price-action-section">
                                                            <!-- Optional pricing section -->
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 d-md-flex justify-content-md-between  align-items-center flex-md-wrap align-items-end">
                                                        ...
                                                        <div class="d-flex align-items-center small text-muted gap-4 mb-2">
                                                            <span class="d-flex align-items-center gap-1">
                                                                <i class="fa-solid fa-badge-check text-success"></i>
                                                                Posted by <strong class="fw-bold " style="cursor:pointer;text-decoration: underline;" data-bs-toggle="modal" data-bs-target="#userModal">John Doe</strong>
                                                            </span>
                                                        ...
                                                        <div class="d-flex align-items-center gap-3 mb-2">
                                                            ...
                                                            <div>
                                                               <span class="icon-report liked" onclick="toggleLike(this)">
    <i class="fa fa-heart"></i>
</span>

                                                                <span class="icon-report"><i class="fa fa-flag"></i></span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="text-end" id="actionSection">
                                                            ...
                                                            <div class="small text-muted mt-2 place-bid-section">
                                                                Need to increase amount?
                                                                <a href="#" class="text-primary fw-semibold text-decoration-none" data-bs-toggle="modal" data-bs-target="#carModal2">
                                                                    Place bid
                                                                </a>
                                                            </div>
                                                        </div>
...
<div class="modal fade" id="createJobModal" tabindex="-1" aria-labelledby="createJobLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content p-3">
            ...
            <div class="modal-body p-3">
                <form id="journeyForm" data-gtm-form-interact-id="0">

                    <!-- Journey Type -->
                    <div class="d-flex align-items-center flex-nowrap overflow-auto gap-2">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-4 col-12">
                            ...
                            <input type="datetime-local" id="pickupDate" class="form-control p-1">
                        </div>
                        <div class="col-md-4 col-12 d-none" id="dropSection">
                            <label>Drop Date &amp; Time</label>
                            <input type="datetime-local" id="dropDate" class="form-control p-1">
                        </div>
                        <div class="col-md-4 col-12">
                            <label for="passengerCount">Passenger Count</label>
                            <input type="number" id="passengerCount" name="passengerCount" class="form-control p-1"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-12">
                            ...
                            <input type="text" id="marketedPrice" class="form-control p-1">
                            <small class="form-text text-muted mt-1">The actual marketed price is ₹1500.</small>
                        </div>

                        <!-- Distance -->
                        <div class="col-md-4 col-12">
                            <label>Distance (KM)</label>
                            <input type="number" id="distance" class="form-control p-1" placeholder="Enter Distance">
                        </div>
                    </div>
                    <!-- Additional Charges -->
                    <div class="mb-2">
    ...
    <div class="mt-2 d-flex flex-column">
        <div class="form-check">
            <input class="form-check-input" type="radio" id="bataIncluded" name="bataRadio">
            <label class="form-check-label" for="bataIncluded">Included</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" id="bataClient" name="bataRadio">
    ...
    <div class="mt-2 d-flex flex-column">
        <div class="form-check">
            <input class="form-check-input" type="radio" id="tollIncluded" name="tollRadio">
            <label class="form-check-label" for="tollIncluded">Included</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" id="tollClient" name="tollRadio">
    ...
    <div class="mt-2 d-flex flex-column">
        <div class="form-check me-2">
            <input class="form-check-input" type="radio" id="parkingIncluded" name="parkingRadio">
            <label class="form-check-label" for="parkingIncluded">Included</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" id="parkingClient" name="parkingRadio">
            <label class="form-check-label" for="parkingClient">Passenger to pay</label>
                    ...
                    <div>
                        <label>Remarks</label>
                        <textarea class="form-control p-1" rows="2" placeholder="Enter remarks..."></textarea>
                    </div>
        ...
        <div class="modal-content p-3">
            ...
            <div class="modal-body" id="previewContent">
                            ...
                            <div class="row">
                                        ...
                                        <div class="car-specs">
                                            <div class="row">
                                                ...
                                                <div
                                                    ...
                                                    <div class="amount-des">
                                                        <i class="fas fa-bullhorn"></i> <small> Toll, parking, and bata
                                                            included</small>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-12 py-3 col-12">
                                    <div class="trip-info">
                                        <div class="route-section">
                                            <div class="location-time">
                                                <div class="date-time">26 Jul <br> <span> 09:00 AM</span> </div>
                                                <div class="location">Perambur railway station, <br> Chennai</div>
                                            </div>

                                            <div class="route-arrow">

                                                <div class="arrow-line">
                                                    <div class="duration d-none d-sm-block">2 days and 15 hours</div>
                                                    <div class="arrow-container">
                                                        <div class="long-arrow"></div>
                                                        <i class="fas fa-car car-icon"></i>
                                                    </div>
                                            ...
                                            <div class="location-time">
                                                <div class="date-time">29 Jul <br> <span> 05:42 AM</span> </div>
                                                <div class="location">Kilambakkam bus terminus <br> chennai</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="summary-section p-3 bg-light rounded">
                    <h6 class="fw-bold mb-3"><i class="fas fa-file-alt me-2"></i>Job Summary</h6>
                    <div class="row">
                        <div class="col-md-6">
                            <p><i class="fas fa-calendar-day me-2"></i><strong>Pickup:</strong> 15 May 2023, 10:00 AM
                            </p>
                            <p><i class="fas fa-map-marker-alt me-2"></i><strong>From:</strong> Mumbai, Maharashtra</p>
                        </div>
                        <div class="col-md-6">
                            <p><i class="fas fa-calendar-day me-2"></i><strong>Drop:</strong> 15 May 2023, 01:30 PM</p>
                            <p><i class="fas fa-map-marker-alt me-2"></i><strong>To:</strong> Pune, Maharashtra</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success" onclick="submitJob()">
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content p-4 rounded-4 text-center">
            ...
            <div class="modal-footer justify-content-center border-0 pt-3">
                <button class="btn btn-success px-4 fw-bold" id="confirmBidBtn">
                    <i class="fas fa-check me-1"></i> Confirm
                </button>
                <button class="btn btn-danger px-4 fw-bold" data-bs-dismiss="modal">
        ...
        <div class="modal-content border-0 shadow-lg position-relative">
            <div class="modal-body text-center p-4 bg-light">
                ...
                <p class="text-muted mb-3">
                    Your bid of <span id="successBidAmount" class="fw-bold text-dark p-2 fs-4">₹12</span>
...
<div class="modal fade" id="userModal" tabindex="-1" aria-labelledby="userModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content p-3">
            ...
            <h5 class="modal-title title-mobile ms-auto fw-bold">
                  User
            ...
            <div class="modal-body bg-light p-2">
                ...
                <div class="mb-3 bg-white rounded-3 shadow-sm p-3 border border-warning border-opacity-25">
                    <div>
                        ...
                        <!-- Action Buttons -->
                        <!--<div class=" align-items-center mt-3 d-flex text-center justify-content-center gap-3">-->
...
<button type="button" class="btn-close position-absolute btn-sm top-0 end-0 m-3" data-bs-dismiss="modal" aria-label="Close"></button>
    ...
    <p class="title-mobile d-flex justify-content-center align-items-center fw-bold">
            ...
            <!-- Footer with action buttons -->
            <div class="modal-footer bg-white border-0 pt-0 d-flex flex-column flex-sm-row gap-2 justify-content-center justify-content-sm-end align-items-center">
                <button type="button" class="btn btn-warning text-dark fw-bold px-4 shadow-sm" onclick="placeBid()">
...
<div class="modal fade" id="acceptBidModal" tabindex="-1" aria-labelledby="acceptBidModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
     ...
     <div class="modal-body p-3">
                <p class="fw-semibold fs-6 mb-2">   Are you sure you want to accept this driver with this bid amount?</p>
                <h3 class="text-primary fw-bold d-flex justify-content-center" id="bidAmountDisplay">₹0</h3>
...
<div class="modal fade" id="rejectConfirmModal" tabindex="-1" aria-labelledby="rejectConfirmModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body p-3">
                <p class="fw-semibold fs-6 mb-2">   Are you sure you want to reject this driver with this bid amount?</p>
                <h3 class="text-primary fw-bold d-flex justify-content-center" id="bidAmountDisplay">₹0</h3>
...
function toggleFlagOptions(elem = null) {
    // Hide all currently visible .flag-options
    ...
    if (elem && typeof elem.closest === 'function') {
        // Contextual usage: clicked inside a .bid-card
        target = elem.closest('.bid-card')?.querySelector('.flag-options');
    } else {
        // General usage: just open the first one
        target = document.querySelector('.flag-options');
    }
    ...
    document.addEventListener('click', function (event) {
        // Close remarks if click is outside
        const allRemarks = document.querySelectorAll('.glassy-remarks');
        allRemarks.forEach(el => {
            if (!el.contains(event.target) && !event.target.classList.contains('info-icon')) {
                el.style.display = 'none';
            }
        });

        // Close flag options if click is outside
        const allFlags = document.querySelectorAll('.stylish-flags');
        allFlags.forEach(el => {
            if (!el.contains(event.target) && !event.target.classList.contains('flag-icon')) {
                el.style.display = 'none';
            }
        });
    });
    ...
    function submitJob() {
        // Simple alert showing job was created
...
<script>
   function enableBidEdit(inputId) {
    ...
    function confirmBidPlacement() {
        ...
        document.getElementById("successBidAmount").textContent = `₹${amount}`;
    ...
    $(document).ready(function () {
        $('.agreeBtn').on('click', function () {
            ...
            $('#confirmBidBtn').off('click').on('click', function () {
    ...
    function placeBid() {
        ...
        const bidRemarks = document.getElementById('bidRemarks').value;

        if (!bidAmount) {
            alert('Please enter a bid amount before placing your bid.');
            return;
        }

        // Here you would typically send the data to your server
        alert(`Bid placed successfully!\nAmount: ₹${bidAmount}\nRemarks: ${bidRemarks || 'None'}`);
    ...
    $(document).ready(function () {
        ...
        $('#mobile_menu_opener').click(function () {
            $('#left_sidebar').show();
            $(this).toggleClass('fa-bars fa-bars');
