          ...
          <div class="col-lg-12 col-md-12 mb-30">
            <div class="v-middle text-center ">
              ...
              <div class="d-none d-md-block">
                ...
                <a href="pricing" class="cs_btn cs_style_2 mt-4 me-3">Get start for free&nbsp;<i
                ...
                @else
                <a href="signup" class="cs_btn cs_style_2  mt-4">Get start for free&nbsp;<i
                    class="fa-regular fa-car-side-bolt"></i></a>
                @endif
              </div>
            ...
            <div class="v-middle text-center two">
              <img src="{{ asset('goride/img/slider/mobile_mockup_two.webp') }}" alt="mobile_mockup" id="mobile_mockup">
              <div id="india-content">
                  @if (isset($_COOKIE['cusid']) && $_COOKIE['cusid'] != null)
                  <a href="/jobs" class="theme-btn btn">
                    Get Your Jobs <i class="fa-solid fa-print-magnifying-glass ms-2"></i>
                  </a>
                  <a href="https://play.google.com/store/apps/details?id=com.shi.goride.customer" target="_blank" class="theme-btn3  btn">
                    Download our App <i class="fa-brands fa-google-play ms-2"></i>
                  </a>
                  @else
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-12 d-flex justify-content-center align-items-center">
        <div class="phone-mockup position-relative" id="notify_jobs">
      ...
      <div class="col-md-6 col-12 text-center d-flex flex-column justify-content-start align-items-center mt-4">
        <div class="section-title nimate__animated animate__fadeInDown"> <span class="my-0">One Platform for Rides &amp;
            Jobs</span>
        </div>
        <p class="fw-semibold my-0">On our platform, passengers or verified drivers can post trip details, bid their
          price, compare fares, check ratings, and book rides instantly.</p>

        <div class="row d-flex justify-content-center align-items-center">
          <!-- Left Image -->
          <div class="col-md-6 col-12 text-center">
            <img src="https://www.goride.net.in/goride/img/mobile-app.jpg" alt="Job Search" class="img-fluid job-search"
              style="
                max-width: 526px;
                /* height: 366px; */
            ">
    ...
    <div class="row">
      <div class="col-lg-6 col-md-12  i_phone mb-md-30">
        <div class="content" data-aos="fade-down" data-aos-duration="1000">
          <div class="text-center text-md-start">
            <h1 class="section-subtitle">The Heartbeat of Mobility</h1>
          </div>
          <div class="section-title text-center text-md-start">Revolutionizing <span>Dispatch with AI-Powered
              Solutions</span></div>
          <p class="mb-2 mb-md-0 fw-normal" style="text-align: justify;">Welcome to GoRide, the leading AI-based
            dispatch system designed to optimize
          ...
          <div class="text-center text-md-start">
            <a href="about" class=" button-4 mb-3 mb-md-0">Learn More About GoRide's Services <span
      ...
      <div class="col-lg-5 offset-lg-1 col-md-12">
        <div class="item " data-aos="fade-down" data-aos-duration="1000"> <img
            src="{{ asset('goride/img/about.webp') }}" class="img-fluid" alt="about">
...
<section class="features section-padding mt-5" id="features">
  <div class="container">
    ...
    <div class="row justify-content-around">
      ...
      <div class="col-12 col-md-2 d-flex justify-content-center d-md-block mb-3 ms-md-2">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6" style="align-self: center;">
        <ul>
          <li class="demo-li fw-normal" data-aos="fade-up" data-aos-duration="1000"><i
              class="fa-solid fa-check-double"></i><strong>Enhanced Efficiency:</strong>
            "Reduce idle
            time and fuel consumption with smart dispatching and routing."
          </li>
          <li class="demo-li fw-normal" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100"><i
              class="fa-solid fa-check-double"></i><strong>Increased Revenue:</strong>
            "Boost your earnings with dynamic pricing and optimized
            fleet utilization."
          </li>
          <li class="demo-li fw-normal" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200"><i
              class="fa-solid fa-check-double"></i><strong>Improved Customer Experience:
            </strong>"Deliver faster, more reliable
            service with AI-powered dispatching."</li>
          <li class="demo-li fw-normal" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300"><i
              class="fa-solid fa-check-double"></i><strong>Scalable Solutions:
            </strong>"Grow your business with a platform that scales with
            you, from a few vehicles to hundreds."</li>
          <li class="demo-li fw-normal" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400"><i
              class="fa-solid fa-check-double"></i><strong>Actionable
...
<section class="how">
  <div class="container">
    ...
    <div class="timeline">
      <!-- Desktop View -->
      <div class="roadmap-desktop row d-none d-md-flex">
        <div class="step col-md-3" data-aos="fade-up" data-aos-duration="2000">
          <div class="content yellow">
            <h2>Step 1</h2>
            <h3>Easy Setup</h3>
            <p>Getting started with GoRide is simple. Our team will guide you through the setup process and customize
              the platform to fit your needs.</p>
          </div>
        </div>
        <div class="step col-md-3">
          <div class="content orange" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="100">
            <h2>Step 2</h2>
        ...
        <div class="step col-md-3" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="300">
          <div class="content blue">
            ...
            <p>Use our analytics tools to monitor performance, identify trends, and make informed decisions to enhance
              your operations.</p>
          </div>
        </div>
      </div>

      <!-- Mobile View (Unique Owl Carousel) -->
      <div class="roadmap-mobile owl-carousel d-block d-md-none">
        <div class="step item">
          <div class="content yellow">
            <h2>Step 1</h2>
            <h3>Easy Setup</h3>
      ...
      <div class="col-md-12">
        <div class="owl-carousel owl-theme">
          <div class="item">
            ...
            <div class="text ">
              <p class="fw-normal">Sri Hema Infotech's incredible customer support made integrating the Dispatch Taxi
                System seamless, ensuring efficiency and reliability from day one, boosting both our operations and
                customer satisfaction.</p>
            </div>
          ...
          <div class="item">
            ...
            <div class="text">
              <p class="fw-normal">The Dispatch Taxi System simplifies operations, offering an intuitive platform,
                real-time updates, and improved efficiency, making it indispensable for any taxi service aiming for
                reliability and enhanced experiences.</p>
            </div>
            <div class="info mt-30">
              <div class="img-curv">
          ...
          <div class="item">
            ...
            <div class="text">
              <p class="fw-normal">Using Sri Hema Infotech's Dispatch Taxi System, our operations transformed with
                real-time GPS tracking & dispatching, resulting in streamlined services and higher efficiency for both
          ...
          <div class="item">
            ...
            <div class="text">
              <p class="fw-normal">The system provides easy setup, real-time tracking, and automatic dispatch for faster
                ride allocation. Though efficient, adding missing features would enhance its value, making it even
                better for taxi services.</p>
            </div>
            <div class="info mt-30">
              <div class="img-curv">
          ...
          <div class="item">
            ...
            <div class="text">
              <p class="fw-normal">Go Ride simplifies operations with an easy-to-use platform, reducing wait times and
                boosting efficiency. It's a game-changing solution for taxi services focused on improving customer
                satisfaction and streamlining processes.</p>
            </div>
            <div class="info mt-30">
              <div class="img-curv">
          ...
          <div class="item">
            ...
            <div class="text">
              <p class="fw-normal">Sri Hema Infotech’s system brought significant improvements to Go Ride, offering
                real-time tracking and effortless bookings, improving experiences for passengers and drivers alike while
  ...
  <div class="container">
    <div class="mcb-wrap-inner">
      ...
      <div class="product-like-reputed-content" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
        ...
        <p class="bottom-gap">GoRide offers 100+ API integrations to help you connect multiple stakeholders and enhance
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center mt-4">
        ...
        <form class="frm-sec">
          ...
          <span class="by-click-text ">Already have an account? <a class="by-click-text under-line text-danger "
              href="login" contenteditable="false" style="cursor: pointer;"> Sign In
            </a>
          </span>
        </form>
      </div>
...
<script>
  ...
  if (countryC === 'IN') {
    document.querySelector('#slider-image .item').style.backgroundImage = "url('/goride/img/goride_main_.webp')";
