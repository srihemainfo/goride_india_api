                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group mt-0">
                                    ...
                                    <input type="text" class="form-control" value="" name="f_name" id="f_name"
                                        required="" oninput="this.value = this.value.replace(/[^A-Za-z ]/g, '').slice(0, 70);"
                                        maxlength="70" placeholder="Name">
                                    <span id="f_name_err" class="spanClass" style="color: red;"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group mt-0">
                                    ...
                                    <small class="form-text fw-bold  mt-1" style="font-weight: 500;font-size:12px;">
                ...
                <div class="signup-card text-center p-4">
                    <form id="form_submit" method="post">
                        ...
                        <div class="col-12 col-md-12 text-center my-3 text-center otp-text">
                           ...
                           <p class="otp-both">
                            <span class="otp-icon whatsapp"><i class="fa-brands fa-whatsapp"></i> WhatsApp</span>
                            <span class="slash">/</span>
                           <span class="otp-icon sms"><i class="fa-solid fa-comment-dots"></i> SMS</span>
                    ...
                    success: function (response) {
                        ...
                        if (response != "") {
                            if (response.status == 'success') {
                                ...
                                $('#formTwo').hide();
                                $('#formThreeTxt').html(
                                    ` Enter the 6-digit code from your registered WhatsApp/SMS <br> +${mobileNumber}`
                                );
