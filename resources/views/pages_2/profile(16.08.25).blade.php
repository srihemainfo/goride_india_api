...
<section class="login_dashboard_section" id="main-dashboard-wrapper">
    ...
    <a href="#" class="p-0" onclick="toggleDropdown(event)" style="cursor: pointer; position: relative; display: inline-block;">
        <img id="profile-pic" 
             src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/profile/user-1.jpg" 
              class="profile-pic rounded-circle mt-2"
             alt="profile-img" style="object-fit: cover;">

        <!-- Edit icon overlay -->
        <i class="fa fa-edit edit-icon-overlay" 
  ...
  <form id="profile_update" enctype="multipart/form-data" onsubmit="profile_update(event)">
    ...
    <div class="form-section">
      ...
      <div class="form-grid-2">
        ...
        <div class="form-control">
          ...
          <input type="text" name="aadhaar_number" id="aadhaar_number" placeholder="Enter 12-digit Aadhaar">
        </div>
        <div class="form-control">
          <label>License Number <span>*</span></label>
          <input type="text" name="license_number" id="license_number" placeholder="Enter license number">
        </div>
      </div>
    </div>
    ...
    <!-- Document Upload -->
                  ...
                  <section class="section">
                    <h2 class="section-heading">Document Upload</h2>
                    <div class="form-grid-2">
                      <div class="form-control">
                        <label>Aadhar Card (Front)<span class="text-danger">*</span></label>
                        <input type="file" name="aadhar_image_front" >
                      </div>
                      <div class="form-control">
                        <label>Aadhar Card (Back)<span class="text-danger">*</span></label>
                        <input type="file" name="aadhar_image_back" >
                      </div>
                      <div class="form-control">
    ...
    <i class="fas fa-info-circle me-1"></i> File size must be less than 5MB
  </small>
                  </section>
  ...
  <div class="col-md-3 col-sm-6 text-center">
    ...
    <img src="https://airportrides-storage.s3.amazonaws.com/goride-aadhar/11-1/ckBwQ1XaR2aaXGzVzr1CUdzMnu5uMfZhRJJvpGkm.jpg" class="card-img-top mx-auto d-block" alt="aadhar_image_front" id="aadhar_image_front" style="width: 150px; height: 100px; object-fit: contain; border-radius: 8px; border: 1px solid #ddd; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
  </div>

  <div class="col-md-3 col-sm-6 text-center">
    <label>Aadhar Card (Back)</label>
    <img src="https://airportrides-storage.s3.amazonaws.com/goride-aadhar/11-Screenshot%202024-01-23%20152221/1Sgo6PJxKXRaahrHga0D2nJ93wlzCMd1PUoFxsG9.png" class="card-img-top mx-auto d-block" alt="aadhar_image_back" id="aadhar_image_back" style="width: 150px; height: 100px; object-fit: contain; border-radius: 8px; border: 1px solid #ddd; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
  </div>

  <div class="col-md-3 col-sm-6 text-center">
    <label>Licence</label>
    <img src="https://airportrides-storage.s3.amazonaws.com/goride-driver/11-Screenshot%202024-01-23%20152221/DXZJONrobOsdemEZyNcqqAJGb2RTMypvB5LEXtVC.png" class="card-img-top mx-auto d-block" alt="licence_image" id="licence_image" style="width: 150px; height: 100px; object-fit: contain; border-radius: 8px; border: 1px solid #ddd; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
  </div>

  <div class="col-md-3 col-sm-6 text-center">
    <label>Profile Image</label>
    <img src="https://airportrides-storage.s3.amazonaws.com/goride-driver/11-user-1/Fj3vgIG7Zdh2fLRkU3LeSHJYfPdZfPqj6tLX5fnw.jpg" class="card-img-top mx-auto d-block" alt="profile_image" id="profile_image" style="width: 150px; height: 100px; object-fit: contain; border-radius: 8px; border: 1px solid #ddd; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
  </div>
</div>
              </section>
...
//     <script>
// function previewFile(inputId, imgId, sectionId) {
...
//       // Show the preview section if at least one file is selected
...
//   } else {
//     preview.src = '';
//     // Hide the preview section if no files are selected
//     const allInputs = ['aadhar_front_input', 'aadhar_back_input', 'licence_input', 'profile_input'];
//     const hasFiles = allInputs.some(id => document.getElementById(id).files.length > 0);
//     if (!hasFiles) {
