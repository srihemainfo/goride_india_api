...
.spinner {
    ...
    border-top: 4px solid #f9bf00; /* Blue */
    border-radius: 50%;
...
.tooltip-inner {
  ...
  padding: 15px;
  border-radius: 10px;
  font-size: 14px;  /* same everywhere */
  line-height: 1.6;
...
.tooltip-box ul li {
  ...
  line-height: 1.5;
  position: relative;
  padding-left: 20px; /* spacing for arrow */
}
...
.create-btn:active {
  ...
  background-color: #e6ad00; /* deeper yellow when clicked */
  box-shadow:
    0 0 0 var(--stone-800),
    0 0 0 var(--stone-50);
}
...
.create-btn:active {
  ...
  background-color: #e6ad00; /* slightly darker yellow when clicked */
}
                ...
                <div class="card px-0">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <ul class="nav nav-tabs card-header-tabs w-100 flex-wrap flex-sm-nowrap" id="jobTabs"
                            ...
                            <li class="nav-item ms-auto d-none d-sm-block me-5 pe-2" role="presentation">
                     ...
                     <div class="row d-block d-md-none">
                        <div class="col-md-6 col-12 ">
                            ...
                            <p><i class="fas fa-map-marker-alt me-2 text-primary"></i><strong
                                    ...
                                    Maharashtra</span></p>
                                        <p><i class="fas fa-calendar-day me-2 text-primary"></i><strong
                                    class="fw-bold">Pickup Date/Time:</strong> <span id="pre_pick5">15 May 2023, 10:00 AM</span>
                            </p>
                                  <p><i class="fas fa-calendar-day me-2 text-danger pre_drop_hide"></i><strong
                        ...
                        <div class="text-left estimated_fare py-0">
                            <p class="mb-0">
                                <strong>Estimated Fare
                                    (₹):</strong> <span id="pre_fare5" class="fw-bold ms-2">1343</span></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content w-100 p-3 position-relative">
            ...
            <div class="modal-body bg-light p-2 mt-3">
                ...
                <div class="mb-2">
                    ...
                    <textarea class="form-control border-warning fw-semibold" id="bidRemarks" rows="2"  oninput="this.value = this.value.replace(/[^0-9a-zA-Z ]/g,'').slice(0,150)"
        ...
        <div class="modal-content  w-100 p-3">
            <div class="modal-body bg-light p-2">
                ...
                <div class="mb-2">
                    ...
                    <textarea class="form-control border-warning fw-semibold" id="manageBidRemarks" rows="2" placeholder="Enter You Remarks"  oninput="this.value = this.value.replace(/[^0-9a-zA-Z ]/g,'').slice(0,150)"
                        disabled=""></textarea>
                </div>
            </div>
