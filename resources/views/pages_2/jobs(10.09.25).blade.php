...
/* Reduce calendar cell height & width */
.daterangepicker td,
.daterangepicker th {
  height: 28px !important;   /* adjust smaller than default */
  line-height: 28px !important;
  width: 32px !important;    /* shrink width if needed */
  font-size: 12px;           /* smaller text to fit */
  padding: 0 !important;     /* remove extra padding */
}

/* Optional: tighten up the overall calendar */
      ...
      <div class="col-12 px-0">
        <div class="card px-0">
          ...
          <div class="card-body tab-content" id="jobTabsContent">
           ...
           <div class="d-flex align-items-center justify-content-end gap-2 mb-3 mt-2 mt-md-0 flex-wrap">
                          ...
                          <div class="col-md-5 col-12 position-relative">
                            ...
                            <div style="display: flex;justify-content: end;align-items: end;">
                              <div class="dropdown sort-dropdown  text-end mb-2">
                                <button class="btn btn-light dropdown-toggle" type="button" id="sortMenuButton"
                                  data-bs-toggle="dropdown" aria-expanded="false">
                                  <i class="fas fa-filter " id="selectedSort"></i>
                                </button>

                                <ul class="dropdown-menu" aria-labelledby="sortMenuButton">
                                  <li><a class="dropdown-item" href="#" onclick="setActiveSort(this)">Price - Low to
                                      High</a></li>
                                  <li><a class="dropdown-item" href="#" onclick="setActiveSort(this)">Price - High
                                      to Low</a></li>
                                </ul>
                              </div>
                            ...
                            <div style="
                              ...
                              <div class="dropdown sort-dropdown  text-end">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="sortMenuButton">
                                  ...
                                  <li><a class="dropdown-item" href="#" onclick="sortCards('priceLow', this)"
                                      data-label="Price - Low to High">Price - Low
                                      to High</a></li>
                                  <li><a class="dropdown-item" href="#" onclick="sortCards('priceHigh', this)"
                                      ...
                                      <div class="row">
                                        <div class="d-flex justify-content-center gap-3">
                                          <div class="driver-info">
                                            <div class="driver-name" style="cursor:pointer; text-decoration: underline;"
                                          ...
                                          <div class="bid-actions" id="actions-1">
                                            <button class="btn btn-success p-2 btn-sm accept-btn"
                                              onclick="showAcceptConfirmation(1)" title="Accept">
                                          ...
                                          <div class="bid-post-accept d-none" id="post-accept-1">
                                            <!-- Call icon -->
                                            <div href="tel:+919999999999" class="icon-circle bg-primary text-white me-2"
                                              title="Call">
                                              <i class="fas fa-phone fa-lg"></i>
                                            </div>

                                            <!-- WhatsApp icon -->
                                            <div href="https://wa.me/919999999999" target="_blank"
                                              class="icon-circle bg-success text-white me-2" title="WhatsApp">
                                              <i class="fab fa-whatsapp fa-lg"></i>
                                            </div>

                                            <!-- Reject button -->
                                            <button class="btn btn-danger p-2 btn-sm accept-btn"
                                              onclick="showRejectModal(1)" title="Reject">
                                ...
                                <div class="bid-card" data-card-id="2">
                                      ...
                                      <div class="row">
                                        <div class="d-flex justify-content-center gap-3">
                                          ...
                                          <div class="bid-actions" id="actions-2">
                                            <button class="btn btn-success p-2 btn-sm accept-btn"
                                              onclick="showAcceptConfirmation(2)" title="Accept">
                                              <i class="fa-solid fa-check"></i>
                                            </button>
                                          ...
                                          <div class="bid-post-accept d-none" id="post-accept-2">
                                            ...
                                            <!-- Reject button -->
                                            <button class="btn btn-danger p-2 btn-sm accept-btn"
                                              onclick="showRejectModal(2)" title="Reject">
                                              <i class="fas fa-times-circle"></i>
                                            </button>
                                          </div>
                                        </div>
                                  ...
                                  <div class="flag-options stylish-flags mt-2" style="display: none;">
                                    <button onclick="reportUser('Ramesh Kumar')"><i
                                      ...
                                      Block</button>
                                    <button onclick="markAsSpam('Ramesh Kumar')"><i class="fas fa-ban"></i> Block and
                                      Report
                                      with Spam</button>
                                  </div>
                                </div>
                                      ...
                                      <div class="row">
                                        <div class="d-flex justify-content-center gap-3">
                                          ...
                                          <div class="bid-actions" id="actions-3">
                                            <button class="btn btn-success p-2 btn-sm accept-btn"
                                              onclick="showAcceptConfirmation(3)" title="Accept">
                                              <i class="fa-solid fa-check"></i>
                                            </button>
                                          ...
                                          <div class="bid-post-accept d-none" id="post-accept-3">
                                            ...
                                            <!-- Reject button -->
                                            <button class="btn btn-danger p-2 btn-sm accept-btn"
                                              onclick="showRejectModal(3)" title="Reject">
                                              <i class="fas fa-times-circle"></i>
                                            </button>
                                          </div>
                                        </div>
                                      ...
                                      <div class="row">
                                        <div class="d-flex justify-content-center gap-3">
                                          ...
                                          <div class="bid-actions" id="actions-4">
                                            <button class="btn btn-success p-2 btn-sm accept-btn"
                                              onclick="showAcceptConfirmation(4)" title="Accept">
                                              <i class="fa-solid fa-check"></i>
                                            </button>
                                          ...
                                          <div class="bid-post-accept d-none" id="post-accept-4">
                                            ...
                                            <!-- Reject button -->
                                            <button class="btn btn-danger p-2 btn-sm accept-btn"
                                              onclick="showRejectModal(4)" title="Reject">
                                              <i class="fas fa-times-circle"></i>
                                            </button>
                                          </div>
                                        </div>
                                      ...
                                      <div class="row">
                                        <div class="d-flex justify-content-center gap-3">
                                          ...
                                          <div class="bid-actions" id="actions-5">
                                            <button class="btn btn-success p-2 btn-sm accept-btn"
                                              onclick="showAcceptConfirmation(5)" title="Accept">
                                              <i class="fa-solid fa-check"></i>
                                            </button>
                                          ...
                                          <div class="bid-post-accept d-none" id="post-accept-5">
                                            ...
                                            <!-- Reject button -->
                                            <button class="btn btn-danger p-2 btn-sm accept-btn"
                                              onclick="showRejectModal(5)" title="Reject">
                                              <i class="fas fa-times-circle"></i>
                                            </button>
                                          </div>
                                        </div>
                            ...
                            <div class="trip-info">
                              <div class="route-section m-3 p-1">
                                ...
                                <div class="location-time">
                                  ...
                                  <div class="location " onclick="toggleAddress(this)">Perambur Bus
                      ...
                      <div class="row">
                            ...
                            <div class="car-specs">
                              <div class="row">
                                ...
                                <div class="col-md-6 col-6 d-flex align-items-center gap-1">
                                  <span class="icon-report me-2 d-none d-md-inline" onclick="toggleLike(this)"
                        ...
                        <div
                          ...
                          <div class="text-end d-none d-md-block" id="actionSection">
                            <button class="btn btn-sm btn-warning ms-auto agreeBtn " onclick="bidManage('23', this)"><i
  ...
  <div class="modal-dialog modal-dialog-centered modal-md w-100">
    <div class="modal-content  p-3">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger btn-sm" onclick="cancelJob()">Yes, Cancel</button>
      </div>
        ...
        <form id="journeyForm" data-gtm-form-interact-id="0" enctype="multipart/form-data"
          ...
          <div class="row ">
            ...
            <div class="col-md-6 col-12">
              ...
              <small class="form-text text-muted mt-1 d-none">The actual marketed price is <span id="approx_fare"
                  class="fw-bold">₹1500</span>.</small>
            </div>
