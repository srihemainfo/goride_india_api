                ...
                <form id="journeyForm" data-gtm-form-interact-id="0" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <input type="text" id="marketedPrice" name="fare" class="form-control p-1 mb-0"
                ...
                <div class="summary-section p-3 bg-light rounded" style="width: auto !important;">
                    ...
                    <div class="row">
                        ...
                        <div class="text-center">
                            <p><i class="fas fa-rupee-sign me-2 text-warning"></i><strong class="fw-bold">Estimated Fare
                                    (₹):</strong> <span id="pre_fare">1343</span></p>
                        </div>
                    </div>
                </div>
            </div>
