                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 mb-30">
                            ...
                            <div class="v-middle text-center two  ">
                                ...
                                @if (isset($_COOKIE['cusid']) && $_COOKIE['cusid'] != null)
                                    <a href="/login" class="header-jobs btn">
                                     Get Your Jobs
                                    </a>
                                @else
                                    <a href="/jobs" class="header-jobs btn">
                                     Get Your Jobs
                                    </a>
                                @endif
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12  i_phone mb-md-30">
                    <div class="content" data-aos="fade-down" data-aos-duration="1000">
                       ...
                       <p class="mb-2 mb-md-0 fw-normal" style="text-align: justify;">Welcome to GoRide, the leading AI-based dispatch system designed to optimize
...
if (countryC === 'IN') {
    ...
    document.querySelector('#slider-image .item').style.backgroundImage = "url('/goride/slider/goride_main_banner.webp')";
