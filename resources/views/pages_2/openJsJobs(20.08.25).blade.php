                            ...
                            jobs_content +=
                                ...
                                `<div class="compact-car-card">
                                    ...
                                    : ''}
                                                                    ...
                                                                    <span class="d-flex align-items-center gap-1">
                                                                        ...
                                                                        <span class="ms-auto" id="actionSection">
                                                                              ${value.user_bid == 'yes' ?
                                    `<button class="btn btn-sm btn-warning ms-auto agreeBtn ${value.job_status != 'created' ? 'd-none' : ''}" onclick="bidManage('${value.id}', this)">
                                    ...
                                    `<div class="small text-muted mt-2 place-bid-section d-flex justify-content-between align-items-center">
                                                                            ...
                                                                            <a href="#"
                                                                                class="text-primary fw-semibold text-decoration-none" onclick="bidCreate('${value.poster_name}', '${value.poster_company}', '${value.poster_mobile}', '${value.poster_ratings}', '${value.poster_complete_jobs}','${value.id}', '${value.created_at}')" style="font-size: 16px;">
                                                                                Place bid
                                                                            </a>
                                                                        </div>`
                                }
                                                        ...
                                                        <div class="col-12">
                                                            <div class="row">
                                                                <div class="d-flex justify-content-center gap-3">
                                                                 ...
                                                                 <div class="driver-name d-flex align-items-center gap-2" style="cursor:pointer;" data-bs-toggle="modal" data-bs-target="#userModal">

  <!-- Initials Badge -->
  <span class="initials-badge" style="
    display: inline-flex;
    align-items: center;
    ...
    height: 32px;
    border-radius: 50%;
    background-color: #701fd9; /* Bootstrap warning yellow, can change */
    color: #fff;
    font-weight: 600;
    font-size: 14px;
  ...
  <!-- Full Name --></div>
                                                ...
                                                <div class="col-12">
                                                    <div class="row">
                                                        <div class="d-flex justify-content-center gap-3">
                                                          <div class="driver-info">
                                                            <div class="driver-name" style="cursor:pointer; " data-bs-toggle="modal" data-bs-target="#userModal"><div class="masked">R*** K****</div></div>
                                                          <div class="driver-info">
                                                            <div class="amount-bid">₹100</div>
                                                          </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status) {
                        ...
                        $('#m_company').text(data.poster_company);
                        // console.log
