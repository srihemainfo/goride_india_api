...
.title::after {
  ...
  background-color: #f8be00; /* yellow color */
  border-radius: 2px;
}
...
.form-group select:focus {
  outline: none;
  border-color: #f8be00;
  box-shadow: 0 0 5px rgba(248, 190, 0, 0.5);
}

input[type="file"] {
  border: 2px dashed #f8be00;
                  ...
                  <section class="section">
                    ...
                    <div class="form-grid">
                      <div class="form-group">
                        ...
                        <input type="text" placeholder="Enter Name" name="name" id="f_name">
                      </div>
                      <div class="form-group">
                        <label>Email <span class="text-danger">*</span></label>
                        <input type="email" placeholder="Enter email" name="email" id="f_email">
                      </div>
                      <div class="form-group">
                        <label>Phone Number <span class="text-danger">*</span></label>
                        <input type="tel" placeholder="Enter Phone Number" name="phone" id="f_phone">
                      </div>
                ...
                <div class="form-grid">
                  <div class="form-group">
                    <label>Aadhar Card (Front)</label>
                     <img src="" class="card-img-top" alt="aadhar_image_front" id="aadhar_image_front" style="width: 150px;height: 100px; object-fit: contain;border-radius: 8px;border: 1px solid #ddd;         box-shadow: 0 2px 5px rgba(0,0,0,0.1);      ">
                  </div>
                  <div class="form-group">
                    <label>Aadhar Card (Back)</label>
                     <img src="" class="card-img-top" alt="aadhar_image_back" id="aadhar_image_back" style="         width: 150px;         height: 100px;         object-fit: contain;         border-radius: 8px;         border: 1px solid #ddd;         box-shadow: 0 2px 5px rgba(0,0,0,0.1);      ">
                  </div>
                  <div class="form-group">
                    <label>Licence</label>
                     <img src="" class="card-img-top" alt="licence_image" id="licence_image" style="         width: 150px;         height: 100px;         object-fit: contain;         border-radius: 8px;         border: 1px solid #ddd;         box-shadow: 0 2px 5px rgba(0,0,0,0.1);      ">
                  </div>
                  <div class="form-group">
                    <label>Profile Image</label>
                     <img src="" class="card-img-top" alt="profile_image" id="profile_image" style="         width: 150px;         height: 100px;         object-fit: contain;         border-radius: 8px;         border: 1px solid #ddd;         box-shadow: 0 2px 5px rgba(0,0,0,0.1);      ">
                  </div>
                </div>
              </section>
