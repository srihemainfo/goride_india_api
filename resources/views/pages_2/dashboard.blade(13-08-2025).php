                                                        ...
                                                        <tbody class="text-center">
                                                            @foreach ($userDetails['userDetails']['crmList'] as $key => $value)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <label class="switch" title="{{ $value['active_status'] == 0 ? 'Active' : 'Inactive' }}">
                                                                            <input type="checkbox" class="status-toggle" data-id="{{ $value['id'] }}" data-subid="{{ $value['subscription_id'] }}" {{ $value['active_status'] == 0 ? 'checked' : '' }}>
...
<!-- Modal -->
<div class="modal fade" id="setupCrmModal" tabindex="-1" aria-labelledby="setupCrmModalLabel" aria-hidden="true" data-bs-backdrop="false">
...
<!--Fare Type Model-->
<div class="modal fade" id="FaretypeModal" tabindex="-1" aria-labelledby="FaretypeModalLabel" aria-hidden="true" data-bs-backdrop="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
                <h5 class="modal-title" id="setupCrmModalLabel">Setup Fare Type</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-body">
                <div class="text-center mb-4">
                    <p>Select your CRM Fare type to proceed:</p>
                </div>

                <div class="row">
                    <!-- Card 1: Instance Booking -->
                    <div class="col-md-6">
                        <div class="card option-card" data-value="instance_booking" onclick="selectCard(this)">
                            <div class="card-body">
                                <h6 class="card-title text-center">Instance Booking</h6>
                    ...
                    <!-- Card 2: Fare Type -->
                    <div class="col-md-6">
                        <div class="card option-card" data-value="fare_type" onclick="selectCard(this)">
                            <div class="card-body">
                                <h6 class="card-title text-center">Fare Type</h6>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">Mileage</li>
                                    <li class="list-group-item">Hourly</li>
                                    <li class="list-group-item">Tariff</li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="instanceBookingModal" tabindex="-1" data-bs-backdrop="false">
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center" id="bookingOptions">
                <div class="row">
                    <div class="col-6">
                        <button class="btn btn-outline-primary option-btn w-100" onclick="showSubmit('bookingOptions', this)">Automation</button>
                    </div>
                    <div class="col-6">
                        <button class="btn btn-outline-primary option-btn w-100" onclick="showSubmit('bookingOptions', this)">Manual</button>
                    </div>
                </div>
                <div class="submit-section mt-4 d-none">
                    <button class="btn btn-success" onclick="submitFareChoice(this)">Submit</button>
                </div>
            </div>
...
<div class="modal fade" id="fareTypeOptionsModal" tabindex="-1" data-bs-backdrop="false">
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title">Choose Fare Type</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>

            <div class="modal-body text-center" id="fareTypeOptions">
                <div class="row">
                    <div class="col-4">
                        <button class="btn btn-outline-primary option-btn w-100" onclick="showSubmit('fareTypeOptions', this)">Mileage</button>
                    </div>
                    <div class="col-4">
                        <button class="btn btn-outline-primary option-btn w-100" onclick="showSubmit('fareTypeOptions', this)">Hourly</button>
                    </div>
                    <div class="col-4">
                        <button class="btn btn-outline-primary option-btn w-100" onclick="showSubmit('fareTypeOptions', this)">Tariff</button>
                    </div>
                </div>
                <div class="submit-section mt-4 d-none">
                    <button class="btn btn-success" onclick="submitFareChoice(this)">Submit</button>
