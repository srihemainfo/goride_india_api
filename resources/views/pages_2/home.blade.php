    ...
    <div class="row">
      ...
      <div class="col-lg-5 offset-lg-1 col-md-12">
        <div class="item " data-aos="fade-down" data-aos-duration="1000"> <img
            src="{{ asset('goride/img/indian-about.jpg') }}" class="img-fluid" alt="about">
      ...
      <div class="col-md-12">
        <div class="owl-carousel owl-theme">
          <div class="item">
            ...
            <div class="text ">
              <p class="fw-normal">Goride Run Private Limited's incredible customer support made integrating the Dispatch Taxi
          ...
          <div class="item">
            ...
            <div class="text">
              <p class="fw-normal">Using Goride Run Private Limited's Dispatch Taxi System, our operations transformed with
          ...
          <div class="item">
            ...
            <div class="text">
              <p class="fw-normal">Goride Run Private Limited’s system brought significant improvements to Go Ride, offering
