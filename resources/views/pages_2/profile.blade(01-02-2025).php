...
@media (max-width: 768px) {
  .modal-dialog {
    width: 90%; /* Takes up 90% of the screen width on mobile */
...
@media (min-width: 769px) {
  .modal-dialog {
    width: 400px; /* Set fixed width for desktops */
  }
}
.modal-top-right {
  position: fixed;
...
.animated-check {
  animation: check-animation 1s ease-out;
}
</style>
@endsection
...
<section class="login_dashboard_section" id="main-dashboard-wrapper">
    ...
    <!-- <input id="password-field" type="password" placeholder="Enter Password" class="form-control" name="password-field" maxlength="15"> -->
    <!-- <span class="input-group-text"style="height: 43px;">
        <i class="fa fa-eye" id="togglePassword" style="cursor: pointer;"></i>
                ...
                <button type="submit" class="btn btn-primary btn-login" data-bs-toggle="modal" data-bs-target="#updated">Update</button>
                </div>
                <div class="modal fade" id="updated" tabindex="-1" aria-labelledby="updatedLabel" aria-hidden="true">
        <div class="modal-dialog modal-top-right">
            <div class="modal-content">
                <div class="modal-body text-center">
                <i class="fas fa-check-circle text-success fa-3x animated-check mt-3"></i>
...
<script>
 ...
 <script>
        document.addEventListener("DOMContentLoaded", function () {
            let updatedModal = document.getElementById("updated");

            updatedModal.addEventListener("shown.bs.modal", function () {
                setTimeout(function () {
                    let modalInstance = bootstrap.Modal.getInstance(updatedModal);
                    modalInstance.hide();
                }, 1000); // 1 second delay
            });
        });
