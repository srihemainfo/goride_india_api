                                        ...
                                        <div class="card filter shadow-sm border-0 rounded-3">
                                            ...
                                            <div class="card-body p-3">
                                                ...
                                                <div class="mb-4">
                                                 ...
                                                 <div class="mb-4">
                                                    <label for="filterPassengerCount"
                                                        class="form-label fw-bold small mb-2 text-dark">
                                                        PassengerCount: <span id="PassengerCountMobile">0 - 10000+</span>
                                                    </label>
                                                    <input type="range" class="form-range custom-range-warning"
                                                        id="filterPassengerCount" min="0" max="10000" step="100"
                                                        value="10000">
                                                </div>
                                                <div class="d-flex align-items-center justify-content-center"><button class="btn btn-sm text-white bg-primary  py-1" id="saveFiltersBtn">
...
<div class="col-12 d-md-flex justify-content-md-between align-items-center flex-md-wrap align-items-end">
                                                            ...
                                                            <span class="d-inline-flex align-items-center gap-1 date-time">
                                                                <i class="fa-solid fa-plane-arrival text-danger"></i>
                                                                    ...
                                                                    <button class="btn btn-sm btn-warning ms-auto agreeBtn " onclick="bidManage('23', this)"><i class="fas fa-gavel me-2"></i> Manage Bid</button>
...
<div class="modal fade" id="userModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered"
        ...
        <div class="dropdown flex-fill">
          <a class="text-danger text-decoration-underline d-flex align-items-center justify-content-center w-100" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
...
<div class="modal fade" id="postedModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content w-100 p-3 position-relative">
      ...
      <button type="button" class="btn-close ms-auto custom-close"
        data-bs-dismiss="modal" aria-label="Close"></button>
...
<div class="modal fade" id="rejectConfirmModal" tabindex="-1" aria-labelledby="rejectConfirmModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl ">
      ...
      You can reject this bid <strong class="fw-bold">only once</strong>. If you reject again, you will need to <strong class="fw-bold">cancel the job</strong>.
  </div>
            </div>
