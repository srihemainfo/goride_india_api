                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <ul class="nav nav-tabs card-header-tabs w-100 flex-wrap flex-sm-nowrap" id="jobTabs"
                            ...
                            <li class="nav-item d-sm-none flex-fill" role="presentation">
                                <button class="nav-link rounded-pill text-center py-2" id="available-tab"
                                    data-bs-toggle="tab" data-bs-target="#available" type="button" role="tab"
                                    aria-selected="false" onclick="openJobs()">
                                    Open Jobs
                                </button>
                            </li>
                            <li class="nav-item d-sm-none flex-fill" role="presentation">
                                <button class="nav-link rounded-pill text-center py-2" id="created-tab"
                                    ...
                                    aria-selected="false" onclick="currentJobs()">
                                    My Jobs
                                </button>
                            </li>
                            <li class="nav-item d-sm-none flex-fill" role="presentation">
                                <button class="nav-link rounded-pill text-center py-2" id="bidding-tab"
                                    ...
                                    aria-selected="false" onclick="bidStatus()">
                                    Bidding Jobs
                                </button>
                            </li>
                            <li class="nav-item d-sm-none flex-fill" role="presentation">
                            ...
                            <li class="nav-item flex-shrink-0 d-none d-sm-block" role="presentation">
                                <button class="nav-link" id="available-tab-desktop" data-bs-toggle="tab"
...
<div class="offcanvas offcanvas-start d-md-none" tabindex="-1"
                                                                ...
                                                                <div class="p-3">
                                                                    ...
                                                                    <div class="trending-tags">
                                                                        <span class="badge go-ride-tag me-2 mb-2">
                                                                            <i
                                                                                class="fa-solid fa-circle-plus me-2"></i>Chennai
                                                                        </span>
                                                                        <span class="badge go-ride-tag me-2 mb-2">
                                                                            <i
                                                                        ...
                                                                        <span class="badge go-ride-tag me-2 mb-2">
                                                                            <i
                                                                                class="fa-solid fa-circle-plus me-2"></i>Mumbai
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                <div class="col-md-3 col-12 mb-4 mb-md-0 d-none d-md-block">
                                    <div class="card filter shadow-sm border-0 rounded-3">
                                        ...
                                        <div class="card-body p-3">
                                            ...
                                            <div class="mb-4">
                                                <label class="form-label fw-bold small mb-2 text-dark">
                                                    <i class="fa-solid fa-person-seat me-2 text-warning
    "></i>Seater Type
                                                </label>
                                                <div class="form-check mb-1">
                                                    <input class="form-check-input custom-checkbox-warning"
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                            ...
                                                            <div class="car-specs">
                                                                <div class="row">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            class="amount d-flex justify-content-center align-items-center">
                                                                            <span class="bids-c me-3">
                                                                                <i class="fas fa-gavel"></i> 15 Bids
                                                                            </span>₹3,800
                                                                            <span class="icon-report ms-5"
                                                    ...
                                                    <div
                                                        ...
                                                        <!-- Left: Posted Info -->
                                                        <div
                                                            class="d-flex align-items-center justify-content-center small text-muted gap-4 mb-2">
  ...
  <div class="col-12">
    <div class="bid-card d-flex flex-column justify-content-center align-items-center text-center p-4">
      ...
      <p class="mb-0 text-muted fw-bold">No bidders available</p>
    </div>
  </div>
</div>
                ...
                <form id="journeyForm" data-gtm-form-interact-id="0" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <small class="form-text text-muted mt-1">The actual marketed price is <span
                        ...
                        <div class="text-left estimated_fare py-0">
                            <p class="mb-0">
                                <strong>Estimated Fare
                                    (₹):</strong> <span id="pre_fare" class="fw-bold ms-2">1343</span></p>
                        </div>
                    </div>
                     <div class="row d-block d-md-none">
                        <div class="col-md-6 col-12 ">
                            ...
                            <p><i class="fas fa-map-marker-alt me-2 text-primary"></i><strong
                                    ...
                                    Maharashtra</span></p>
                                        <p><i class="fas fa-calendar-day me-2 text-primary"></i><strong
                                    class="fw-bold">Pickup Date/Time:</strong> <span id="pre_pick">15 May 2023, 10:00 AM</span>
                            </p>
                                  <p><i class="fas fa-calendar-day me-2 text-danger pre_drop_hide"></i><strong
                                    class="fw-bold pre_drop_hide">Drop Date/Time:</strong> <span id="pre_drop"
                                    class="pre_drop_hide">15 May 2023, 01:30 PM</span></p>
            ...
            <div class="modal-body">
                ...
                <div class="mt-3 border-top pt-3">
                    <p class="text-danger mb-1 bg-light fw-normal border w-100 rounded p-2">
                        <strong class="text-dark">Note:</strong> <span id="bidAmountDetails">This amount includes toll, parking, bata, and passenger fare.</span> 
                    </p>
                </div>
            </div>
        ...
        <div class="modal-content p-3">
            ...
            <div class="modal-footer d-flex justify-content-center gap-2 bg-white border-0 px-3 flex-nowrap">
                ...
                <div class="dropdown flex-fill">
                    <button
                        class="btn btn-outline-danger btn-sm w-100 dropdown-toggle d-flex align-items-center justify-content-center"
                ...
                <!-- Close Button -->
                <button type="button" class="btn btn-secondary close-button btn-sm flex-fill w-100"
...
<div class="modal fade " id="carModal2" tabindex="-1" style="display: none; padding-left: 0px;" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-xl">
            ...
            <div class="modal-body bg-light p-2 mt-3">
                ...
                <div class="mb-3 bg-white rounded-3 shadow-sm p-3  border border-warning border-opacity-25">
                    ...
                    <div class="row align-items-center">
                                ...
                                <div class="flex-grow-1 pt-md-1 w-100">
                                    ...
                                    <div class="d-flex flex-wrap gap-0 gap-md-3 text-dark small d-none d-md-block">
                                        ...
                                        <span class="fw-semibold d-block d-md-inline-block">
                                            <i class="fas fa-calendar text-warning me-1"></i><span class="j_time">Posted 3
                                                hours ago</span>
                                        </span>
                                    </div>
                        ...
                        <div class="col-lg-4 col-12 d-flex flex-column align-items-center justify-content-center  mt-lg-0 d-block d-md-none">
                           <div class="d-flex flex-wrap gap-3  text-dark small ">
                                        <span class="fw-semibold d-block d-md-inline-block mb-1 mb-md-0">
                                            <i class="fa fa-briefcase text-warning me-1"></i><span class="j_complete">0 Completed</span>
                                        </span>
                                        <span class="fw-semibold d-block d-md-inline-block">
                        ...
                        <div class="col-lg-4 d-flex flex-column align-items-center justify-content-center mt-3 mt-lg-0 d-none d-md-block">
        ...
        <div class="modal-content  w-100 p-3">
            <div class="modal-body bg-light p-2">
                ...
                <div class="mb-2">
                    ...
                    <textarea class="form-control border-warning fw-semibold" id="manageBidRemarks" rows="2" placeholder="Enter You Remarks"
                        disabled=""></textarea>
                </div>
            </div>
        ...
        <div class="modal-content w-100">
            ...
            <div class="modal-body bg-light p-2">
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group">
                        <span class="input-group-text bg-warning text-dark fw-bold border-warning">₹</span>
                        <input type="number" class="form-control border-warning fw-semibold" id="b_amount"
                            value="" min="0" style="border-left: none;" disabled="">
                    </div>
        ...
        <div class="modal-content w-100">
            ...
            <div class="modal-body bg-light p-2">
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group">
                        <span class="input-group-text bg-warning text-dark fw-bold border-warning">₹</span>
                        <input type="number" class="form-control border-warning fw-semibold" id="r_amount"
                            value="4200" min="0" style="border-left: none;" disabled="">
                    </div>
