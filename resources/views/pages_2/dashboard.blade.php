...
.calendly-badge-widget:before {
 ...
 .calendly-badge-widget {
    ...
    color: #6362e7;
       ...
       .profile-greeting .greeting-user .btn.open-jobs {
           border:none;
      background: #f9bf00;
    color: #323232;
        display: -webkit-box;
                        ...
                        <div class="media">
                            <div class="media-body">
                                <div class="greeting-user">
                                    ...
                                    <a class="btn btn-outline-white_color" href="/pricing">Get Started<i class="fa-light fa-arrow-right"></i></a>
                                          <a class="btn btn-outline-white_color position-relative open-jobs"  href="/jobs">
                                          Open Jobs <i class="fa-solid fa-suitcase ms-2 text-primary">
                                          </i>
                ...
                <div class="card">
                    ...
                    @else
                        <div class="card-body text-center">
                            <p>No Purchases have done. Click here to <a href="/pricing"  class="ms-md-2 ms-0" style="    color: black;background: #f9bf00;width: 77px;height: 32px;font-weight: 400;border-radius: 10px;
    justify-content: center;
    align-items: center;">Buy now</a>
                            </p>
                        </div>
                    @endif
                </div>
