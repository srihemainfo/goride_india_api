...
/*-----------*/
  ...
  font-size: 14px;
    ...
    #agreedModal .modal-footer {
        ...
        #current  .compact-car-card {
                margin-left: -12px;
        }
         #liked  .compact-car-card {
                margin-left: -10px;
        }
...
<ul class="nav nav-tabs card-header-tabs w-100 flex-wrap flex-sm-nowrap" id="jobTabs" role="tablist">
    ...
    <li class="nav-item flex-shrink-0" role="presentation">
        <button class="nav-link active" id="available-tab" data-bs-toggle="tab" data-bs-target="#available" type="button" role="tab" aria-selected="true">
            Open Jobs
        </button>
    </li>
    <li class="nav-item flex-shrink-0" role="presentation">
        <button class="nav-link" id="created-tab" data-bs-toggle="tab" data-bs-target="#created" type="button" role="tab" aria-selected="false">
            My Jobs
        </button>
    </li>
    <li class="nav-item flex-shrink-0" role="presentation">
        <button class="nav-link" id="bidding-tab" data-bs-toggle="tab" data-bs-target="#bidding" type="button" role="tab" aria-selected="false">
            Bidding Jobs
        </button>
    </li>
    ...
    <!-- Second Row Centered Items -->
    <li class="nav-item d-sm-none w-100 d-flex justify-content-center gap-2 mt-2 mb-2" role="presentation">
        <button class="nav-link p-2 border-0 bg-transparent icon-report" id="liked-tab" data-bs-toggle="tab" data-bs-target="#liked" type="button" role="tab" aria-selected="false">
            Liked Jobs <i class="fa fa-heart text-danger"></i>
        </button>
        <button class="btn btn-sm view-btn d-flex align-items-center gap-1" style="font-size: 14px;" data-bs-toggle="modal" data-bs-target="#createJobModal">
            <i class="fa-solid fa-square-plus"></i> Create Job
        </button>
    </li>

    <!-- Keep them in original place for larger screens -->
    <li class="nav-item ms-auto d-none d-sm-block" role="presentation">
        <button class="nav-link p-2 border-0 bg-transparent icon-report" id="liked-tab-desktop" data-bs-toggle="tab" data-bs-target="#liked" type="button" role="tab" aria-selected="false">
            Liked Jobs <i class="fa fa-heart text-danger"></i>
        </button>
    </li>
    ...
    <div class="d-flex justify-content-center">
        ...
        <button class="btn btn-sm btn-link text-muted p-0" id="saveFiltersBtn">
            <i class="fas fa-save me-1"></i>Save
                                ...
                                <!-- Job Cards Column -->
                                <div class="col-md-9 col-12" id="openJobs_cards">
   ...
   <div href="tel:+919999999999" class="icon-circle bg-primary text-white me-2" title="Call">
                                                    ...
                                                    <div class="col-md-12 col-12">
                                                        <div class="company-info">
                                                            <div class="car-specs">
                                                                <div class="row">
                                                                    <div
                                                                        class="col-md-6 col-12 d-flex align-items-end justify-content-end gap-3">
                                                                        <span class="passenger-count">
                                                                            <i class="fas fa-users"></i> 5
                                                                        </span>
                                                                        <span class="distance">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="amount-des">
                                                                            <i class="fas fa-bullhorn"></i> <small>
                                                                                Toll, parking passenger to pay and bata
                                                                                included</small>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6 col-12 d-flex align-items-center gap-3">
                                                                        ...
                                                                        <span class="distance d-flex align-items-center gap-1">
                                                                            <i class="fas fa-route"></i> 29 km
                                                                        </span>
                                                    
                                                                        <!-- Heart icon pushed to end -->
                                                                          <span class="icon-report ms-auto d-md-none" onclick="toggleLike(this)" style="cursor:pointer;">
            <i class="fa fa-heart"></i>
        </span>
                                                                    </div>
                                                    
                                                                    <!-- Right: Amount & Description -->
                                                                   <div class="col-md-6 col-12 d-flex flex-column align-items-md-end align-items-start text-md-end text-start">
                                                        <div class="amount d-flex justify-content-md-end justify-content-center align-items-center">
                                                            <span class="bids-c me-3">
                                                                <i class="fas fa-gavel"></i> 15 Bids
                                                            </span>₹ 123
                                                                                                     <span class="icon-report ms-2 d-none d-md-inline" onclick="toggleLike(this)" style="cursor:pointer;">
                <i class="fa fa-heart"></i>
            </span>
                                                        </div>
                                                        ...
                                                        <div class="amount-des">
                                                            <i class="fas fa-bullhorn"></i>
                                                            <small>Toll Inc., Parking Inc., Bata PTP</small>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="route-section">
                                                                ...
                                                                <div class="route-arrow">
                                                                    <div class="arrow-line">
                                                                        ...
                                                                        <div class="arrow-container">
                                                                            <div class="long-arrow"></div>
                                                                            <i class="fas fa-car car-icon" style="transform: scale(1); color: rgb(0, 123, 255);"></i>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="location-time">
    ...
    <div class="d-md-flex d-inline-block align-items-center justify-content-center small text-muted gap-4 mb-2 d-none d-md-block">
        <span class="d-flex align-items-center gap-1">
            <i class="fa-solid fa-badge-check text-success"></i>
            Posted by
            <strong class="fw-bold" style="cursor:pointer; text-decoration: underline;" data-bs-toggle="modal" data-bs-target="#userModal">
                Elavarasan
            </strong>
        </span>
    </div>
    ...
    <div class="d-md-flex d-inline-block align-items-center justify-content-center gap-3 mb-2 d-none d-md-block">
        <span class="text-form">
            <i class="fas fa-hourglass-end text-danger hourglass-rotate"></i>
            Expiry in 0 days and 23 hours
        </span>
    </div>
 <!-- Mobile View: Posted and Expiry in one line -->
    <div class="d-flex justify-content-between align-items-center w-100 small text-muted mt-2 d-md-none">
        <span class="d-flex align-items-center gap-1">
            <i class="fa-solid fa-badge-check text-success"></i>
            Posted by
            <strong class="fw-bold" style="cursor:pointer; text-decoration: underline;" data-bs-toggle="modal" data-bs-target="#userModal">
    ...
    <!-- Right: Action Buttons -->
    <div class="text-end" id="actionSection">
        <button class="btn btn-sm btn-success ms-auto agreeBtn" data-bs-toggle="modal" data-bs-target="#agreedModal">
            <i class="fas fa-thumbs-up me-1"></i> Agree
        </button>

        <div class="small text-muted mt-2 place-bid-section">
            Need to increase amount?
            <a href="#" class="text-primary fw-semibold text-decoration-none" data-bs-toggle="modal" data-bs-target="#carModal2" onclick="bidCreate('Elavarasan', 'Your Company', '919585769163', 'null', '0','9')">
                Place bid
            </a>
        </div>
    </div>
                ...
                <div class="summary-section p-3 bg-light rounded" style="width: auto !important;">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            ...
                            <p><i class="fas fa-map-marker-alt me-2 text-primary"></i><strong class="fw-bold">From:</strong> <span id="pre_from2">Mumbai, Maharashtra</span></p>
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <p><i class="fas fa-map-marker-alt me-2 text-danger"></i><strong class="fw-bold">To:</strong> <span id="pre_to2">Pune, Maharashtra</span></p>
                              <p><i class="fas fa-check-circle me-2 text-primary"></i><strong class="fw-bold">Additional Charges:</strong> <span id="pre_included">Bata, Toll, Parking</span></p>
...
<div class="modal fade" id="agreedModal" tabindex="-1" aria-labelledby="agreedModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content w-100 p-4 rounded-4 text-center">

            <!-- Header -->
            <div class="modal-header border-0 pb-0">
                <h5 class="modal-title fw-bold" id="agreedModalLabel">
                    <i class="fas fa-check-circle text-success me-2"></i> Confirm Bid
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="mt-3 border-top pt-3">
                    <p class="text-muted mb-1">
                        🚗 <strong>Note:</strong> This amount includes toll, parking, bata, and passenger fare.
                    </p>
