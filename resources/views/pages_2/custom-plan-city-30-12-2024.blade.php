                ...
                <div class="col-10">
                    <ul class="accordion-box clearfix">
                        <li class="accordion block">
                            <div class="acc-btn"><span class="count">1.</span> What is Taxi Cab Dispatch Software?</div>
                            <div class="acc-content" style="display: none;">
                                <div class="content">
                                    <div class="text">Taxi cab dispatch software is a system designed to help manage and
                                        streamline the operation of taxi services. For example, in
                                        {{(isset($seoTags['cityName']) ? ucfirst(strtolower($seoTags['cityName'])) : '')}},
                                        the software enables taxi companies to handle ride requests, track vehicles, and
                                        process payments, all in real-time. It connects drivers, passengers, and
                                        dispatchers, ensuring efficient and smooth operations.
                                    </div>
                                </div>
                            </div>
                        </li>
