...
@keyframes blinkColor {
  ...
  <section class="page-header" 
    style="background-image: url('{{ request()->is('agency') ? asset('goride/img/handshake.webp') : asset('goride/img/breadcrump_banner.webp') }}');">
        <div class="page-header-shape"></div>
        <div class="container">
            <div class="page-header-info">
                <h4>GoRide My Riders App</h4>
  ...
  <div class="col-md-9 mb-4 mb-md-0">
    <div class="section-heading mb-40">
      <h4 class="wow fadeIn" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-name: fadeIn;"> <span></span>GoRide My Riders App</h4>
      ...
      <p class="wow fadeIn" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-name: fadeIn;">
        At GoRide, we believe in empowering drivers with the tools they need to succeed. Our AI-based dispatch software offers a powerful and intuitive My Riders App, specifically designed to enhance the efficiency and earnings of taxi drivers. Whether you’re an independent driver or part of a larger fleet, the GoRide My Riders App is your key to a seamless driving experience.
      </p>
    </div>
  </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="section-heading text-center mb-40">
                        <h2 class="wow fadeIn" data-wow-duration="2s">Why Choose the GoRide My Riders App?</h2>
                    </div>
                </div>
                ...
                <div class="col-md-4 d-flex my-1 wow fadeIn" data-wow-duration="2s" data-wow-delay="500ms">
                    <div class="key_features_card">
                        ...
                        <p>Integrated with cutting-edge GPS technology, the GoRide My Riders App provides real-time navigation and traffic updates. This means fewer delays and quicker routes, helping you provide a better service to your passengers.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4 d-flex my-1 wow fadeIn" data-wow-duration="2s" data-wow-delay="500ms">
                    <div class="key_features_card">
                        ...
                        <p>Say goodbye to payment hassles. GoRide’s My Riders App provides secure, transparent, and quick payment processing. Track your earnings in real time and receive detailed summaries of all your rides.</p>
                    </div>
                </div>
                <div class="col-md-4 d-flex my-1 wow fadeIn" data-wow-duration="2s" data-wow-delay="1000ms">
                    <div class="key_features_card">
    			...
    			<div class="col-md-6">
    				<div class="how-app-work-content-wrap">
    					<div class="title wow fadeIn" data-wow-duration="2s">
    						<h3>Get Started with GoRide My Riders App</h3>
    					</div>
    					<div class="how-app-work-content" id="how-app-work-slider-pager">
    						<a href="#" class="pager-item active wow fadeIn" data-wow-duration="2s" data-wow-delay="500ms">
    						    <div class="single-how-app-work ">
        							...
        							<div class="text-box">
        								<h4>Sign Up</h4>
        								<p>Download the GoRide My Riders App from the App Store or Google Play, and sign up with your details.</p>
        							</div>
        						</div>
    						</a>
