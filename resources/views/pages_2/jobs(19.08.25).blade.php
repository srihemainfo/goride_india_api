...
.job-empty-body button {
  min-width: 160px; /* keeps it neat even as small btn */
}
.job-list-wrapper {
  display: flex;
  flex-direction: column;
...
#mainLocationInput {
    border: 1px solid #ffc107; /* Bootstrap warning yellow */
...
@media screen and (max-width: 576px) {
    ...
    left: 50%;              
    transform: translateX(-50%);
    background: #fff;        /* same background as card */
    padding: 0 10px;
    font-size: 11px;
    font-weight: 600;
...
select.form-control {
    ...
    line-height: 1.2em;    /* tighter line spacing if wrapping */
}
...
.glassy-remarks {
  ...
  padding: 3px 15px;
  border-radius: 25px;
  max-width: 280px; /* adjust to fit within box */
  width: fit-content;
  margin-top: 8px;
...
<section class="login_dashboard_section" id="main-dashboard-wrapper">
    ...
    <div class="page-wrapper">
       <div class="mobile_menu_toggler d-flex justify-content-between">
            ...
            <h1 class="admin_name text-center mt-3 ms-5">Hello Suriya M</h1>
            <div class="fixed-profile p-2 mx-4 mb-1  rounded">
  <div class="btn-group" id="profile-bar">
    <!-- Profile picture + edit icon -->
    <a href="#" class="p-0" onclick="toggleDropdown(event)" style="cursor: pointer; position: relative; display: inline-block;">
        <img id="profile-pic" src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/profile/user-1.jpg" class="profile-pic rounded-circle mt-2" alt="profile-img" style="object-fit: cover;">
    ...
    <!-- Hidden file input -->
    <input type="file" id="profile-upload" accept="image/*" style="display:none;" onchange="previewProfilePic(event)">

    <!-- Dropdown -->
    <div tabindex="-1" role="menu" class="dropdown-menu dropdown-menu-right" id="profile-bar-box" style="display:none;">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class=" card profile-greeting d-none d-md-block">
                    <div class="card-body">
                        <div class="media">
  ...
  <ul class="nav nav-tabs card-header-tabs w-100 flex-wrap flex-sm-nowrap" id="jobTabs" role="tablist">

    <!-- Mobile: Create Job button on top -->
    <li class="nav-item w-100 d-sm-none mb-2" role="presentation">
      <button class="btn btn-sm view-btn w-100 d-flex justify-content-center align-items-center gap-1" 
  ...
  <button class="nav-link rounded-pill text-center" id="available-tab" 
          data-bs-toggle="tab" data-bs-target="#available" 
          type="button" role="tab" aria-selected="false">
    Open Jobs
  </button>
</li>
    <li class="nav-item d-sm-none flex-fill" role="presentation">
      <button class="nav-link rounded-pill text-center" id="created-tab" data-bs-toggle="tab" 
              data-bs-target="#created" type="button" role="tab" aria-selected="false">
        My Jobs
      </button>
    </li>
    <li class="nav-item d-sm-none flex-fill" role="presentation">
      <button class="nav-link rounded-pill text-center" id="bidding-tab" data-bs-toggle="tab" 
              data-bs-target="#bidding" type="button" role="tab" aria-selected="false">
        Bidding Jobs
      </button>
    </li>
    <li class="nav-item d-sm-none flex-fill" role="presentation">
      <button class="nav-link rounded-pill text-center" id="liked-tab" data-bs-toggle="tab" 
              data-bs-target="#liked" type="button" role="tab" aria-selected="false">
        Liked Jobs <i class="fa fa-heart text-danger"></i>
      </button>
    </li>
    <li class="nav-item d-sm-none d-flex align-items-center" role="presentation">
      
                                    <button class="btn btn-warning py-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#mobileFilterOffcanvas">
  ...
  <button class="nav-link" id="available-tab-desktop" 
          data-bs-toggle="tab" data-bs-target="#available" 
          type="button" role="tab" aria-selected="false">
    Open Jobs
  </button>
    ...
    <li class="nav-item ms-auto d-none d-sm-block" role="presentation">
      <button class="nav-link p-2 border-0 bg-transparent icon-report" id="liked-tab-desktop" 
              data-bs-toggle="tab" data-bs-target="#liked" type="button" role="tab" aria-selected="false">
        <i class="fa fa-heart text-danger"></i> Liked Jobs
      </button>
    </li>
    <li class="nav-item d-none d-sm-block" role="presentation">
      <button class="btn btn-sm view-btn d-flex align-items-center gap-1" 
              style="font-size: 14px;" 
              data-bs-toggle="modal" 
              data-bs-target="#createJobModal">
        <i class="fa-solid fa-square-plus"></i> Create Job
                            ...
                            <div class="row mb-4 mt-3">
                                <div class="col-12">
                                    <div class="search-container position-relative">
                                        <div class="input-group go-ride-search">
                                        ...
                                        <div class="search-dropdown position-absolute w-100 bg-white shadow-lg"
                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="trending-tags">
                                                    ...
                                                    <span class="badge go-ride-tag me-2 mb-2">
                                                        <i class="fas fa-chair me-1"></i> Seater
                                                    </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-12 mb-4 mb-md-0 d-none d-md-block">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button class="btn btn-sm btn-link text-muted p-0 me-3" id="resetFiltersBtn">
  ...
  <div class="position-relative">
    ...
    <input type="text" 
           class="form-control form-control-sm border-warning location-input text-center mb-2"
    ...
    <div class="search-dropdown position-absolute w-100 bg-white shadow-lg"
      ...
      <div class="p-3">
        <h6 class="popular-searches-title mb-3">Popular Locations</h6>
        <div class="trending-tags">
          <span class="badge go-ride-tag me-2 mb-2 location-option">
            ...
            <i class="fa-solid fa-circle-plus me-2"></i>Mumbai
                                            ...
                                            <div class="mb-4">
                                                <label for="filterDistance"
                                                    ...
                                                    <i class="fas fa-route text-warning me-2"></i>Distance Range: <span
                                                        id="distanceValue">0 - 1000 km+</span>
                                                </label>
                                                <input type="range" class="form-range custom-range-warning"
                                                    id="filterDistance" min="0" max="1000" step="10" value="1000">
                                            ...
                                            <div class="mb-4">
                                                <label for="filterAmount"
                                                    class="form-label fw-bold small mb-2 text-dark">
                                                    Amount Range:
                                                    <span id="amountValue">₹0 - ₹10000+</span>
                                                </label>
                                                <input type="range" class="form-range custom-range-warning"
                                                    id="filterAmount" min="0" max="10000" step="100" value="10000">
                                            ...
                                            <div class="mb-4">
                                                <label class="form-label fw-bold small mb-2 text-dark">
                                                    <i class="fas fa-chair text-warning me-2"></i>Seater Type
                                                </label>
                                                <div class="form-check mb-1">
                                                    <input class="form-check-input custom-checkbox-warning"
                                                        type="checkbox" value="4" id="seater4">
                                                    <label class="form-check-label small text-dark" for="seater4">
                                                        4 Seater
                                                    </label>
                                                </div>
                                                <div class="form-check mb-1">
                                                    <input class="form-check-input custom-checkbox-warning"
                                                        type="checkbox" value="8" id="seater8">
                                                    <label class="form-check-label small text-dark" for="seater8">
                                                        8 Seater
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input custom-checkbox-warning"
                                                        type="checkbox" value="12" id="seater12">
                                                    <label class="form-check-label small text-dark" for="seater12">
                                                        12 Seater
                                                    </label>
                                                </div>
                                            </div>

                                            <!-- Vehicle Type Filter (Added for completeness) -->
                                            <div class="mb-2">
                                                <label class="form-label fw-bold small mb-2 text-dark">
                                                ...
                                                <div class="form-check mb-1">
                                                    <input class="form-check-input custom-checkbox-warning"
                                                        type="checkbox" value="Sedan" id="vehicleSedan">
                                                    <label class="form-check-label small text-dark" for="vehicleSedan">
                                                        Sedan
                                                    </label>
                                                </div>
                                                <div class="form-check mb-1">
                                                    <input class="form-check-input custom-checkbox-warning"
                                                        type="checkbox" value="SUV" id="vehicleSUV">
                                                    <label class="form-check-label small text-dark" for="vehicleSUV">
                                                        SUV
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input custom-checkbox-warning"
                                                        type="checkbox" value="Tempo Traveller" id="vehicleTempo">
                                                    <label class="form-check-label small text-dark" for="vehicleTempo">
                                                        Tempo Traveller
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body p-3">
                                               ...
                                               <div class="mb-4 position-relative">
                                                ...
                                                <div id="locationFields">
                                                    <div class="position-relative">
                                                            <i class="fas fa-search position-absolute text-warning" style="left: 10px; top: 50%; transform: translateY(-50%); "></i>
                                                        <input type="text" class="form-control form-control-sm border-warning location-input text-center mb-2" placeholder="search" autocomplete="off" id="mainLocationInput">
                                                        <!-- Location Suggestions Dropdown -->
                                                        <div class="search-dropdown position-absolute w-100 bg-white shadow-lg" id="locationDropdown" style="display: none; top: 100%; z-index: 1000;">
                                                            <div class="p-3">
                                                ...
                                                <!-- Distance Range Filter -->
                                                <div class="mb-4">
                                                    <label for="filterDistanceMobile"
                                                        class="form-label fw-bold small mb-2 text-dark">
                                                        <i class="fas fa-route text-warning me-2"></i>Distance Range:
                                                        <span id="distanceValueMobile">0 - 1000 km+</span>
                                                    </label>
                                                    <input type="range" class="form-range custom-range-warning"
                                                        id="filterDistanceMobile" min="0" max="1000" step="10"
                                                        value="1000">
                                                </div>

                                                <!-- Amount Range Filter -->
                                                <div class="mb-4">
                                                    <label for="filterAmountMobile"
                                                        class="form-label fw-bold small mb-2 text-dark">
                                                        Amount Range: <span id="amountValueMobile">₹0 - ₹10000+</span>
                                                    </label>
                                                    <input type="range" class="form-range custom-range-warning"
                                                        id="filterAmountMobile" min="0" max="10000" step="100"
                                                        value="10000">
                                                </div>
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="form-check mb-1">
                                                        <input class="form-check-input custom-checkbox-warning"
                                                            type="checkbox" value="4" id="seater4Mobile">
                                                        <label class="form-check-label small text-dark"
                                                            for="seater4Mobile">4 Seater</label>
                                                    </div>
                                                    <div class="form-check mb-1">
                                                        <input class="form-check-input custom-checkbox-warning"
                                                            type="checkbox" value="8" id="seater8Mobile">
                                                        <label class="form-check-label small text-dark"
                                                            for="seater8Mobile">8 Seater</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input custom-checkbox-warning"
                                                            type="checkbox" value="12" id="seater12Mobile">
                                                        <label class="form-check-label small text-dark"
                                                            for="seater12Mobile">12 Seater</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <div class="form-check mb-1">
                                                        <input class="form-check-input custom-checkbox-warning"
                                                            type="checkbox" value="Sedan" id="vehicleSedanMobile">
                                                        <label class="form-check-label small text-dark"
                                                            for="vehicleSedanMobile">Sedan</label>
                                                    </div>
                                                    <div class="form-check mb-1">
                                                        <input class="form-check-input custom-checkbox-warning"
                                                            type="checkbox" value="SUV" id="vehicleSUVMobile">
                                                        <label class="form-check-label small text-dark"
                                                            for="vehicleSUVMobile">SUV</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input custom-checkbox-warning"
                                                            type="checkbox" value="Tempo Traveller"
                                                            id="vehicleTempoMobile">
                                                        <label class="form-check-label small text-dark"
                                                            for="vehicleTempoMobile">Tempo Traveller</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div
                                                                       ...
                                                                       <div class="amount d-flex justify-content-center align-items-center">
                                                                            <span class="bids-c me-3">
                                                                                <i class="fas fa-gavel"></i> 15 Bids
                                                                            </span>₹3,800
                                                                            <span class="icon-report ms-5" onclick="toggleLike(this)">
                                                                            <i class="fa fa-heart"></i>
                                                                        </span>
                                                                          </div>
                                                                        <div class="amount-des">
                                                                            <i class="fas fa-bullhorn"></i>
                                                                            <small>Toll, parking passenger to pay and
                                                                                bata included</small>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <!-- Left: Posted Info -->
                                                      <div class="d-flex align-items-center justify-content-center small text-muted gap-4 mb-2">
                                                            <span class="d-flex align-items-center gap-1">
                                                                    <i class="fa-solid fa-badge-check text-success"></i>
                                                                    Posted by
                                                                
                                                                    <!-- John Doe - opens user modal -->
                                                                    <strong class="fw-bold" style="cursor:pointer; text-decoration: underline;" data-bs-toggle="modal" data-bs-target="#postedModal">
                                                                        John Doe
                                                                    </strong>
                                                                
                                                                    <!--<div class="dropdown flag-container position-relative d-inline-block" style="z-index: 1050;">-->
                                                                    <!--    <span class="fw-bold" style="cursor: pointer;" onclick="toggleFlagOptionss(this)">-->
                                                                    <!--        <i class="fa fa-flag text-danger ms-1" id="redflag"></i>-->
                                                                    <!--    </span>-->
                                                                    
                                                                    <!--    <div class="dropdown-menu animate-slide-in custom-flag-popup">-->
                                                                    <!--        <button class="dropdown-item btn-block-user">-->
                                                                    <!--            <i class="fas fa-exclamation-circle"></i> Block-->
                                                                    <!--        </button>-->
                                                                    <!--        <button class="dropdown-item btn-report-spam">-->
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-center gap-3 mb-2">
                                                          <span class="text-form">
                                                                ...
                                                                Expiry in 2 days and 15 hours
                                                            </span>

                                                            <div>
<!--                                                               <span class="icon-report" onclick="toggleLike(this)">-->
<!--    <i class="fa fa-heart"></i>-->
<!--</span>-->
                                                        ...
                                                        <!-- Right: Agree & Place Bid -->
                                                        <!-- Right: Agree + Place Bid -->
                                                        <!-- Right: Action Buttons -->

                                                        <div class="text-end" id="actionSection">
                                                            <!-- Change both id="agreeBtn" to class="agreeBtn" -->
...
<!--<div class="dropdown flag-container position-relative d-inline-block">-->
<!--    <span class="fw-bold" style="cursor: pointer;" onclick="toggleFlagOptionss(this)">-->
<!--        <i class="fa fa-flag text-danger ms-1" id="redflag"></i>-->
<!--    </span>-->
...
">
                                                            <div class="dropdown sort-dropdown  text-end">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="sortMenuButton">
                                                                    ...
                                                                    <li><a class="dropdown-item" href="#" onclick="sortCards('priceLow', this)" data-label="Price - Low to High">Price - Low
                                                                            to High</a></li>
                                                                    <li><a class="dropdown-item" href="#" onclick="sortCards('priceHigh', this)" data-label="Price - High to Low">Price -
                                                                            High to Low</a></li>
        ...
        <div class="d-flex justify-content-center gap-3">
          ...
          <div class="driver-info">
            <div class="amount-bid">₹100</div>
             ...
             <div class="bid-actions" id="actions-1">
                                                                      <button class="btn btn-success p-2 btn-sm accept-btn" onclick="showAcceptConfirmation(1)" title="Accept">
    <i class="fa-solid fa-check"></i> </button>
                                                            ...
                                                            <div class="car-specs">
                                                                <div class="row mt-3">
                                                                    ...
                                                                    <div class="col-md-6 col-7 d-flex align-items-center gap-1">
                                                                        ...
                                                                        <span class="passenger-count d-flex align-items-center gap-1 ms-5">
                                                                   ...
                                                                   <div class="col-md-6 col-5 d-flex justify-content-end align-items-end">
                                            ...
                                            <div class="trip-info">
                                                            <div class="route-section m-3 p-1">
                                                                <div class="location-time">
                                                                    ...
                                                                    <div class="location" onclick="toggleAddress(this)">Kallakurichi New bus stand, Tamil Nadu, India - 606213</div>
                                                                </div>
                                                                <div class="route-arrow">
                                                                
                                                                    <div class="arrow-line">
                                                                        <span class="oneway-label d-none d-md-block">ONE WAY</span>
                                                                        <div class="arrow-container">
                                                                ...
                                                                <div class="location-time">
                                                                    ...
                                                                    <div class="location " onclick="toggleAddress(this)">Perambur Bus Terminus, Perambur High Road, Chinnaiyan Colony, Perambur, Chennai, Tamil Nadu, India - 600012</div>
                                                                </div>
                                            ...
                                            <div class="trip-info">
                                                  ...
                                                  <div class="col-12 d-md-flex justify-content-md-between align-items-center flex-md-wrap align-items-end">
                                                                ...
                                                                <div class=" small text-muted mt-2 position-relative d-md-none" style="border-top: 2px solid #ddd;">
                                                                 <span class="oneway-label">ONE WAY</span>
                                                            ...
                                                            <span class="d-inline-flex align-items-center gap-1 date-time">
                                                                    ...
                                                                    <span class="d-flex align-items-center gap-1">
                                                                        ...
                                                                        <span class="ms-auto" id="actionSection">
                                                                              <button class="btn btn-sm btn-warning ms-auto agreeBtn " onclick="bidManage('18')">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0 shadow">
      ...
      <div class="modal-body px-4 py-3 text-secondary" style="line-height: 1.6;">
        Available immediately, prefers routes with less traffic, comfortable with night drives, and has experience in long-distance delivery.
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-dialog modal-lg  modal-dialog-centered">
        <div class="modal-content w-100 p-3">
            ...
            <div class="modal-body p-2">
                <form id="journeyForm" data-gtm-form-interact-id="0" enctype="multipart/form-data" onsubmit="journeyForm(event)">

                    <!-- Journey Type -->
                    <div class="d-flex align-items-center flex-nowrap overflow-auto gap-2 ms-2">
                        <div class="form-check mb-0">
                            <input class="form-check-input mt-2" type="radio" name="job_type" id="oneWay" value="oneway" checked>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <input type="number" id="passengerCount" name="pass_count" class="form-control p-1"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <input type="text" id="marketedPrice" name="fare" class="form-control p-1" placeholder="Enter the estimated fare">
                            <small class="form-text text-muted mt-1">The actual marketed price is <span id="approx_fare">₹1500</span>.</small>
                        </div>

                        <!-- Distance -->
                        <div class="col-md-4 col-12">
                            <label class="fw-bold">Distance (KM)</label>
                            <input type="number" id="distance" name="distance" class="form-control p-1" placeholder="Enter Distance">
                        </div>
                    </div>
                    <!-- Additional Charges -->
                    <div class="mb-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <div class="mt-2 d-flex flex-column">
                                    <div class="form-check">
                                        <input class="form-check-input mt-2" type="radio" id="bataIncluded" name="bataRadio" value="Included" checked>
                                        <label class="form-check-label" for="bataIncluded">Included</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input mt-2" type="radio" id="bataClient" name="bataRadio" value="Passenger to pay">
                            ...
                            <div class="col-md-4 col-12">
                                ...
                                <div class="mt-2 d-flex flex-column">
                                    <div class="form-check">
                                        <input class="form-check-input mt-2" type="radio" id="tollIncluded" name="tollRadio" value="Included" checked>
                                        <label class="form-check-label" for="tollIncluded">Included</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input mt-2" type="radio" id="tollClient" name="tollRadio" value="Passenger to pay">
                           ...
                           <div class="col-md-4 col-12">
                                ...
                                <div class="mt-2 d-flex flex-column">
                                    <div class="form-check me-2">
                                        <input class="form-check-input mt-2" type="radio" id="parkingIncluded" name="parkingRadio" value="Included" checked>
                                        <label class="form-check-label" for="parkingIncluded">Included</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input mt-2" type="radio" id="parkingClient" name="parkingRadio" value="Passenger to pay">
                    ...
                    <div>
                        ...
                        <textarea class="form-control p-1" rows="2" placeholder="Enter remarks..." name="job_remark"></textarea>
                    </div>
                    ...
                    <div class="text-center d-flex justify-content-center">
                        ...
                        <button type="submit" class="btn view-btn " id="job_submit-btn" style="padding:4px 16px";>Post Job</button>
        ...
        <div class="modal-content w-100 p-3">
            ...
            <div class="modal-body" id="previewContent">
                ...
                <div class="summary-section p-3 bg-light rounded" style="width: auto !important;">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <p><i class="fas fa-calendar-day me-2 text-primary"></i><strong class="fw-bold">Pickup:</strong> <span id="pre_pick">15 May 2023, 10:00 AM</span></p>
                            <p><i class="fas fa-map-marker-alt me-2 text-primary"></i><strong class="fw-bold">From:</strong> <span id="pre_from2" onclick="toggleAddress(this)">Mumbai, Maharashtra</span></p>
                            <p><i class="fas fa-user-friends me-2 text-success"></i><strong class="fw-bold">Passenger Count:</strong> <span id="pre_pass">12</span></p>
                           <p><i class="fas fa-ruler-horizontal me-2 text-info"></i><strong class="fw-bold">Distance (KM):</strong> <span id="pre_dis">391</span></p>
                        </div>
                        <div class="col-md-6 col-12">
                            <p ><i class="fas fa-calendar-day me-2 text-danger pre_drop_hide" ></i><strong class="fw-bold pre_drop_hide">Drop:</strong> <span id="pre_drop" class="pre_drop_hide">15 May 2023, 01:30 PM</span></p>
                            <p><i class="fas fa-map-marker-alt me-2 text-danger"></i><strong class="fw-bold">To:</strong> <span id="pre_to2" onclick="toggleAddress(this)">Pune, Maharashtra</span></p>
                            <p class="my-0">
...
<ul class="mb-0 ps-4">
  ...
  <li>Parking</li>
                        ...
                        <div class="text-center">
                             <p><i class="fas fa-rupee-sign me-2 text-warning"></i><strong class="fw-bold">Estimated Fare (₹):</strong> <span id="pre_fare">1343</span></p>
                            </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="agreedModal" tabindex="-1" aria-labelledby="agreedModalLabel" aria-hidden="true">
    ...
    <button type="button" class="btn-close position-absolute top-0 end-0 p-2 m-1" 
    ...
    <div class="modal-body">
        ...
        <div class="mt-3 border-top pt-3">
            <p class="text-danger mb-1 bg-light fw-normal border w-100 rounded p-2">
                <strong class="text-dark">Note:</strong> This amount includes toll, parking, bata, and passenger fare.
            </p>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg position-relative">
            <div class="modal-header p-3  text-white">
             ...
             <button type="button" class="btn-close position-absolute" style="top: 15px; right: 15px;" data-bs-dismiss="modal" aria-label="Close">
</button>
            </div>
...
<div class="modal fade" id="userModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-md modal-dialog-centered" style="animation: 0.3s ease-out 0s 1 normal none running modalSlideIn;">
    <div class="modal-content p-3">
      ...
      <!-- Footer -->
   <!-- Modal Footer -->
<div class="modal-footer d-flex justify-content-center gap-2 bg-white border-0 px-3 flex-nowrap">

  <!-- Report Dropdown -->
  <div class="dropdown flex-fill">
    <button class="btn btn-outline-danger btn-sm w-100 dropdown-toggle d-flex align-items-center justify-content-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
  ...
  <!-- Close Button -->
  <button type="button" class="btn btn-secondary btn-sm flex-fill w-100" data-bs-dismiss="modal">
    Close
  </button>
</div>
        ...
        <div class="mb-3 bg-white rounded-3 shadow-sm p-3 border border-warning border-opacity-25">
          ...
          <div class="pt-3">
            ...
            <div class="d-flex flex-column text-dark small text-center gap-1">
              ...
              <span class="fw-semibold">
                <i class="fa fa-briefcase text-warning me-1"></i> 15 jobs posted
              </span>
            </div>
          </div>
        </div>
...
<button type="button" class="btn-close position-absolute btn-sm top-0 end-0 m-3" data-bs-dismiss="modal" aria-label="Close"></button>


                    <div class="row align-items-center">
    <!-- Profile Section - col-8 -->
    <div class="col-lg-8  col-12 d-flex align-items-start">
      <div class="d-flex align-items-start flex-grow-1 flex-column flex-md-row">
    ...
    <div class="position-relative me-md-3 mb-3 mb-md-0 text-center text-lg-start">
        ...
        <span class="position-absolute d-none d-md-block bottom-0 end-0 bg-success rounded-circle border-2 border-white" 
    ...
    <div class="flex-grow-1 pt-md-1 w-100">
        <div class="d-flex align-items-center mb-1 flex-wrap">
            <h6 class="mb-0 fw-bold text-dark me-2" id="j_name">Rajesh Kumar</h6>
            <span class="badge rounded-pill bg-success small">
                <i class="fas fa-check-circle me-1"></i>Verified
            </span>
        </div>
        ...
        <div class="d-flex flex-wrap gap-2 text-dark small mb-2">
            <span class="fw-semibold d-block d-md-inline-block mb-1 mb-md-0">
                <i class="fas fa-building text-warning me-1"></i><span id="j_company">Sri Hematech Info Solutions</span>
            </span>
            <span class="fw-semibold d-none mb-1 mb-md-0">
                <i class="fas fa-map-marker-alt text-warning me-1"></i><span>Perambur, Chennai</span>
            </span>
            <span class="d-block d-md-inline-block">
                <i class="fas fa-star text-warning me-1"></i>
                <span class="fw-semibold" id="j_rate">4.7</span>
            </span>
        </div>
        ...
        <div class="d-flex flex-wrap gap-3 text-dark small">
            <span class="fw-semibold d-block d-md-inline-block mb-1 mb-md-0">
                <i class="fa fa-briefcase text-warning me-1"></i><span id="j_complete">15 jobs completed</span>
            </span>
            <span class="fw-semibold d-block d-md-inline-block">
                <i class="fas fa-calendar text-warning me-1"></i><span id="j_time">Posted 3 hours ago</span>
            </span>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-4 d-flex flex-column align-items-center justify-content-center mt-3 mt-lg-0 ">
        ...
        <small class="text-muted text-center">You can contact only if the bid is accepted</small>
             ...
             <div class="mb-2">
                 <div class="row">
                       <div class="col-6">
                            <p class="my-0"><i class="fas fa-map-marker-alt me-2 text-primary"></i><strong class="fw-bold">From:</strong> <span id="pre_from4" onclick="toggleAddress(this)">Perungalathur Bus Stand, Tambaram Corporation, Grand Southern Trunk Road, Otteri Extension, Kamaraj Nagar, New Perungalathur, Chennai, Tamil Nadu, India - 600063</span></p>
                           </div>
                            <div class="col-6">
                                 <p class="my-0"><i class="fas fa-map-marker-alt me-2 text-danger"></i><strong class="fw-bold">To:</strong> <span id="pre_to4" onclick="toggleAddress(this)">Perambur Bus Terminus, Perambur High Road, Chinnaiyan Colony, Perambur, Chennai, Tamil Nadu, India - 600012</span></p>
                           </div>
                           <div class="col-12">
    ...
    <p class="title-mobile d-flex justify-content-center align-items-center fw-bold">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control border-warning fw-semibold" id="bidAmount" placeholder="e.g., 4200" min="0" style="border-left: none;">
                    </div>
                ...
                <div class="mb-2">
                    ...
                    <textarea class="form-control border-warning fw-semibold" id="bidRemarks" rows="2" placeholder="Any special notes or conditions..."></textarea>
                </div>
            </div>

            <!-- Footer with action buttons -->
           <div class="modal-footer bg-white border-0 pt-0 d-flex flex-row gap-2 justify-content-center justify-content-sm-end align-items-center">
    <button type="button" class="btn btn-warning text-dark fw-bold px-4 shadow-sm" id="placeBid_btn" onclick="placeBid('10')">
...
<button type="button" class="btn-close position-absolute btn-sm top-0 end-0 m-3" data-bs-dismiss="modal" aria-label="Close"></button>
    ...
    <!-- Action Buttons - col-4 -->
    <div class="col-lg-4 col-12 d-flex flex-column align-items-center justify-content-center mt-3 mt-lg-0 ">
        <div class="d-flex gap-2 mb-2">
            <button type="button" class="btn btn-warning text-dark btn-sm px-3 py-1" disabled="">
                <i class="fas fa-comments me-1"></i>
            </button>
        ...
        <small class="text-muted text-center">You can contact only if the bid is accepted</small>
               ...
               <div class="mb-2">
                   <div class="row">
                       <div class="col-6">
                            <p class="my-0"><i class="fas fa-map-marker-alt me-2 text-primary"></i><strong class="fw-bold">From:</strong> <span id="pre_from3" onclick="toggleAddress(this)">Perungalathur Bus Stand, Tambaram Corporation, Grand Southern Trunk Road, Otteri Extension, Kamaraj Nagar, New Perungalathur, Chennai, Tamil Nadu, India - 600063</span></p>
                           </div>
                            <div class="col-6">
                                 <p class="my-0"><i class="fas fa-map-marker-alt me-2 text-danger"></i><strong class="fw-bold">To:</strong> <span id="pre_to3" onclick="toggleAddress(this)">Perambur Bus Terminus, Perambur High Road, Chinnaiyan Colony, Perambur, Chennai, Tamil Nadu, India - 600012</span></p>
                           </div>
                           <div class="col-12">
                               <div class="d-flex justify-content-between mt-3 ">
                                                            <!-- Pickup with icon -->
    ...
    <p class="title-mobile d-flex justify-content-center align-items-center fw-bold">
                 ...
                 Manage Your Bid
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <div>
                            ...
                            <!--    <i class="fas fa-save"></i>-->
                            <!--</button>-->
                            <button id="editManageBidAmountBtn" class="btn btn-sm btn-outline-warning" onclick="enableBidEdit('manageBidAmount', 'editManageBidAmountBtn', 'saveManageBidAmountBtn')">
                                <i class="fas fa-edit"></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        <span class="input-group-text bg-warning text-dark fw-bold border-warning">₹</span>
                        <input type="number" class="form-control border-warning fw-semibold" id="manageBidAmount" value="4200" min="0" style="border-left: none;" disabled="">
                    </div>
                ...
                <div class="mb-2">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <div>
                            <button id="saveManageBidRemarksBtn" class="btn btn-sm btn-warning me-1 d-none" onclick="saveBidField('manageBidRemarks', 'editManageBidRemarksBtn', 'saveManageBidRemarksBtn', 'Bid remarks')">
                                <i class="fas fa-save"></i>
                            </button>
                            <button id="editManageBidRemarksBtn" class="btn btn-sm btn-outline-warning" onclick="enableBidEdit('manageBidRemarks', 'editManageBidRemarksBtn', 'saveManageBidRemarksBtn')">
                                <i class="fas fa-edit"></i>
                            </button>
                        </div>
                    </div>
                    <textarea class="form-control border-warning fw-semibold" id="manageBidRemarks" rows="2" disabled="">This is a default remark.</textarea>
                </div>
            </div>

            <!-- Footer -->
           <div class="modal-footer bg-white border-0 pt-0 d-flex flex-row gap-2 justify-content-center justify-content-sm-end align-items-center flex-wrap">
    <button type="button" class="btn btn-warning text-dark fw-bold px-4 shadow-sm" onclick="confirmBidPlacement()">
        <i class="fas fa-gavel me-2"></i>Update
    </button>
    <button type="button" class="btn btn-outline-secondary text-dark px-4" data-bs-dismiss="modal">
        <i class="fas fa-times me-1"></i>Cancel
    </button>
...
<div class="modal fade" id="acceptBidModal" tabindex="-1" aria-labelledby="acceptBidModalLabel" aria-hidden="true">
 <div class="modal-dialog modal-dialog-centered modal-xl " style="animation: 0.3s ease-out 0s 1 normal none running modalSlideIn;">
    ...
    <div class="col-lg-8 d-flex align-items-start">
        <div class="d-flex align-items-start flex-grow-1 flex-column flex-lg-row ">
            ...
            <div class="position-relative me-3 text-center text-lg-start">
                ...
                <span class="position-absolute d-none d-md-block bottom-0 end-0 bg-success rounded-circle border-2 border-white" style="width: 14px; height: 14px;" title="Active now"></span>
            </div>
 ...
 const selectedContainer = document.getElementById("selectedLocations");
  ...
  document.addEventListener("click", (e) => {
    ...
    function journeyForm(event) {
        ...
        $('#pre_drop2').text(formObject.dropoff_date != '' ? formatDate(formObject.dropoff_date) : 'NA');
...
function showAcceptConfirmation(id) {
    currentBidId = id;
