...
@keyframes fadeIn {
  ...
  #profile-bar-box .dropdown-item {
      background: transparent;
      border-radius: 0;
  }
  
  #profile-bar-box.dropdown-menu {
      opacity: 1;
  }
                ...
                <div class="btn-group" id="profile-bar">
                    ...
                    <div tabindex="-1" role="menu" class="dropdown-menu dropdown-menu-right" id="profile-bar-box"
                        ...
                        <a href="/profile" type="button" class="dropdown-item">
                            <i class="fas fa-user"></i> Vie Profile
                        </a>
            ...
            <ul class="nav nav-tabs card-header-tabs w-100 flex-wrap flex-sm-nowrap" id="jobTabs" role="tablist">
              ...
              <li class="nav-item d-sm-none flex-fill text-center" role="presentation">
                <button
                  ...
                  id="available-tab" data-bs-toggle="tab" data-bs-target="#available" type="button" role="tab"
                  aria-selected="false">
                  <!--<img src="{{ asset('goride/img/flag.png') }}" alt="goride_ads" style="height: 20px;width: 20px;">-->
                  Open Jobs
                </button>
              </li>

              <li class="nav-item d-sm-none flex-fill" role="presentation">
                <button class="nav-link rounded-pill text-center py-2" id="created-tab" data-bs-toggle="tab"
                  data-bs-target="#created" type="button" role="tab" aria-selected="false">
                  My Jobs
                </button>
              </li>
              <li class="nav-item d-sm-none flex-fill" role="presentation">
                <button class="nav-link rounded-pill text-center py-2" id="bidding-tab" data-bs-toggle="tab"
              ...
              <li class="nav-item d-sm-none flex-fill" role="presentation">
                <button class="nav-link rounded-pill text-center py-2" id="liked-tab" data-bs-toggle="tab"
              ...
              <li class="nav-item flex-shrink-0 d-none d-sm-block" role="presentation">
                <button class="nav-link d-flex align-items-center gap-2" id="available-tab-desktop" data-bs-toggle="tab"
                  data-bs-target="#available" type="button" role="tab" aria-selected="false">
                  <!--<img src="{{ asset('goride/img/flag.png') }}" alt="goride_ads" style="height:20px;width:20px;">-->
                  Open Jobs
                </button>
              </li>
              ...
              <li class="nav-item flex-shrink-0 d-none d-sm-block" role="presentation">
                <button class="nav-link" id="created-tab-desktop" data-bs-toggle="tab" data-bs-target="#created"
                  type="button" role="tab" aria-selected="false">
                  My Jobs
                </button>
              </li>
              <li class="nav-item flex-shrink-0 d-none d-sm-block" role="presentation">
                <button class="nav-link" id="bidding-tab-desktop" data-bs-toggle="tab" data-bs-target="#bidding"
                  type="button" role="tab" aria-selected="false">
                  Bidding Jobs
                </button>
              </li>
              ...
              <li class="nav-item d-none d-sm-block" role="presentation">
                <button class="btn btn-sm create-btn d-flex align-items-center gap-1" style="font-size: 14px;"
...
<div class="d-flex align-items-center justify-content-between gap-2 mb-3 mt-2 mt-md-0 flex-wrap">

  <!-- Left: Date Picker -->
  <div class="d-flex align-items-center gap-2" style="margin-left: 12px;">
    <input type="text" class="form-control form-control-sm mb-0 py-2" id="dateRangePicker" placeholder="Select date range">
...
<!-- Distance Filter -->
<!--<div class="dropdown">-->
<!--  <button class="btn btn-outline-secondary rounded-pill px-3 py-1 dropdown-toggle" -->
<!--          type="button" id="distanceDropdown" data-bs-toggle="dropdown" aria-expanded="false"-->
<!--          data-default="Distance">-->
<!--    Distance-->
<!--  </button>-->
<!--  <ul class="dropdown-menu p-2 shadow" aria-labelledby="distanceDropdown">-->
<!--    <li><button class="dropdown-item sort-btn mb-2" data-sort="distance-asc">Low → High</button></li>-->
<!--    <li><button class="dropdown-item sort-btn" data-sort="distance-desc">High → Low</button></li>-->
<!--    <li><hr class="dropdown-divider"></li>-->
<!--    <li><button class="dropdown-item reset-btn">Reset</button></li>-->
<!--  </ul>-->
<!--</div>-->
...
<!--<div class="dropdown">-->
<!--  <button class="btn btn-outline-secondary rounded-pill px-3 py-1 dropdown-toggle" -->
<!--          type="button" id="amountDropdown" data-bs-toggle="dropdown" aria-expanded="false"-->
<!--          data-default="Amount">-->
<!--    Amount-->
<!--  </button>-->
<!--  <ul class="dropdown-menu p-2 shadow" aria-labelledby="amountDropdown">-->
<!--    <li><button class="dropdown-item sort-btn mb-2" data-sort="amount-asc">Low → High</button></li>-->
<!--    <li><button class="dropdown-item sort-btn" data-sort="amount-desc">High → Low</button></li>-->
<!--    <li><hr class="dropdown-divider"></li>-->
<!--    <li><button class="dropdown-item reset-btn">Reset</button></li>-->
<!--  </ul>-->
<!--</div>-->
 ...
 <script>
//   // Update button text when a sort option is clicked
...
//       const filterName = dropdownBtn.getAttribute('data-default'); // Distance / Amount
//       dropdownBtn.textContent = `${filterName}: ${this.textContent}`;
//     });
//   });

//   // Reset button text when Reset is clicked
//   document.querySelectorAll('.reset-btn').forEach(item => {
//     item.addEventListener('click', function () {
//       const dropdownBtn = this.closest('.dropdown').querySelector('.dropdown-toggle');
//       dropdownBtn.textContent = dropdownBtn.getAttribute('data-default'); // reset back
//     });
//   });
// </script>
    ...
    <!-- Sort By -->
    <!--<button class="btn btn-warning dropdown-toggle py-1" type="button" id="sortDropdown" data-bs-toggle="dropdown" aria-expanded="false">-->
    <!--  Sort By-->
    <!--</button>-->
                  ...
                  <div class="card filter shadow-sm border-0 rounded-3">
                    <div class="card-header bg-white border-bottom py-2">
                      ...
                      <div class="d-flex justify-content-center">
                        <button class="btn btn-sm btn-link text-muted p-0 me-3" onclick="resetFilter()"
                          id="resetFiltersBtn">
...
<!--</div>-->
                      ...
                      <div class="mb-4 position-relative">
                        ...
                        <div class="position-relative">
                          ...
                          <!-- Dropdown -->
                          <div class="search-dropdown position-absolute w-100 bg-white shadow-lg" id="locationDropdown"
            ...
            <div class="tab-pane fade " id="created" role="tabpanel">
              <div class="row">
                <ul class="nav nav-tabs card-header-tabs justify-content-center text-center mb-5" id="MyjobTabs"
                  role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="past-tab" data-bs-toggle="tab" data-bs-target="#past" type="button"
                      role="tab" aria-selected="false"> Past
                      Jobs</button>
                  </li>
                </ul>
...
<div class="modal fade" id="cancelModal" tabindex="-1" aria-labelledby="cancelModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-md w-100">
    <div class="modal-content  p-3">
      ...
      <!-- Header -->
      <div class="modal-header p-2 d-flex justify-content-center position-relative p-0">
        <h3 class="modal-title" id="cancelModalLabel">Confirm Cancellation</h3>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <!-- Body -->
      <div class="modal-body p-2" id="q_text">
        
      </div>

      <!-- Footer -->
      <div class="modal-footer">
        <button type="button" class="btn btn-danger btn-sm" id="cancel-btn">Yes, Cancel</button>
        ...
        <form id="journeyForm" data-gtm-form-interact-id="0" enctype="multipart/form-data"
          ...
          <div class="d-flex align-items-center flex-nowrap overflow-auto gap-2 ms-2">
            ...
            <div class="form-check mb-0">
              <input class="form-check-input mt-2" type="radio" name="job_type" id="roundTrip" value="roundtrip">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-4 col-12">
              ...
              <input type="number" id="passengerCount" name="pass_count" class="form-control p-1"
                oninput="this.value = this.value.replace(/[^0-9]/g,'').slice(0,3)" placeholder="Count" min="1"
                max="500">
            </div>
          </div>
          ...
          <div class="row ">
            ...
            <div class="col-md-6 col-12">
              ...
              <input type="number" id="marketedPrice" name="fare" class="form-control p-1 mb-0"
                oninput="this.value = this.value.replace(/[^0-9]/g,'').slice(0,7)"
                placeholder="Enter the estimated fare">
              <small class="form-text text-muted mt-1">The actual marketed price is <span id="approx_fare"
            ...
            <div class="col-md-4 col-12">
              ...
              <input type="number" id="distance" name="distance" class="form-control p-1"
                oninput="this.value = this.value.replace(/[^0-9]/g,'').slice(0,7)" placeholder="Enter Distance">
            </div>
          </div>
          <!-- Additional Charges -->
          <div class="mb-2">
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-4">
                ...
                <div class="neo-toggle-container">
                  <input class="neo-toggle-input" name="bataRadio" id="bataIncluded" type="checkbox" value="Included" />
              ...
              <div class="col-md-3 col-4">
                ...
                <!--</div>-->
                <div class="neo-toggle-container">
                  <input class="neo-toggle-input" name="tollRadio" id="tollIncluded" type="checkbox" value="Included"/>
              ...
              <div class="col-md-3 col-4">
                ...
                <!--</div>-->
                <div class="neo-toggle-container">
                  <input class="neo-toggle-input" name="parkingRadio" id="parkingIncluded" type="checkbox" value="Included"/>
          ...
          <div class="mt-3">
            ...
            <textarea class="form-control p-1" rows="2" placeholder="Enter remarks..."
              oninput="this.value = this.value.replace(/[^0-9a-zA-Z ]/g,'').slice(0,150)" name="job_remark"></textarea>
          </div>
          <div class="form-check mt-3">
            <input class="form-check-input p-1 mt-2 " type="checkbox" id="termsCheck2" required>
            <label class="form-check-label " style="font-size:14px;" for="termsCheck2">
      ...
      <div class="modal-body" id="previewContent">
        ...
        <div class="summary-section p-3 bg-light rounded" style="width: auto !important;">
          ...
          <div class="row d-none d-md-flex">
            <div class="col-md-6 col-12">
              <p><i class="fas fa-calendar-day me-2 text-primary"></i><strong class="fw-bold">Pickup:</strong> <span
                  id="pre_pick">15 May 2023, 10:00 AM</span>
              </p>
              <p><i class="fas fa-map-marker-alt me-2 text-primary"></i><strong class="fw-bold">From:</strong> <span
                  id="pre_from2" onclick="toggleAddress(this)">Mumbai, Maharashtra</span></p>
            ...
            <div class="col-md-6 col-12">
              <p><i class="fas fa-calendar-day me-2 text-danger pre_drop_hide"></i><strong
                  class="fw-bold pre_drop_hide">Drop:</strong> <span id="pre_drop" class="pre_drop_hide">15 May 2023,
                  01:30 PM</span></p>
              <p><i class="fas fa-map-marker-alt me-2 text-danger"></i><strong class="fw-bold">To:</strong> <span
                  id="pre_to2" onclick="toggleAddress(this)">Pune,
                  Maharashtra</span></p>
              <p class="my-0">
          ...
          <div class="row d-block d-md-none">
            <div class="col-md-6 col-12 ">
              ...
              <p><i class="fas fa-map-marker-alt me-2 text-primary"></i><strong class="fw-bold">From:</strong> <span
                  id="pre_from5" onclick="toggleAddress(this)">Mumbai, Maharashtra</span></p>
              <p><i class="fas fa-map-marker-alt me-2 text-danger"></i><strong class="fw-bold">To:</strong> <span
                  id="pre_to5" onclick="toggleAddress(this)">Pune,
                  Maharashtra</span></p>
              ...
              <p><i class="fas fa-calendar-day me-2 text-danger pre_drop_hide"></i><strong
                  class="fw-bold pre_drop_hide">Drop Date/Time:</strong> <span id="pre_drop5" class="pre_drop_hide">15
                  May 2023, 01:30 PM</span></p>
...
<div class="modal fade" id="agreedModal" tabindex="-1" aria-labelledby="agreedModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md modal-dialog-centered">
    <div class="modal-content w-100 p-4 rounded-4 text-center position-relative">
      ...
      <button type="button" class="btn-close close-button position-absolute top-0 end-0 p-2 m-1" data-bs-dismiss="modal"
      ...
      <div class="modal-body">
        ...
        <div class="mt-3 border-top pt-3">
          <p class="text-danger mb-1 bg-light fw-normal border w-100 rounded p-2 d-flex flex-column align-items-start">
...
<div class="modal fade" id="postedModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-sm modal-dialog-centered">
    <div class="modal-content w-100 p-3 position-relative">
      ...
      <button type="button" class="btn-close ms-auto custom-close" data-bs-dismiss="modal" aria-label="Close"></button>
      ...
      <div class="modal-body bg-light">
        ...
        <div class="mb-3 bg-white rounded-3 shadow-sm p-3 border border-warning border-opacity-25 text-center">
          ...
          <img src="https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/profile/user-1.jpg"
            style="    width: 88px; height: 92px;object-fit: cover;" class="rounded" alt="User Image" id="post_img">
      ...
      <!-- Footer -->
      <div class="modal-footer d-none justify-content-center py-0 bg-white  flex-nowrap">
        <div class="dropdown flex-fill">
          <a class="text-danger text-decoration-underline d-flex align-items-center justify-content-center w-100"
            href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <i class="fas fa-flag me-2"></i> Report User
      ...
      <div class="modal-body bg-light p-2 mt-3">
                ...
                <div class="flex-grow-1 pt-md-1 w-100">
                  ...
                  <div class="d-flex flex-wrap gap-2 text-dark small mb-0 mb-md-2 mb-sm-0">
                    <span class="fw-semibold d-block d-md-inline-block mb-1 mb-md-0">
                      <i class="fas fa-building text-warning me-1"></i><span id="j_company"></span>
                    </span>
                  ...
                  <div class="d-flex flex-column align-items-center justify-content-center  mt-lg-0 d-block d-md-none">
        ...
        <div class="mb-2">
          <div class="row">
            <div class="col-6">
              <p class="my-0"><i class="fas fa-map-marker-alt me-2 text-primary"></i><strong
                  class="fw-bold">From:</strong> <span id="pre_from4" onclick="toggleAddress(this)">Perungalathur Bus
                  Stand, Tambaram Corporation, Grand
                  Southern Trunk Road, Otteri Extension, Kamaraj Nagar, New Perungalathur, Chennai,
                  Tamil Nadu, India - 600063</span></p>
            </div>
            <div class="col-6">
              <p class="my-0"><i class="fas fa-map-marker-alt me-2 text-danger"></i><strong class="fw-bold">To:</strong>
                <span id="pre_to4" onclick="toggleAddress(this)">Perambur Bus Terminus, Perambur High Road, Chinnaiyan
          ...
          <div class="input-group">
            ...
            <input type="number" class="form-control border-warning fw-semibold" id="bidAmount" placeholder="e.g., 4200"
              min="0" style="border-left: none;">
          </div>
      ...
      <div class="modal-body bg-light p-2">
              ...
              <div class="d-flex align-items-start flex-grow-1  flex-md-row gap-3">
                ...
                <div class="flex-grow-1 pt-md-1 w-100">
                  ...
                  <div class="d-flex flex-wrap gap-0 gap-md-2 text-dark small mb-0 mb-md-2">
                    <span class="fw-semibold d-block d-md-inline-block mb-1 mb-md-0">
                      <i class="fas fa-building text-warning me-1"></i><span id="m_company"></span>
                    </span>
                    <span class="fw-semibold d-none mb-1 mb-md-0">
                      <i class="fas fa-map-marker-alt text-warning me-1"></i>
                    </span>
                  ...
                  <div class="d-flex flex-wrap gap-0 gap-md-3 text-dark small">
                    <span class="fw-semibold d-block d-md-inline-block mb-1 mb-md-0">
                      <i class="fa fa-briefcase text-warning me-1"></i><span id="m_complete"></span>
                    </span>
                    <span class="fw-semibold d-block d-md-inline-block">
        ...
        <div class="mb-2">
          <div class="row">
            <div class="col-6">
              <p class="my-0"><i class="fas fa-map-marker-alt me-2 text-primary"></i><strong
                  class="fw-bold">From:</strong> <span id="pre_from3" onclick="toggleAddress(this)"></span></p>
            </div>
            <div class="col-6">
              <p class="my-0"><i class="fas fa-map-marker-alt me-2 text-danger"></i><strong class="fw-bold">To:</strong>
                <span id="pre_to3" onclick="toggleAddress(this)"></span></p>
            </div>
            <div class="col-12">
          ...
          <div class="input-group">
            <span class="input-group-text bg-warning text-dark fw-bold border-warning">₹</span>
            <input type="number" class="form-control border-warning fw-semibold" id="manageBidAmount" value="0" min="0"
        ...
        <div class="mb-2">
          ...
          <textarea class="form-control border-warning fw-semibold" id="manageBidRemarks" rows="2"
            placeholder="Enter You Remarks" oninput="this.value = this.value.replace(/[^0-9a-zA-Z ]/g,'').slice(0,150)"
            disabled=""></textarea>
        </div>
      </div>
    ...
    <div class="modal-content w-100">
      ...
      <div class="modal-body bg-light p-2">
              ...
              <div class="d-flex align-items-start flex-grow-1 flex-column flex-lg-row ">
                ...
                <div class="flex-grow-1 pt-1">
                  ...
                  <div class="d-flex flex-wrap gap-2 text-dark small mb-2">
                    <span class="fw-semibold">
                      <i class="fas fa-building text-warning me-1"></i><span id="b_company"></span>
                    </span>
                    <span class="fw-semibold ">
                      &nbsp;
                    </span>
                    ...
                    <span class="fw-semibold">
                      <i class="fa fa-briefcase text-warning me-1"></i><span id="b_complete"></span>
                    </span>
                  </div>
        ...
        <div class="mb-2">
          ...
          <div class="input-group">
            <span class="input-group-text bg-warning text-dark fw-bold border-warning">₹</span>
            <input type="number" class="form-control border-warning fw-semibold" id="b_amount" value="" min="0"
              style="border-left: none;" disabled="">
          </div>
    ...
    <div class="modal-content w-100">
      ...
      <div class="modal-body bg-light p-2">
            ...
            <div class="col-lg-8 d-flex align-items-start">
              <div class="d-flex align-items-start flex-grow-1 flex-column flex-lg-row ">
                ...
                <div class="flex-grow-1 pt-1">
                  ...
                  <div class="d-flex flex-wrap gap-2 text-dark small mb-2">
                    <span class="fw-semibold">
                      <i class="fas fa-building text-warning me-1"></i><span id="r_company"></span>
                    </span>
                    <span class="fw-semibold d-none">
                      <i class="fas fa-map-marker-alt text-warning me-1"></i>Perambur, Chennai
                    </span>
                    ...
                    <span class="fw-semibold">
                      <i class="fa fa-briefcase text-warning me-1"></i> <span id="r_complete"></span>
                    </span>
                  </div>
        ...
        <div class="mb-2">
          ...
          <div class="input-group">
            <span class="input-group-text bg-warning text-dark fw-bold border-warning">₹</span>
            <input type="number" class="form-control border-warning fw-semibold" id="r_amount" value="4200" min="0"
              style="border-left: none;" disabled="">
          </div>
        ...
        <div class="mb-2">
          ...
          <textarea class="form-control border-warning fw-semibold" id="r_remark" rows="2" disabled=""></textarea>
        </div>
...
document.querySelectorAll(".close-btn").forEach(btn => {
  ...
  $(function () {
    ...
    $('#dateRangePicker').daterangepicker({
      ...
      // This callback fires immediately when dates are selected
...
<script>
  ...
  function loc_select() {
    ...
    $('#fromPlace, #toPlace, input[name="job_type"], #passengerCount').on('input change', function () {
      clearTimeout(distanceTimeout); // stop previous waiting timer
    
      distanceTimeout = setTimeout(function () {
        if (isRequestRunning) return; // if a request is already running, skip
    
        let fromPlace = $('#fromPlace').val();
        let toPlace = $('#toPlace').val();
        let passengerCount = $('#passengerCount').val();
        let jobType = $('input[name="job_type"]:checked').val();
    
        if (fromPlace !== '' && toPlace !== '' && jobType !== '') {
          ...
          formData.append("from", fromPlace);
          formData.append("to", toPlace);
          formData.append("pass", passengerCount);
          formData.append("way_type", jobType);
    
          isRequestRunning = true; // set running flag
          ...
          $.ajax({
            ...
            complete: function () {
              isRequestRunning = false; // release lock
            }
          });
        }
      }, 1000); // wait 1 second after last change
  ...
  $(document).on('change', '.neo-toggle-input', function () {
        if ($(this).is(':checked')) {
            $(this).val("Passenger To Pay");
        } else {
            $(this).val("Included");
        }
    });
  ...
  function journeyForm(event) {
    ...
    const requiredFields = [
      ...
      { name: "bataRadio", label: "Bata", type: "checkbox" },
      { name: "tollRadio", label: "Toll", type: "checkbox" },
      { name: "parkingRadio", label: "Parking", type: "checkbox" },
    ...
    $('.neo-toggle-input').each(function() {
        if ($(this).is(':checked')) {
            formData.set($(this).attr('name'), "Passenger To Pay");
        } else {
            formData.set($(this).attr('name'), "Included");
        }
    });
