            ...
            <div class="col-md-6">
                <div class="contact-details-wrap">
                    ...
                    <ul class="contact-details">
                        ...
                        <li><a href="tel:+916369742104" title="International"><i
                                    class="fa-solid fa-earth-asia"></i>+91 63697 42104</a></li>
                        ...
                        <li><a href="javascript:void(0);">
                            ...
                            </a>Goride Run Private Limited </br>
                            No: 1A,2nd Floor,
                        ...
                        <div class="contact-form-group">
                            ...
                            <div class="form-field">
                                <div>
                                    <input type="text" id="name" name="user_name" placeholder="Full Name"
                                        class="form-control m-0"  oninput="this.value = this.value.replace(/[^A-Za-z ]/g, '');" maxlength="70" >
                                </div>
                            ...
                            <div class="form-field">
                                <!-- <label for="sub1" class="form-label"><span>Subject <span
                                            class="required-star">*</span></span></label> -->
                                <div>
                                    <input type="text" id="sub1" name="sub1" class="form-control m-0" placeholder="Subject"  oninput="this.value = this.value.replace(/[^A-Za-z. ]/g, '');" maxlength="100" >
                                </div>
                        ...
                        <div class="form-field">
                                ...
                                <div>
                                    <textarea id="message" placeholder="Message" style="
                                        height: auto;
    resize: unset;" class="form-control m-0" cols="30" rows="4"  oninput="this.value = this.value.replace(/[^A-Za-z.?` ]/g, '');" maxlength="500" ></textarea>
                                </div>
