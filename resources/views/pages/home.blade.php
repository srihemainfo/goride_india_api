...
.phone-mockup {
  ...
  height: 483px;
  overflow: scroll;
  max-height: 483px; /* or whatever height you want */
  ...
  <div class="container">
            ...
            <div class="col-md-6 col-12 text-center d-flex flex-column justify-content-start align-items-center mt-4">
                    ...
                    <div class="row d-flex justify-content-center align-items-center">
                      ...
                      <div class="col-md-6 col-12 text-center">
                        <img src="{{ asset('goride/img/mobile-app.webp') }}" alt="Job Search" class="img-fluid job-search" style="max-width: 526px;">
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12  i_phone mb-md-30">
                    <div class="content" data-aos="fade-down" data-aos-duration="1000">
                       ...
                       <p class="mb-30 fw-normal" style="text-align: justify;">Welcome to Go Ride, the leading AI-based dispatch system designed to optimize
                            ...
                            and fleet management. With Go Ride, you can streamline operations, reduce costs, and enhance
                            customer satisfaction.</p>
                                    <div class="text-center text-md-start">
                        <a href="about" class=" button-4 mb-3 mb-md-0">Learn More About Go Ride's Services <span class="ti-arrow-top-right"></span></a></div>
                    </div>
                </div>
                <div class="col-lg-5 offset-lg-1 col-md-12">
                    <div class="item " data-aos="fade-down" data-aos-duration="1000">  <img src="{{ asset('goride/img/indian-about.jpg') }}" class="img-fluid" alt="about">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title"> <span>Go Ride the Best AI Management Software</span></div>
                    <p class="text-center">Explore the Powerful Capabilities of Go Ride</p>
            ...
            <div class="row justify-content-around">
                ...
                <div class="col-md-2 text-center mb-3">
                    <div class="mycard wallet mx-auto"  data-aos ="fade-up" data-aos-duration="1000" data-aos-delay="200">
                        ...
                        <p class="text-center">Maximize your profits with Go Ride's dynamic pricing and demand forecasting
                ...
                <div class="col-md-2 text-center mb-3">
                    <div class="mycard wallet mx-auto"  data-aos ="fade-up" data-aos-duration="1000" data-aos-delay="300">
                        ...
                        <p class="text-center">Gain valuable insights into your fleet's performance with Go Ride's
                ...
                <div class="col-md-2 text-center mb-3">
                    <div class="mycard wallet mx-auto"  data-aos ="fade-up" data-aos-duration="1000" data-aos-delay="400">
                        ...
                        <p class="text-center">Every business is unique, and so is our approach. Go Ride offers customizable
    ...
    <section class="tax-brand section-padding mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title text-center">Benefits of&nbsp;<span> Go Ride</span></div>
                ...
                <div class="roadmap row">
                    <div class="step col-md-3 "  data-aos="fade-up" data-aos-duration="2s">
                        <div class="content yellow">
                            <h2>Step 1</h2>
                            <h3>Easy Setup</h3>
                            <p>Getting started with Go Ride is simple. Our team will guide you through the setup process and
                ...
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            ...
                            <div class="text ">
                                <p class="fw-normal">Goride Run Private Limited's incredible customer support made integrating the Dispatch Taxi System seamless, ensuring efficiency and reliability from day one, boosting both our operations and customer satisfaction.</p>
                            </div>
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                <p class="fw-normal">Using Goride Run Private Limited's Dispatch Taxi System, our operations transformed with real-time GPS tracking & dispatching, resulting in streamlined services and higher efficiency for both drivers and passengers.</p>
                            </div>
                            <div class="info mt-30">
                                <div class="img-curv">
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                <p class="fw-normal">Goride Run Private Limited’s system brought significant improvements to Go Ride, offering real-time tracking and effortless bookings, improving experiences for passengers and drivers alike while boosting operational efficiency.</p>
                            </div>
                            <div class="info mt-30">
                                <div class="img-curv">
            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <div class="cs_cta cs_style_1 text-center position-relative"  data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <p class="cs_section_subtitle mb-4">Join hundreds of satisfied customers who trust Go Ride for their
        ...
        <div class="container">
            <div class="mcb-wrap-inner">
                ...
                <div class="product-like-reputed-content"  data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                    ...
                    <p class="bottom-gap">Go Ride offers 100+ API integrations to help you connect multiple stakeholders and enhance your business efficiency</p>
                    <div style="
    display: flex;
    justify-content: center;
