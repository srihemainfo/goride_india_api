...
@keyframes blinkColor {
    ...
    <section class="page-header">
        ...
        <div class="container">
            <div class="page-header-info">
                <h4>Go Ride My Riders App</h4>
                <h1>Boost Your Productivity <br> with <span>Our My Riders App!</span></h1>
  ...
  <div class="col-md-9 mb-4 mb-md-0">
    <div class="section-heading mb-40">
      <h4 class="wow fadeIn" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-name: fadeIn;"> <span></span>Go Ride My Riders App</h4>
      ...
      <p class="wow fadeIn" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-name: fadeIn;">
        At Go Ride, we believe in empowering drivers with the tools they need to succeed. Our AI-based dispatch software offers a powerful and intuitive My Riders App, specifically designed to enhance the efficiency and earnings of taxi drivers. Whether you’re an independent driver or part of a larger fleet, the Go Ride My Riders App is your key to a seamless driving experience.
      </p>
    </div>
  </div>
  ...
  <div class="col-md-3">
    <div class="mb-5 text-center">
      <h3 class="widget-title">Try our My Riders App</h3>
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="section-heading text-center mb-40">
                        <h2 class="wow fadeIn" data-wow-duration="2s">Why Choose the Go Ride My Riders App?</h2>
                    </div>
                </div>
                <div class="col-md-4 d-flex my-1 wow fadeIn" data-wow-duration="2s">
                    <div class="key_features_card">
                        <h4>AI-Powered Dispatching</h4>
                        <p>Our advanced AI algorithms ensure that you receive the most optimized jobs based on your location, availability, and driving patterns. With Go Ride, you spend less time waiting and more time earning.</p>
                    </div>
                </div>
                <div class="col-md-4 d-flex my-1 wow fadeIn" data-wow-duration="2s" data-wow-delay="500ms">
                    <div class="key_features_card">
                        <h4>Real-Time Navigation</h4>
                        <p>Integrated with cutting-edge GPS technology, the Go Ride My Riders App provides real-time navigation and traffic updates. This means fewer delays and quicker routes, helping you provide a better service to your passengers.</p>
                    </div>
                </div>
                ...
                <div class="col-md-4 d-flex my-1 wow fadeIn" data-wow-duration="2s">
                    <div class="key_features_card">
                        ...
                        <p>Receive instant alerts for new ride requests, cancellations, and any changes in your schedule. With Go Ride, you are always in the loop, ensuring that you never miss an opportunity.</p>
                    </div>
                </div>
                <div class="col-md-4 d-flex my-1 wow fadeIn" data-wow-duration="2s" data-wow-delay="500ms">
                    <div class="key_features_card">
                        <h4>Secure and Transparent Payments</h4>
                        <p>Say goodbye to payment hassles. Go Ride’s My Riders App provides secure, transparent, and quick payment processing. Track your earnings in real time and receive detailed summaries of all your rides.</p>
                    </div>
                </div>
                <div class="col-md-4 d-flex my-1 wow fadeIn" data-wow-duration="2s" data-wow-delay="1000ms">
                    <div class="key_features_card">
                        <h4>Driver Support and Community</h4>
                        <p>At Go Ride, we care about our drivers. Our dedicated support team is available 24/7 to assist you with any issues or questions. Plus, connect with other drivers through our app community for tips, advice, and camaraderie.</p>
                    </div>
                </div>
            </div>
        </div>
    			...
    			<div class="col-md-6">
    				<div class="how-app-work-content-wrap">
    					<div class="title wow fadeIn" data-wow-duration="2s">
    						<h3>Get Started with Go Ride My Riders App</h3>
    					</div>
    					<div class="how-app-work-content" id="how-app-work-slider-pager">
    						<a href="#" class="pager-item active wow fadeIn" data-wow-duration="2s" data-wow-delay="500ms">
    						    <div class="single-how-app-work ">
        							...
        							<div class="text-box">
        								<h4>Sign Up</h4>
        								<p>Download the Go Ride My Riders App from the App Store or Google Play, and sign up with your details.</p>
        							</div>
        						</div>
    						</a>
