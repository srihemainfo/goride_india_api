<script>
    ...
    function openJobs(pg = null) {
        
        
        
        let formData = new FormData();
        // // console.log(pg, 'fffffffffff', loading, hasMore)
        if(pg == 'yes'){
        ...
        if($('#location_input').val() != ''){
            formData.append('location', $('#location_input').val());
        }
        if($("#filterDistance").val() != ''){
            
            formData.append('distance', $("#filterDistance").val());
        }
        if($("#filterPassengerCount").val() != ''){
            
            formData.append('pass', $("#filterPassengerCount").val());
        }
        if($("#filterAmount").val() != ''){
            
            formData.append('fare', $("#filterAmount").val());
        }
        if($("#fromDate").val() != ''){
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status) {
                                                        ...
                                                        <div class="company-info">
                                                            <div class="car-specs">
                                                                <div class="row">
                                                                    ...
                                                                    <span class="icon-report me-2 d-none d-md-inline ${value.user_like_status != '0' ? 'liked' : ''}" onclick="updateLike('${value.id}', '${value.user_like_status != '0' ? 'off' : 'on'}' , this)" style="cursor:pointer;">
                                                            ...
                                                            >
                                                              ...
                                                              >
                                                                <span class="d-flex align-items-center gap-1">
                                                                  ...
                                                                  <strong
                                                                    class="fw-bold"
                                                                    style="cursor: pointer; text-decoration: underline" onclick="jobOwner('${value.user_id}')">
                                                                    ${value.poster_name}
                                                                  </strong>
                                                                </span>
                                                              </div>
                                                              ...
                                                              <div
                                                                class="small text-muted mt-2 position-relative d-md-none"
                                                                style="border-top: 2px solid #ddd"
                                                              >
                                                                <span class="oneway-label"
                                                                  >${value.job_type != 'oneway' ? 'ROUND TRIP' : 'ONE WAY'}</span
                                                                >
                                                                <div class="d-flex justify-content-between py-3">
                                                                  <!-- Pickup with icon -->
                                                                  <span class="d-inline-flex align-items-center gap-1 date-time">
                                                                    <i class="fa-solid fa-plane-departure text-success"></i>
                                                                    <strong class="fw-bold"> ${value.pickup_date} </strong>
                                                                  </span>
                                                            
                                                                  <!-- Dropoff only if date exists -->
                                                                  <span class="d-inline-flex align-items-center gap-1 date-time">
                                                                    ${value.dropoff_date ? `<i
                                                                      class="fa-solid fa-plane-arrival text-danger"
                                                                    ></i>
                                                                    <strong
                                                                      class="fw-bold"
                                                                ...
                                                                <span class="d-flex align-items-center gap-1">
                                                                  ...
                                                                  <span class="ms-auto" id="actionSection">
                                                                    ${value.user_bid == 'yes' ? `<button
                                                                      class="btn btn-sm btn-warning ms-auto agreeBtn ${value.job_status != 'bidding' && value.job_status != 'created' ? 'd-none' : ''}"
                                                                      onclick="bidManage('${value.id}', this)"
                                                                    >
                                                                      <i class="fas fa-gavel me-2"></i> Manage Bids</button
                                                                    >` : `<button
                                                                      class="btn btn-sm btn-success ms-auto agreeBtn"
                                                                      onclick="agreeBid('${value.id}', this, '${JSON.parse(value.add_fare_details)}', '${value.fare}')"
                                                                    >
                                                                      <i class="fas fa-thumbs-up me-1"></i> Agree</button
                                                                    >` }
                                                                  </span>
                                                                </span>
                                                                <span class="text-form">
                                                                ...
                                                                ${value.user_bid == 'yes' ? `` : `
                                                                <div
                                                                  class="small text-muted mt-2 place-bid-section d-flex justify-content-between align-items-center"
                                                                >
                                                                  <span
                                                                    class="icon-report d-md-none ${value.user_like_status != '0' ? 'liked' : ''}" onclick="updateLike('${value.id}', '${value.user_like_status != '0' ? 'off' : 'on'}', this)"
                                                                  ...
                                                                  <div>
                                                                    ...
                                                                    <a
                                                                      ...
                                                                      onclick="bidCreate('${value.id}', this)"
                    ...
                    $('#openJobs_cards').append(jobs_content);
                            ...
                            if(value.bidders.length > 0){
                                ...
                                biddersData += `
                                    ...
                                    <div class="row bid-card-wrapper ${ bid.status == 'accept' ? '' : isDis}" >
                                                          <div class="bid-card col-12 p-0" data-card-id="${ind}">
                                                                    ...
                                                                    <div class="driver-info">
                                                                      ...
                                                                      if(bid.status == 'accept'){
                                                                            ...
                                                                            biddersData += `<div class="bid-post-accept" id="post-accept-3">
                                                                                            ...
                                                                                            <div  class="icon-circle bg-white border border-danger me-2" title="report">
                            ...
                            jobs_content +=
                                ...
                                `<div class="compact-car-card ">
                                                ...
                                                <div class="row d-flex justify-content-start align-items-start">
                                                 <div class="car-specs mb-3">
                                                               <div class="row">
                                                                    <!-- Left: Passenger & Distance + Heart at end -->
                                                                    <div class="col-md-6 col-6 d-flex align-items-center gap-1">
                                                                    <span class="icon-report me-2 d-none ${value.user_like_status != '0' ? 'liked' : ''}" onclick="updateLike('${value.id}', '${value.user_like_status != '0' ? 'off' : 'on'}', this)" style="cursor:pointer;">
                                                                        <i class="fa fa-heart"></i>
                                                                    </span>
                                                                        <span class="passenger-count d-flex align-items-center gap-1">
                                                                            <i class="fas fa-users"></i> ${value.pass_count}
                                    ...
                                    : ''}
                                                   ...
                                                   <div class="col-md-4 col-10 position-relative px-0">
                                                    ...
                                                    <div class="col-md-1 col-2 position-relative">
                                                        <div class="dropdown sort-dropdown  text-end d-none">
  ...
  <button class="btn btn-link text-danger p-0" onclick="setCancel(${value.id}, 'job')">
    Cancel Job
  </button>
                ...
                if (response.status) {
                    ...
                    if (data.length > 0) {
                        ...
                        $.each(data, function (index, value) {
                            ...
                            let add_details = 'Toll ' + decode_details.toll + ', Parking ' + decode_details.parking + ', Bata ' + decode_details.bata;
                            let isHide = false;
                            if(value.user_bid_status == 'accept' || value.user_bid_status == 'reject'){
                                isHide = true;
                            }
                            
                            // // console.log('hijjj ' + value.user_bid_status)
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                        ...
                                                        <div class="car-specs">
                                                            <div class="row">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <span class="icon-report me-2 d-none d-md-inline ${value.user_like_status != '0' ? 'liked' : ''}" onclick="updateLike('${value.id}', '${value.user_like_status != '0' ? 'off' : 'on'}', this)"
                                                                        onclick="toggleLike(this)"
                                                                        style="cursor:pointer;">
                                                                        <i class="fa fa-heart"></i>
                                                                    </span>
                                                ...
                                                <div class="col-md-12 py-1 px-0 col-12">
                                                    ...
                                                    <div class="trip-info">
                                                        <div class="route-section my-3 p-1">
                                                            <div class="location-time">
...
<div class="col-12 d-md-flex justify-content-md-between align-items-center flex-md-wrap align-items-end">
                                                                ...
                                                                <div class="d-md-flex d-inline-block align-items-center justify-content-center small text-muted gap-4 mb-2 d-none d-md-block">
                                                                    <span class="d-flex align-items-center gap-1">
                                                                        <i class="fa-solid fa-badge-check text-success"></i>
                                                                        Posted by
                                                                        <strong class="fw-bold" style="cursor:pointer; text-decoration: underline;" onclick="jobOwner('${value.user_id}')">
                                                                            ${value.poster_name}
                                                                        </strong>
                                                                    </span>
                                                                </div>
                                                                       ...
                                                                       ${
                                                                          isHide == true
                                                                            ...
                                                                            : (
                                                                                value.user_bid === 'yes'
                                                                                  ? `<button
                                                                                      class="btn btn-sm btn-warning  d-none d-md-block agreeBtn ${value.job_status !== 'bidding' && value.job_status !== 'created' ? 'd-none' : ''}"
                                                                                      onclick="bidManage('${value.id}', this)"
                                                                                    >
                                                                                      <i class="fas fa-gavel me-2"></i> Manage Bids
                                                                                    </button>`
                                                                                  : `<button
                                                                                      class="btn btn-sm btn-success ms-auto d-none d-md-block agreeBtn"
                                                                                      onclick="agreeBid('${value.id}', this, '${JSON.parse(value.add_fare_details)}', '${value.fare}')"
                                                                                    >
                                                                                      <i class="fas fa-thumbs-up me-1"></i> Agree
                                                                                    </button>`
                    ...
                    $('#liked_job_list').html(jobs_content);
                    // // // console.log(response.data);
                } else {
                    showToast('error', response.message, 3000);
                }
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status) {
                        ...
                        $('#manageBidAmount').val(data.bidders? data.bidders.amount : '');
                        $('#manageBidRemarks').val(data.bidders? data.bidders.remark : '');
    ...
    function agreeBid(id, btn, details, fare){
        ...
        `;
        $('#bidAmountDetails').html(add_details);
    ...
    function showAcceptConfirmation(id, job_id, btn) {
        ...
        formData.append('method', 'bidder_accept');
        ...
        $.ajax({
                ...
                success: function (response) {
                    if (response.status) {
                        ...
                        // data = response.data.bidders.length > 0 ? response.data.bidders : response.data;
                        data = response.data.bidders;
                        
                        $('#b_name').text(data.bidder_name??'');
                        $('#b_company').text(data.bidder_company_name??data.bidder_name);
                        $('#b_rate').text((data.bidder_ratings != null && data.bidder_ratings != '') ? data.bidder_ratings : '0');
                ...
                if (response.status) {
                    ...
                    if(data.length > 0){
                        ...
                        if (value.user_bid_status === 'accept') {
                            ...
                            ribbonHtml = '<div class="ribbon"><span class="cancelled">Lost</span></div>';
...
<div class="col-12 d-md-flex justify-content-md-between align-items-center flex-md-wrap align-items-end">
                                                            ...
                                                            <span class="d-inline-flex align-items-center gap-1 date-time">
                                                                            ...
                                                                            ${
                                                                              isHide
                                                                                ...
                                                                                : (
                                                                                    value.user_bid === 'yes'
                                                                                      ? `<button
                                                                                          class="btn btn-sm btn-warning d-none d-md-block ms-auto agreeBtn ${value.job_status != 'bidding' && value.job_status != 'created' ? 'd-none' : ''}"
                                                                                          onclick="bidManage('${value.id}', this)"
                                                                                        >
                                                                                          <i class="fas fa-gavel me-2"></i> Manage Bids</button
                                                                                        >`
                                                                ...
                                                                <div class="row mt-3">
                                               <div class="d-flex justify-content-end">
  <button class="btn btn-link text-danger p-0" onclick="setCancel(${value.id}, 'bid')">
    Cancel Bid
  </button>
    ...
    function updateLike(id, status, element, tabtyp = ''){
        if (id == '') {
            showToast('error', 'Job Not Available.', 3000);
            return;
        ...
        status = $(element).hasClass('liked') ? 'off' : 'on';
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status) {
                    ...
                    // openJobs(null, null, null, null, pg);
                    // // openJobs()
                    // currentJobs();
                    // bidStatus();
                    // likedJob();
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status) {
                    ...
                    let data = response.data;
                    if(data){
                        $('#post_name').text(data.name);
                        $('#post_comp').text(data.company_name??data.name+' Travels');
                        $('#post_complete').text(data.complete_jobs + ' jobs Completed');
                        $('#post_rate').text(data.ratings??'5');
                        
                        $('#post_img').attr(
                          'src',
                          data.profile_img_url || 'https://bootstrapdemos.adminmart.com/modernize/dist/assets/images/profile/user-1.jpg'
                        );
    ...
    // function myFilterFunction() {
        ...
        //     loc = $('#location_input').val();
        // }
        
        // if (/Mobi|Android/i.test(navigator.userAgent)) {
        //     // Mobile
        //     loc = $('#location_input_m').val();
        // }
        ...
        // console.log("Sending data to function/server:", location, distance, passengers, amount, pg);
    // }
    
    function pastJobs() {

        $.ajax({
            url: "{{ env('APP_API') }}my-past-jobs",
            type: 'POST',
            headers: {
                "Authorization": "Bearer " + getCookie('sessionToken')
            },
                ...
                if (response.status) {
                    ...
                    if (data.length > 0) {
                        ...
                        $.each(data, function (index, value) {
                            ...
                            switch (value.final_status) {
                                case 'cancelled':
                                    var st_col = 'Cancelled';
                                    break;
                                case 'no-response':
                                    var st_col = 'No Response';
                                    break;
                                case 'completed':
                                    var st_col = 'Completed';
                                    break;
                                case 'expired': // fixed spelling
                                    var st_col = 'Expired';
                                    break;
                                default:
                                    var st_col = 'Unknown';
                            ...
                            jobs_content +=
                                ...
                                `
                                <div class="job-card mb-3">
                                <div class="ribbon"><span class="${value.final_status}">${st_col}</span></div>
                                                        ...
                                                        <div class="trip-info">
                                                            <div class="route-section my-3 p-1">
                                                                ...
                                                                <div class="location-time">
                                                                    <div class="date-time"></div>
                                                                    <div class="location "
                                                                        onclick="toggleAddress(this)">${value.to_place}
                                                                    </div>
                                                                </div>
    ...
    function getFilter(){
        ...
        $.ajax({
            url: "{{ env('APP_API') }}get-prefered-loc",
            type: 'POST',
            headers: {
                "Authorization": "Bearer " + getCookie('sessionToken')
            },
            ...
            success: function (response) {
                if (response.status) {
                    ...
                    if (data) {
                        // Set Select2 value and trigger change
            
                        // Set range inputs with fallback to 0
                        $('#filterDistance').val(data.distance != '' && data.distance != null ? data.distance : 0);
                        $('#filterAmount').val(data.fare != '' && data.fare != null ? data.fare : 0);
                        $('#filterPassengerCount').val(data.pass != '' && data.pass != null ? data.pass : 0);
            
                        if (data.location != '' && data.location != null) {
                            // Create a new option if it doesn't exist
                            let newOption = new Option(data.location, data.location, true, true);
                            $('#location_input').append(newOption);
                        }
    ...
    function storeFilter() {
        ...
        // Get input values
        let loc = $('#location_input').val();
        let fare = $('#filterAmount').val();
        let distance = $('#filterDistance').val();
        let pass = $('#filterPassengerCount').val();
    
        // Client-side validation
        // if (!loc || loc.trim() === '') {
        //     showToast('error', 'Please select a location.', 3000);
        //     return;
        // }
        ...
        // if (fare !== '' && (isNaN(fare) || parseFloat(fare) < 0)) {
            showToast('error', 'Fare must be a number greater than or equal to 0.', 3000);
            return;
        }
    
        if (distance !== '' && (isNaN(distance))) {
        // if (distance !== '' && (isNaN(distance) || parseFloat(distance) < 0)) {
            showToast('error', 'Distance must be a number greater than or equal to 0.', 3000);
            return;
        }
    
        if (pass !== '' && (isNaN(pass))) {
        // if (pass !== '' && (isNaN(pass) || parseInt(pass) < 0)) {
            showToast('error', 'Passenger count must be a number greater than or equal to 0.', 3000);
            return;
        }
        ...
        formData.append('fare', fare || 0);
        formData.append('distance', distance || 0);
        formData.append('pass', pass || 0);
    
        // AJAX request
        $.ajax({
            url: "{{ env('APP_API') }}prefered-loc-store",
            type: 'POST',
            headers: {
                "Authorization": "Bearer " + getCookie('sessionToken')
            },
            ...
            success: function (response) {
                if (response.status) {
                    $('#saveFiltersBtn').html(`<i class="fas fa-save"></i> Saved`);
                    // showToast('success', response.message || 'Filters saved successfully.', 3000);
                    // openJobs();
                    location.reload()
                } else {
                    showToast('error', response.message || 'Failed to save filters.', 3000);
                }
            },
            error: function () {
                showToast('error', 'Something went wrong!', 3000);
    ...
    function resetFilter(){
        ...
        $('#filterPassengerCount').val(0);
        
        let newOption = new Option('', '', true, true);
        $('#location_input').append(newOption).trigger('change');
    }
    
    function setCancel(id, txt) {
        if (id != '') {
            if(txt == 'job'){
                $('#q_text').text('Are you sure you want to cancel this job?');
                $('#cancel-btn').attr('onclick', 'cancel_job(' + id + ')');
                
            }else if(txt == 'bid'){
                
                $('#q_text').text('Are you sure you want to cancel this bid?');
                $('#cancel-btn').attr('onclick', 'cancel_bid(' + id + ')');
            }
    ...
    function cancel_job(id) {
        ...
        $.ajax({
            ...
            processData: false,
            beforeSend: function () {
                $('#cancel-btn').prop('disabled', true).text('Cancelling...');
            },
            success: function (response) {
                if (response.status) {
                    showToast('success', response.message, 3000);
                    ...
                    showToast('error', response.message || 'Something went wrong!', 3000);
                }
            },
            error: function () {
                showToast('error', 'Something went wrong!', 3000);
            ...
            complete: function () {
                $('#cancel-btn').prop('disabled', false).text('Yes, Cancel');
            }
        });
    }
