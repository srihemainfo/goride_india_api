                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company_name" id="f_company" placeholder="Enter Company name" oninput="this.value = this.value.replace(/[^a-zA-Z _]/g,'').slice(0,30)">
                                </div>
                                </div>
                                </div>
                                <div class="form-group">
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status) {
                    ...
                    $('#f_company').val(data.company_name);
