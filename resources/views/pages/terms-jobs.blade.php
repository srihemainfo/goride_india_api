...
<div class="col-6 col-md-6 col-lg-2">
  <div class="footer-widget-box list">
    ...
    <ul class="footer-list">
      <li><a href="/goride-jobs#about"><i class="fas fa-caret-right"></i> About </a></li>
      <li><a href="/goride-jobs#features"><i class="fas fa-caret-right"></i> Features</a></li>
      <li><a href="/goride-jobs#how-it-works"><i class="fas fa-caret-right"></i> How It Works</a></li>
      <li><a href="/goride-jobs#faq"><i class="fas fa-caret-right"></i> Faq</a></li>
      <li><a href="/goride-jobs#app"><i class="fas fa-caret-right"></i> App</a></li>
    </ul>
  </div>
</div>
