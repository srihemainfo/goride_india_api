...
@section('content')
    @php
        ...
        $fromCity = ucfirst($expl_slg[0] ?? '');
        $toCity   = ucfirst($expl_slg[2] ?? '');
    ...
    @if($seoTags['page_exist'])
        ...
        <section class="choose-content-area d-block d-md-none">
            <div class="container">
                <h3>
                    {{ $title }} One Way Drop Taxi & Outstation Cab Booking in Tamil Nadu – GoRide
                </h3>
                ...
                <div class="row align-items-center mb-5 gap-5 gap-md-0">
                    <div class="col-lg-8 col-md-12 order-1 order-lg-1">
                        <div class="choose-content-area">
                            ...
                            <h3>What is Famous in {{ ucfirst($explode[0]) }} &amp; How GoRide Cabs Help You Reach There</h3>
                            <p>
                                {!!$seoTags['wikiDesHtml'] ?? ''!!}
                            </p>
        ...
        <section class="goride-route-tags">
            <div class="container">
                <div class="choose-content-area">
                    <h3 style="max-width:100%;"><span class="text-warning fs-3">Goride's</span> Service Cities</h3>
                </div>
        
                <div class="route-tags mt-3">
        
                    <a href="/taxi/ariyalur"><i class="fa-solid fa-location-dot text-danger me-2"></i>Ariyalur One Way Taxi</a>
        
                    <a href="/taxi/chengalpattu"><i class="fa-solid fa-location-dot text-danger me-2"></i>Chengalpattu Taxi Cab</a>
        
                    <a href="/taxi/coimbatore"><i class="fa-solid fa-location-dot text-danger me-2"></i>Coimbatore Round Trip Taxi</a>
        
                    <a href="/taxi/cuddalore"><i class="fa-solid fa-location-dot text-danger me-2"></i>Cuddalore Taxi Cab</a>
        
                    <a href="/taxi/dharmapuri"><i class="fa-solid fa-location-dot text-danger me-2"></i>Dharmapuri Cab</a>
        
                    <a href="/taxi/dindigul"><i class="fa-solid fa-location-dot text-danger me-2"></i>Dindigul Round Trip Taxi</a>
        
                    <a href="/taxi/erode"><i class="fa-solid fa-location-dot text-danger me-2"></i>Erode Round Trip Taxi</a>
        
                    <a href="/taxi/kallakurichi"><i class="fa-solid fa-location-dot text-danger me-2"></i>Kallakurichi One Way Cab</a>
        
                    <a href="/taxi/kancheepuram"><i class="fa-solid fa-location-dot text-danger me-2"></i>Kancheepuram One Way Taxi</a>
        
                    <a href="/taxi/kanniyakumari"><i class="fa-solid fa-location-dot text-danger me-2"></i>Kanniyakumari Cab</a>
        
                    <a href="/taxi/karur"><i class="fa-solid fa-location-dot text-danger me-2"></i>Karur Taxi Cab</a>
        
                    <a href="/taxi/krishnagiri"><i class="fa-solid fa-location-dot text-danger me-2"></i>Krishnagiri Taxi</a>
        
                    <a href="/taxi/madurai"><i class="fa-solid fa-location-dot text-danger me-2"></i>Madurai Round Trip Cab</a>
        
                    <a href="/taxi/mayiladuthurai"><i class="fa-solid fa-location-dot text-danger me-2"></i>Mayiladuthurai One Way Taxi</a>
        
                    <a href="/taxi/nagapattinam"><i class="fa-solid fa-location-dot text-danger me-2"></i>Nagapattinam Taxi</a>
        
                    <a href="/taxi/namakkal"><i class="fa-solid fa-location-dot text-danger me-2"></i>Namakkal Taxi Cab</a>
        
                    <a href="/taxi/perambalur"><i class="fa-solid fa-location-dot text-danger me-2"></i>Perambalur One Way Cab</a>
        
                    <a href="/taxi/pudukkottai"><i class="fa-solid fa-location-dot text-danger me-2"></i>Pudukkottai Taxi</a>
        
                    <a href="/taxi/ramanathapuram"><i class="fa-solid fa-location-dot text-danger me-2"></i>Ramanathapuram Round Trip Cab</a>
        
                    <a href="/taxi/ranipet"><i class="fa-solid fa-location-dot text-danger me-2"></i>Ranipet Round Trip Taxi</a>
        
                    <a href="/taxi/salem"><i class="fa-solid fa-location-dot text-danger me-2"></i>Salem One Way Cab</a>
        
                    <a href="/taxi/sivaganga"><i class="fa-solid fa-location-dot text-danger me-2"></i>Sivaganga One Way Taxi</a>
        
                    <a href="/taxi/tenkasi"><i class="fa-solid fa-location-dot text-danger me-2"></i>Tenkasi Round Trip Taxi</a>
        
                    <a href="/taxi/thanjavur"><i class="fa-solid fa-location-dot text-danger me-2"></i>Thanjavur One Way Taxi</a>
        
                    <a href="/taxi/theni"><i class="fa-solid fa-location-dot text-danger me-2"></i>Theni One Way Taxi</a>
        
                    <a href="/taxi/thiruvallur"><i class="fa-solid fa-location-dot text-danger me-2"></i>Thiruvallur Cab</a>
        
                    <a href="/taxi/thiruvarur"><i class="fa-solid fa-location-dot text-danger me-2"></i>Thiruvarur Taxi Cab</a>
        
                    <a href="/taxi/thoothukudi"><i class="fa-solid fa-location-dot text-danger me-2"></i>Thoothukudi Cab</a>
        
                    <a href="/taxi/tiruchirappalli"><i class="fa-solid fa-location-dot text-danger me-2"></i>Tiruchirappalli Round Trip Taxi</a>
        
                    <a href="/taxi/tirunelveli"><i class="fa-solid fa-location-dot text-danger me-2"></i>Tirunelveli One Way Taxi</a>
        
                    <a href="/taxi/tirupathur"><i class="fa-solid fa-location-dot text-danger me-2"></i>Tirupathur Round Trip Taxi</a>
        
                    <a href="/taxi/tiruppur"><i class="fa-solid fa-location-dot text-danger me-2"></i>Tiruppur Round Trip Taxi</a>
        
                    <a href="/taxi/tiruvannamalai"><i class="fa-solid fa-location-dot text-danger me-2"></i>Tiruvannamalai Taxi Cab</a>
        
                    <a href="/taxi/nilgiris"><i class="fa-solid fa-location-dot text-danger me-2"></i>Nilgiris Round Trip Cab</a>
        
                    <a href="/taxi/vellore"><i class="fa-solid fa-location-dot text-danger me-2"></i>Vellore One Way Taxi</a>
        
                    <a href="/taxi/viluppuram"><i class="fa-solid fa-location-dot text-danger me-2"></i>Viluppuram Taxi</a>
        
                    <a href="/taxi/chennai"><i class="fa-solid fa-location-dot text-danger me-2"></i>Chennai One Way Taxi</a>
