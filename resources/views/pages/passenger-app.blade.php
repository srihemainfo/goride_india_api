    ...
    <section class="page-header">
        ...
        <div class="container">
            <div class="page-header-info">
                <h4>Go Ride My Passenger App</h4>
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="section-heading text-center mb-40">
                        <h2 class="wow fadeIn" data-wow-duration="2s">Why Choose the Go Ride My Passenger App?</h2>
                    </div>
                </div>
    			...
    			<div class="col-md-6">
    				<div class="how-app-work-content-wrap">
    					<div class="title wow fadeIn" data-wow-duration="2s">
    						<h3>Get Started with Go Ride My Passenger App</h3>
    					</div>
    					<div class="how-app-work-content" id="how-app-work-slider-pager">
    						<a href="#" class="pager-item active wow fadeIn" data-wow-duration="2s" data-wow-delay="500ms">
    						    <div class="single-how-app-work ">
        							...
        							<div class="text-box">
        								<h4>Download the Go Ride My Passenger App</h4>
