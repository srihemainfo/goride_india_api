...
@php
    ...
    //dd( $cartDetails['cartData']['finalTotal']);
                    ...
                    <td>
                        @if ($cartDetails['cartData']['currency'] === 'INR')
                            <button type="button" id="payNow"
                                onclick="{{ isset($cartDetails['cartData']['planType']) && $cartDetails['cartData']['planType'] === 'TRAIL' ? 'buyTrailCRM()' : 'startPayment()'   }}"
                                class="btn btn-primary"><i class="fas fa-share"></i> Checkout</button>
                        @else
        ...
        {{-- <div class="tabed-content">
            <div class="package-details">
                ...
                <div class="detail-item">
                    <p class="price-label">Domain name:</p>
                    <p class="price-value">{{ $cartDetails['cartData']['crmDetails']['subDomainName'] }}</p>
                </div>
                @endif
                <div class="detail-item">
                    <p class="price-label">Package Name:</p>
                    <p class="price-value">{{ $cartDetails['cartData']['productDetails']['name'] }}</p>
                </div>
                <div class="detail-item">
                    <p class="price-label">Plan Type:</p>
                    <p class="price-value">{{ $cartDetails['cartData']['planType'] }}</p>
                </div>
                <div class="detail-item">
                    <p class="price-label">Trial Days:</p>
                    <p class="price-value">{{ $cartDetails['cartData']['trailsDays'] }}</p>
                </div>
                <div class="detail-item">
                    <p class="price-label">Validity Days:</p>
                    <p class="price-value">{{ $cartDetails['cartData']['noOfDays'] }}</p>
                </div>
                <div class="detail-item">
                    <p class="price-label">Total Days:</p>
                    <p class="price-value">{{ $cartDetails['cartData']['totalDays'] }}</p>
                </div>
                <div class="detail-item">
                    <p class="price-label">Final Total:</p>
                    <p class="price-value">{{ $cartDetails['cartData']['finalTotal'] }}</p>
                </div>
                <div class="detail-item">
                    <p class="price-label">Discount Total:</p>
                    <p class="price-value">{{ $cartDetails['cartData']['discountAmt'] }}</p>
                </div>
                <div class="detail-item">
                    <p class="price-label">Grand Total:</p>
                    <p class="price-value">{{ $cartDetails['cartData']['grandtotal'] }}</p>
                </div>
            </div>
