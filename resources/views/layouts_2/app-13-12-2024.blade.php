...
<head>
    ...
    <title>{{ $seoTags['metaTitle'] ?? 'Go Ride' }}</title>
    <meta name="description" content="{{ $seoTags['metaDes'] ?? 'Go Ride' }}">
    <meta name="keywords" content="{{ $seoTags['metaKeyword'] ?? 'Go Ride' }}">
    <link rel="canonical" href="{{ $seoTags['canonical'] ?? url('/') }}">
