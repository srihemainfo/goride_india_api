...
">+91 63697 42104
                        ...
                        <div class="widget-text">
                            ...
                            <div class="social-icons">
                                <ul class="list-inline text-center">
                                    ...
                                    <li><a href="https://www.instagram.com/goride.run/" target="_blank"><i
                                                class="fa-brands fa-instagram"></i></a></li>
                                    <li><a href="https://www.facebook.com/profile.php?id=61564856917550"
        ...
        <div class="bottom-footer-text">
            <div class="row copyright">
                <div class="col-md-12">
                    <p class="mb-0 text-center">&copy;<?php echo date('Y'); ?> <a href="https://www.cwd.co.in/">SRIHEMA INFOTECH</a>. All
                        rights reserved.</p>
                </div>
            </div>
        </div>
