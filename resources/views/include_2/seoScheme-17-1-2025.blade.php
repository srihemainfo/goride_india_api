...
@if (isset($slug) && $slug != null && $slug != '')
  <script type="application/ld+json">
    ...
    "@type": "Organization",
    "url": "{{ $currentUrl }}",
    "name": "{{$seoTags['metaTitle'] ?? 'Go Ride - The Heartbeat of Mobility' }}",
    "description": "{{ $seoTags['metaDes'] ?? 'Go Ride is your one-stop platform for cutting-edge mobility solutions. We offer a seamless ride experience with innovative technology, reliable vehicles, and a focus on customer satisfaction. Whether you`re looking to book a ride, rent a vehicle, or explore sustainable transportation options, Go Ride makes it easier, faster, and smarter.' }}",
    "aggregateRating": {
    "@type": "AggregateRating",
    "ratingValue": "5.0",
    "reviewCount": "1200"
    ...
    "address": {
    "@type": "PostalAddress",
    "addressLocality": "{{ isset($seoTags['cityName']) ? ucfirst(strtolower($seoTags['cityName'])) : ''}}",
    "addressCountry": "City"
    },
    "serviceArea": {
    "@type": "Place",
    "name": "{{ isset($seoTags['cityName']) ? ucfirst(strtolower($seoTags['cityName'])) : ''}}",
    "sameAs": "{{  $currentUrl }}"
    },
    "contactPoint": {
    "@type": "ContactPoint",
  ...
  <script type="application/ld+json">
    ...
    },
    {
      ...
      "position": 2,
      "name": "Our Features",
      "item": "{{ url()->to('/') }}/features"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "CRM With Dispatch",
      "item": "{{ url()->to('/') }}/crm-with-dispatch"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "Driver APP",
      "item": "{{ url()->to('/') }}/driver-app"
    },
    {
      "@type": "ListItem",
      "position": 5,
      "name": "Passenger APP",
      "item": "{{ url()->to('/') }}/passenger-app"
    },
    {
      "@type": "ListItem",
      "position": 6,
