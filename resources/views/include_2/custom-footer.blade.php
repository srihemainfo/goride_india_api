                            ...
                            @if(isset($seoTags['innerLinks']))
                                @foreach($seoTags['innerLinks'] as $key => $value)
                                    @if($value->slug !== Request::path())
                                        <a style="color: rgb(255, 253, 253) !important;" href="/{{ $value->slug }}" target="_blank">
                                            {{ ucwords(strtolower($value->name)) . ' – ' . ucwords(strtolower($value->to_place)) }}
                                        </a>
                                        @if(!$loop->last)
                                            |
                                        @endif
...
">+91 63697 42104
                        ...
                        <div class="widget-text">
                            ...
                            <div class="social-icons">
                                <ul class="list-inline text-center">
                                    <li><a href="https://api.whatsapp.com/send/?phone=916369742104&text=Hi%2C%20Need%20Taxi%20%2F%20Cab%20Dispatch%20Software%20System%2C%20connect%20me.&type=phone_number&app_absent=0" target="_blank"><i
                                                class="fa-brands fa-whatsapp"></i></a></li>
                                    <li><a href="https://x.com/go_rides8499" target="_blank">
                                       <img src="https://cdn-icons-png.flaticon.com/16/5968/5968958.png" class="img-fluid twitter-x" style=" height: 12px;width: 13px;filter: invert(1);">
                                    </a></li>
                                    <li><a href="https://www.instagram.com/go_ride.run/" target="_blank"><i
                                                class="fa-brands fa-instagram"></i></a></li>
                                    <li><a href="https://www.facebook.com/goride25"
                ...
                <div class="col-md-3 offset-md-1 widget-area service_offerings_footer">
                    <div class="widget clearfix usful-links">
                        ...
                        <ul>
                            ...
                            <li><a href="/passenger-app">My Passenger App</a></li>
                        </ul>
                        ...
                        <a href="https://play.google.com/store/apps/details?id=com.shi.my_rider_driver&pcampaignid=web_share"
                            ...
                            <img src="{{ asset('goride/img/google-play.png') }}" alt="google-play" style="width:160px;">
                        </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="bottom-footer-text">
            <div class="row copyright">
                <div class="col-md-12">
                    <p class="mb-0 text-center">&copy;<?php echo date('Y'); ?> <a href="https://www.goride.run/">GORIDE RUN PRIVATE LIMITED</a>. All
                        rights reserved.</p>
                </div>
            </div>
        </div>
...
<a class='blantershow-chat'  href="https://api.whatsapp.com/send/?phone=916369742104&text=Hi%2C%20Need%20Taxi%20%2F%20Cab%20Dispatch%20Software%20System%2C%20connect%20me.&type=phone_number&app_absent=0" target="_blank" title='Show Chat'>
...
<script>
    ...
    $(document).ready(function () {
          ...
          chatForm.addEventListener('submit', async (e) => {
            ...
            let apiURL = {!! json_encode($postMessUrl) !!};
        ...
        if (getCookie('acceptCookie') || countryC == 'IN') {
  ...
  $(document).ready(function () {
    ...
    if (countryC == 'IN') {
        ...
        $('#app_link').attr('href', 'https://play.google.com/store/apps/details?id=com.shi.my_rider_driver&pcampaignid=web_share');
    }
