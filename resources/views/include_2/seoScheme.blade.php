...
@elseif(str_contains($currentUrl, 'car-rental') && $seoTags['page_exist'])
  ...
  "@graph": [
    {
      ...
      "description": "Book affordable {{ ucfirst($explode[0]) }} To {{ ucfirst($explode[2]) }} cab service online. Compare taxi fares, choose from sedans, SUVs, and tempo travellers for your {{ $seoTags['kms'] }} km journey.",
      "brand": {
        "@type": "Organization",
        "name": "Goride Cabs",
        "url": "{{ url()->to('/') }}/"
      ...
      "offers": {
        ...
        "highPrice": "{{ $seoTags['fivezero_seater'] }}",
        "priceCurrency": "INR",
        "offerCount": "2",
        "offers": [
          {
    ...
    },
    {
      ...
      "alternateName": [
        "{{ ucfirst($explode[0]) }} To {{ ucfirst($explode[2]) }} cab service",
        "{{ ucfirst($explode[0]) }} To {{ ucfirst($explode[2]) }} taxi",
        "{{ ucfirst($explode[0]) }} To {{ ucfirst($explode[2]) }} one way cab",
        "{{ ucfirst($explode[0]) }} To {{ ucfirst($explode[2]) }} outstation taxi",
        "Cab from {{ ucfirst($explode[0]) }} To {{ ucfirst($explode[2]) }}",
        "Taxi from {{ ucfirst($explode[0]) }} To {{ ucfirst($explode[2]) }}",
        "One way taxi {{ ucfirst($explode[0]) }} To {{ ucfirst($explode[2]) }}",
        "Affordable {{ ucfirst($explode[0]) }} To {{ ucfirst($explode[2]) }} cab",
        "{{ ucfirst($explode[0]) }} To {{ ucfirst($explode[2]) }} drop taxi",
        "{{ ucfirst($explode[0]) }} To {{ ucfirst($explode[2]) }} cab booking online",
        "Cheap {{ ucfirst($explode[0]) }} To {{ ucfirst($explode[2]) }} cab service"
      ],
      "provider": {
        "@type": "Organization",
        "name": "Goride Cabs",
      ...
      "serviceType": "Affordable one-way and round-trip {{ ucfirst($explode[0]) }} To {{ ucfirst($explode[2]) }} taxi and cab services including cab price, taxi fare, and cab fare options.",
      "areaServed": {
        "@type": "City",
        "name": "{{ ucfirst($explode[0]) }}"
      },
      "availableChannel": {
        "@type": "ServiceChannel",
      ...
      "offers": {
        ...
        "price": "{{ $seoTags['mini_four_seater'] }}",
        "url": "{{ $seoTags['canonical'] }}",
        "description": "Get the lowest {{ ucfirst($explode[0]) }} To {{ ucfirst($explode[2]) }} cab fare starting from ₹{{ $seoTags['mini_four_seater'] }}. Extra fare: ₹13/km.",
        "eligibleRegion": {
          "@type": "Place",
          "name": "{{ ucfirst($explode[0]) }} To {{ ucfirst($explode[2]) }}"
        }
      }
    }
  ]
